    ...
    <div class="catalog-content">
        ...
        <div class="flex justify-between items-end border-b-4 border-maroon pb-2 mb-4">
            ...
            <div class="text-right">
                <p class="text-[10px] font-black text-maroon uppercase">Page <?php echo e($pageIndex + 1); ?> of <?php echo e($totalPages); ?></p>
                <p class="text-[8px] text-slate-400 font-bold uppercase tracking-widest"><?php echo e(date('M d, Y')); ?></p>
            </div>
        </div>
                ...
                <div class="item-card">
                    ...
                    <div class="item-details">
                        <div class="detail-row">
                            ...
                            <span class="font-black text-slate-800 uppercase text-[11px] truncate-text"><?php echo e($product->product_code); ?></span>
                        </div>
                        <div class="detail-row">
                            <span class="detail-label">Part No#:</span>
                            <span class="font-mono text-slate-700 font-bold text-[9px]"><?php echo e($product->part_number); ?></span>
                        </div>
                        <div class="detail-row">
                            ...
                            <span class="text-slate-600 font-bold text-[9px] truncate-text">
                                ...
                                <?php if($product->position ?: $product->Position): ?>
                                    <span class="text-[7px] text-slate-400 ml-1">(<?php echo e($product->position ?: $product->Position); ?>)</span>
                                <?php endif; ?>
                            </span>
                        </div>
                        <div class="detail-row">
                            <span class="detail-label">Brand:</span>
                            <span class="text-slate-500 uppercase font-bold text-[9px]"><?php echo e($product->category); ?></span>
                        </div>
...
</div><?php /**PATH C:\xampp\htdocs\hatdog\resources\views\Regular_User\master_list\partials\catalog_chunk.blade.php ENDPATH**/ ?>