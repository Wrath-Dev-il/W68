...
<script>
    ...
    window.purchaseRoutes = {
        fetch: '<?php echo e(route("admin.purchase.note.data")); ?>',
        details: '<?php echo e(route("admin.purchase.note.details", ["id" => ":id"])); ?>',
        searchSuppliers: '<?php echo e(route("admin.purchase.search-suppliers")); ?>',
        searchProducts: '<?php echo e(route("admin.purchase.search-products")); ?>',
        store: '<?php echo e(route("admin.purchase.note.store")); ?>',
        update: '<?php echo e(route("admin.purchase.note.update", ["id" => ":id"])); ?>',
        delete: '<?php echo e(route("admin.purchase.note.delete", ["id" => ":id"])); ?>',
        supplierItemConflicts: '<?php echo e(route("admin.purchase.note.supplier-item-conflicts")); ?>',
        forgottenPartialItems: '<?php echo e(route("admin.purchase.note.forgotten-partial-items", ["supplierCode" => ":supplierCode"])); ?>',
        nextNumber: '<?php echo e(route("admin.purchase.note.next-number")); ?>',
        print: '<?php echo e(route("admin.purchase.note.print", ["id" => ":id"])); ?>',
        verifyPasswordUrl: '<?php echo e(route("admin.purchase.note.verify-password")); ?>',
        checkPasswordUrl: '<?php echo e(url("/check-password")); ?>',
        invoicesByNoteUrl: '<?php echo e(route("admin.purchase-order.by-note", ["purchaseNoteNumber" => ":noteNumber"])); ?>'
    };
...
<?php /**PATH C:\xampp\htdocs\hatdog\resources\views\Admin\Purchase\Purchase-Note.blade.php ENDPATH**/ ?>