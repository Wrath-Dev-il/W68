...
<script>
    window.purchaseRoutes = {
        process: '<?php echo e(route("admin.purchase-order.process")); ?>',
        updatePO: '<?php echo e(route("admin.purchase-order.update")); ?>',
        openNotesUrl: '<?php echo e(route("admin.purchase.open-notes")); ?>',
        dashboardDataUrl: '<?php echo e(route("admin.purchase-order.dashboard")); ?>',
        activeDataUrl: '<?php echo e(route("admin.purchase-order.active")); ?>',
        historyDataUrl: '<?php echo e(route("admin.purchase-order.history")); ?>',
        poItemsUrl: '<?php echo e(route("admin.purchase-order.po-items", ["poId" => ":poId"])); ?>',
        poDetailUrl: '<?php echo e(route("admin.purchase-order.detail", ["poId" => ":poId"])); ?>',
        forceCloseUrl: '<?php echo e(route("admin.purchase-order.force-close.submit", ["purchaseNoteId" => ":purchaseNoteId"])); ?>',
        resyncCostsUrl: '<?php echo e(route("admin.purchase-order.resync-product-costs", ["poId" => ":poId"])); ?>',
    };
...
<?php $__env->startPush('scripts'); ?>
    <script>
        window.purchaseRoutes = {
            process: '<?php echo e(route("admin.purchase-order.process")); ?>',
            updatePO: '<?php echo e(route("admin.purchase-order.update")); ?>',
            itemsUrl: '<?php echo e(url("/admin/purchase/purchase-order/items")); ?>',
            openNotesUrl: '<?php echo e(route("admin.purchase.open-notes")); ?>',
            activeDataUrl: '<?php echo e(route("admin.purchase-order.active")); ?>',
            historyDataUrl: '<?php echo e(route("admin.purchase-order.history")); ?>',
            detailsByNumberUrl: '<?php echo e(url("/admin/purchase/purchase-note/details-by-number")); ?>',
            dashboardDataUrl: '<?php echo e(route("admin.purchase-order.dashboard")); ?>',
            poItemsUrl: '<?php echo e(route("admin.purchase-order.po-items", ["poId" => ":poId"])); ?>',
            poDetailUrl: '<?php echo e(route("admin.purchase-order.detail", ["poId" => ":poId"])); ?>',
            forceCloseUrl: '<?php echo e(route("admin.purchase-order.force-close.submit", ["purchaseNoteId" => ":purchaseNoteId"])); ?>',
...
<?php /**PATH C:\xampp\htdocs\hatdog\resources\views\Admin\Purchase\Purchase-Order.blade.php ENDPATH**/ ?>