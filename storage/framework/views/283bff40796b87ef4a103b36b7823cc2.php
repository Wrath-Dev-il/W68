...
<?php $__env->startPush('scripts'); ?>
    <script>
        ...
        function loadCIDashboard() {
            fetch('<?php echo e(route("admin.consignment-invoice.dashboard")); ?>')
                .then(r => r.json())
                .then(res => {
        ...
        function loadCIActiveNotes() {
            ...
            fetch('<?php echo e(route("admin.consignment-invoice.active")); ?>')
                .then(r => r.json())
                .then(res => {
        ...
        function loadCIHistory() {
            ...
            fetch('<?php echo e(route("admin.consignment-invoice.history")); ?>')
                .then(r => r.json())
                .then(res => {
        ...
        function loadCINoteDetail(id) {
            ...
            fetch('<?php echo e(route("admin.consignment-invoice.note-detail", ["id" => "__ID__"])); ?>'.replace('__ID__', id))
                .then(r => r.json())
                .then(res => {
        ...
        window.finalizeConsignmentInvoice = function() {
            ...
            fetch('<?php echo e(route("admin.consignment-invoice.proceed")); ?>', {
                method: 'POST',
        ...
        window.submitCIPrintReceipt = function() {
            ...
            fetch('<?php echo e(route("admin.consignment-invoice.receipt-print")); ?>', {
                method: 'POST',
                headers: {
        ...
        function loadCIOrderDetail(id) {
            ...
            fetch('<?php echo e(route("admin.consignment-invoice.detail", ["id" => "__ID__"])); ?>'.replace('__ID__', id))
                .then(r => r.json())
                .then(res => {
                    if (!res.success) {
...
<?php /**PATH C:\xampp\htdocs\hatdog\resources\views\Admin\sales\consignment-invoicing.blade.php ENDPATH**/ ?>