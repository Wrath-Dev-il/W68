<?php $__env->startPush('styles'); ?>
    <link rel="stylesheet" href="<?php echo e(asset('css/audit-trail.css')); ?>?v=<?php echo e(time()); ?>">
<?php $__env->stopPush(); ?>

<?php $__env->startSection('audit_trail_content'); ?>
    <div id="audit-trail-page" class="space-y-6" data-data-url="<?php echo e(route('admin.audit-trail.data')); ?>" data-purge-at="<?php echo e($audit_purge_at ?? ''); ?>">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-5">
            <?php $__currentLoopData = [
                ...
                <button type="button" class="audit-card bg-white p-5 rounded-2xl shadow-sm border border-slate-100 flex items-center justify-between group hover:border-slate-200 transition-all hover:shadow-md hover:scale-[1.01] duration-200 overflow-hidden text-left" data-module="<?php echo e($card['key']); ?>">
...
<?php $__env->startPush('scripts'); ?>
    <script src="<?php echo e(asset('js/audit-trail.js')); ?>?v=<?php echo e(time()); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('partials.admin.admin_sidebar_navbar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php /**PATH C:\xampp\htdocs\hatdog\resources\views\Admin\System Security\Aduit-trail.blade.php ENDPATH**/ ?>