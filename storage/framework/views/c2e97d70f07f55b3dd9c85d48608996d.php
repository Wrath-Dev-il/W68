<?php $__env->startPush('styles'); ?>
    <?php echo app('Illuminate\Foundation\Vite')(['resources/css/Sales-Return.css']); ?>
    <style>
        @keyframes blink-red {
...
<?php $__env->startSection('sales_return_content'); ?>
...
<!-- ============== ADD RETURN MODAL ============== -->
<div id="add-return-modal" class="fixed inset-0 z-[900] hidden flex items-center justify-center p-4">
...
<div id="invoice-search-modal" class="fixed inset-0 z-[950] hidden flex items-center justify-center p-4">
    ...
    <div class="relative bg-white rounded-[2rem] text-left overflow-hidden shadow-2xl transform transition-all max-w-4xl w-full modal-animate-in flex flex-col max-h-[80vh]">
        ...
        <div class="p-6 bg-slate-50 border-b border-slate-100">
            <div class="relative">
                ...
                <input type="text" id="invoice-search-query-input" placeholder="Search by Invoice No, Customer, or Date..." oninput="handleInvoiceSearchInput()" class="w-full pl-11 pr-4 py-3 bg-white border border-slate-200 rounded-xl text-xs outline-none focus:ring-2 focus:ring-maroon/10 transition-all">
            </div>
        </div>
...
<!-- ============== SUCCESS MODAL ============== -->
<div id="return-success-modal" class="fixed inset-0 z-[1000] hidden flex items-center justify-center p-4">
...
<div id="view-return-modal" class="fixed inset-0 z-[900] hidden flex items-center justify-center" role="dialog" aria-modal="true">
...
<!-- ============== EDIT RETURN MODAL ============== -->
<div id="edit-return-modal" class="fixed inset-0 z-[900] hidden flex items-center justify-center" role="dialog" aria-modal="true">
...
<div id="edit-return-confirm-modal" class="fixed inset-0 z-[950] hidden flex items-center justify-center" role="dialog" aria-modal="true">
...
<div id="edit-return-success-modal" class="fixed inset-0 z-[1000] hidden flex items-center justify-center" role="dialog" aria-modal="true">
...
<?php $__env->startPush('scripts'); ?>
    <script>
        window.salesReturnRoutes = {
            invoices: "<?php echo e(route('regular.sales-return.invoices')); ?>",
            items: "<?php echo e(route('regular.sales-return.items', ':id')); ?>",
            history: "<?php echo e(route('regular.sales-return.history')); ?>",
            historyDetail: "<?php echo e(route('regular.sales-return.history-detail', ':id')); ?>",
            finalize: "<?php echo e(route('regular.sales-return.finalize')); ?>",
            dashboard: "<?php echo e(route('regular.sales-return.dashboard')); ?>",
            editData: "<?php echo e(route('regular.sales-return.edit-data', ':id')); ?>",
            update: "<?php echo e(route('regular.sales-return.update', ':id')); ?>",
            delete: "<?php echo e(route('regular.sales-return.delete', ':id')); ?>",
        };
        window.csrfToken = "<?php echo e(csrf_token()); ?>";
    </script>
    <script src="<?php echo e(asset('js/Sales-Return.js')); ?>?v=<?php echo e(filemtime(public_path('js/Sales-Return.js'))); ?>"></script>
<?php $__env->stopPush(); ?>
...
<?php echo $__env->make('partials.special_user.special_sidebar_navbar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\hatdog\resources\views/Special_User/sales/sales-return.blade.php ENDPATH**/ ?>