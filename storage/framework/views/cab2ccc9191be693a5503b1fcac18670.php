...
<?php $__env->startPush('scripts'); ?>
    <script>
        window.waybillRoutes = {
            stats: "<?php echo e(route('regular.waybill.stats')); ?>",
            pending: "<?php echo e(route('regular.waybill.pending')); ?>",
            soItems: "<?php echo e(route('regular.waybill.so-items', ':id')); ?>",
            finalize: "<?php echo e(route('regular.waybill.finalize')); ?>",
            forwarderSuggestions: "<?php echo e(route('regular.waybill.forwarder-suggestions')); ?>",
            history: "<?php echo e(route('regular.waybill.history')); ?>",
            historyDetails: "<?php echo e(route('regular.waybill.history-details', ':id')); ?>",
            batchPrint: "<?php echo e(route('regular.waybill.batch-print')); ?>",
            update: "<?php echo e(route('regular.waybill.update', ':id')); ?>",
            editData: "<?php echo e(route('regular.waybill.edit-data', ':id')); ?>"
        };
...
<?php echo $__env->make('partials.user_account.user_sidebar_navbar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\hatdog\resources\views/Regular_User/sales/Waybill.blade.php ENDPATH**/ ?>