...
<?php $__env->startPush('scripts'); ?>
    <script>
        window.salesOrderRoutes = {
            activeUrl: '<?php echo e(route("special.sales-order.active")); ?>',
            proceedUrl: '<?php echo e(route("special.sales-order.proceed")); ?>',
            forceCloseNoteUrl: '<?php echo e(route("special.sales-order.force-close-note", ["salesNoteId" => ":salesNoteId"])); ?>',
            historyUrl: '<?php echo e(route("special.sales-order.history")); ?>',
            dashboardUrl: '<?php echo e(route("special.sales-order.dashboard")); ?>',
            detailUrl: '<?php echo e(route("special.sales-order.detail", ["id" => ":id"])); ?>',
            editDetailUrl: '<?php echo e(route("special.sales-order.edit-detail", ["salesOrderId" => ":salesOrderId"])); ?>',
            updateUrl: '<?php echo e(route("special.sales-order.update", ["salesOrderId" => ":salesOrderId"])); ?>',
            ledgerUrl: '<?php echo e(route("special.sales-order.ledger", ["salesNumber" => ":salesNumber"])); ?>',
            receiptPrintUrl: '<?php echo e(route("special.sales-order.receipt-print")); ?>',
            ...
            counterPartProductsUrl: '<?php echo e(route("special.sales-order.counter-part-products")); ?>',
            onlineGenerateUrl: '<?php echo e(route("special.sales-order.online-generate")); ?>',
            onlinePrintUrl: '<?php echo e(route("special.sales-order.online-print", ["id" => ":id"])); ?>',
            onlineInvoicesUrl: '<?php echo e(route("special.sales-order.online-invoices")); ?>',
            onlineInvoicesDataUrl: '<?php echo e(route("special.sales-order.online-invoices-data")); ?>',
            onlineInvoiceEditUrl: '<?php echo e(route("special.sales-order.online-edit", ["id" => ":id"])); ?>',
            onlineInvoiceUpdateUrl: '<?php echo e(route("special.sales-order.online-update", ["id" => ":id"])); ?>',
            onlineInvoiceDeleteUrl: '<?php echo e(route("special.sales-order.online-destroy", ["id" => ":id"])); ?>',
            onlineInvoiceMinSearchLength: 3,
            allOrdersDataUrl: '<?php echo e(route("special.sales-order.all-orders-data")); ?>',
            historyDataUrl: '<?php echo e(route("special.sales-order.history-data")); ?>',
            historyDeleteUrl: '<?php echo e(route("special.sales-order.history-destroy", ["id" => ":id"])); ?>',
            allUrl: '<?php echo e(route("special.sales-order.all")); ?>',
            productPriceUrl: '<?php echo e(route("special.sales-order.product-price", ["id" => ":id"])); ?>',
            priceCodesUrl: '<?php echo e(route("special.sales-order.price-codes", ["productId" => ":productId"])); ?>',
            stockCheckUrl: '<?php echo e(route("special.sales-order.check-stock")); ?>',
            editStockCheckUrl: '<?php echo e(route("special.sales-order.edit-check-stock")); ?>',
            noteInvoicesUrl: '<?php echo e(route("special.sales-note.invoices", ["noteId" => ":noteId"])); ?>',
            onlineVerifyLedgerUrl: '<?php echo e(route("special.sales-order.online-report.verify-product-ledger", ["onlineReport" => ":reportId"])); ?>',
        };
...
<?php echo $__env->make('partials.special_user.special_sidebar_navbar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\hatdog\resources\views/Special_User/sales/sales-order.blade.php ENDPATH**/ ?>