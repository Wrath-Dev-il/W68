...
<?php
    ...
    $systemThemeIconMap = [
        'default' => [
            'notification' => null,
            'chat_image' => null,
            'chat_lucide' => 'message-circle',
            'chat_label' => 'Default AI Chat',
        ],
        'christmas' => [
            'notification' => 'build/assets/images/SYSTEM DESIGNS/XMASS/snowflakes.gif',
            'chat_image' => null,
            'chat_lucide' => 'snowflake',
            'chat_label' => 'Snow flakes',
        ],
        'holy-week' => [
            'notification' => 'build/assets/images/SYSTEM DESIGNS/HOLYWEEK/religious.gif',
            'chat_image' => null,
            'chat_lucide' => 'book-open-text',
            'chat_label' => 'Bibble',
        ],
        'halloween' => [
            'notification' => 'build/assets/images/SYSTEM DESIGNS/HOLLOWEEN/spiderweb.gif',
            'chat_image' => null,
            'chat_lucide' => 'shopping-basket',
            'chat_label' => 'Pumpkin basket',
        ],
        'new-year' => [
            'notification' => 'build/assets/images/SYSTEM DESIGNS/NEWYEAR/new-years-eye.gif',
            'chat_image' => null,
            'chat_lucide' => 'party-popper',
            'chat_label' => 'Fire Cracker',
        ],
        'chinese-new-year' => [
            'notification' => 'build/assets/images/SYSTEM DESIGNS/chinese new year/lantern.gif',
            'chat_image' => 'build/assets/images/SYSTEM DESIGNS/chinese new year/dragon.gif',
            'chat_lucide' => null,
            'chat_label' => 'Dragon',
        ],
    ];
...
<body class="bg-gray-50 text-gray-800 font-sans h-screen flex flex-col overflow-hidden" data-system-theme="<?php echo e($activeSystemTheme); ?>">
    ...
    <div class="flex flex-1 h-screen overflow-hidden">
        ...
        <aside id="sidebar" class="sidebar-transition bg-maroon-900 border-r-4 border-goldlining-500 w-64 flex flex-col h-full min-h-0 text-white z-40 shadow-2xl relative no-print">
            ...
            <div class="flex-1 min-h-0 overflow-y-auto px-3 pt-4 pb-28 space-y-1.5 scroll-pb-28" id="nav-container">
                ...
                <div>
                    <a href="<?php echo e(route('admin.dashboard')); ?>" class="nav-item flex items-center space-x-3 px-3 py-3 rounded-lg transition-all duration-150 group <?php echo e(Route::currentRouteName() === 'admin.dashboard' ? 'active bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'hover:bg-maroon-800 text-gray-100'); ?>" title="Dashboard">
                        <i data-lucide="layout-dashboard" class="w-5 h-5 flex-shrink-0"></i>
                        <span class="sidebar-text text-sm transition-opacity duration-200">Dashboard</span>
                    </a>
                </div>

                <!-- SYSTEM SECURITY (DROPDOWN) -->
                <div class="menu-dropdown">
                    <button onclick="toggleDropdown('dropdown-sys-sec', this)" class="w-full flex items-center justify-between px-3 py-3 rounded-lg hover:bg-maroon-800 text-gray-100 hover:text-white transition-all group" title="System Security">
                        <div class="flex items-center space-x-3">
                            <i data-lucide="lock" class="w-5 h-5 text-goldlining-400 group-hover:scale-110 transition-transform flex-shrink-0"></i>
                            <span class="sidebar-text text-sm whitespace-nowrap">System Security</span>
                        </div>
                        <i data-lucide="chevron-down" class="dropdown-chevron w-4 h-4 text-goldlining-500 rotate-transition sidebar-text <?php echo e(in_array(Route::currentRouteName(), ['admin.usm', 'admin.archived', 'admin.datasync', 'admin.audit-trail']) ? 'rotate-180' : ''); ?>"></i>
                    </button>
                    <!-- Submenu Links -->
                    <div id="dropdown-sys-sec" class="submenu-transition overflow-hidden bg-maroon-950 bg-opacity-40 rounded-md mt-1 pl-4 space-y-1" style="<?php echo e(in_array(Route::currentRouteName(), ['admin.usm', 'admin.archived', 'admin.datasync', 'admin.audit-trail']) ? 'max-height: 500px;' : 'max-height: 0px;'); ?>">
                        <a href="<?php echo e(route('admin.usm')); ?>" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all <?php echo e(Route::currentRouteName() === 'admin.usm' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1'); ?>" data-page="usm">
                            <i data-lucide="key-round" class="w-3.5 h-3.5 <?php echo e(Route::currentRouteName() === 'admin.usm' ? 'text-maroon-950' : 'text-red-400'); ?>"></i>
                            <span>USM (Admin Access Only)</span>
                        </a>
                        <a href="<?php echo e(route('admin.archived')); ?>" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all <?php echo e(Route::currentRouteName() === 'admin.archived' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1'); ?>" data-page="archived">
                            <i data-lucide="archive" class="w-3.5 h-3.5 <?php echo e(Route::currentRouteName() === 'admin.archived' ? 'text-maroon-950' : ''); ?>"></i>
                            <span>Archived</span>
                        </a>
                        <a href="<?php echo e(route('admin.datasync')); ?>" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all <?php echo e(Route::currentRouteName() === 'admin.datasync' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1'); ?>" data-page="datasync">
                            <i data-lucide="refresh-cw" class="w-3.5 h-3.5 <?php echo e(Route::currentRouteName() === 'admin.datasync' ? 'text-maroon-950' : ''); ?>"></i>
                            <span>Data Sync</span>
                        </a>
                        <a href="<?php echo e(route('admin.audit-trail')); ?>" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all <?php echo e(Route::currentRouteName() === 'admin.audit-trail' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1'); ?>" data-page="audit">
                            <i data-lucide="file-spreadsheet" class="w-3.5 h-3.5 <?php echo e(Route::currentRouteName() === 'admin.audit-trail' ? 'text-maroon-950' : ''); ?>"></i>
                ...
                <div class="menu-dropdown">
                    <button onclick="toggleDropdown('dropdown-master', this)" class="w-full flex items-center justify-between px-3 py-3 rounded-lg hover:bg-maroon-800 text-gray-100 hover:text-white transition-all group" title="Master List">
                        ...
                        <i data-lucide="chevron-down" class="dropdown-chevron w-4 h-4 text-goldlining-500 rotate-transition sidebar-text <?php echo e(in_array(Route::currentRouteName(), ['admin.prod-master', 'admin.prod-online-config']) ? 'rotate-180' : ''); ?>"></i>
                    </button>
                    <div id="dropdown-master" class="submenu-transition overflow-hidden bg-maroon-950 bg-opacity-40 rounded-md mt-1 pl-4 space-y-1" style="<?php echo e(in_array(Route::currentRouteName(), ['admin.prod-master', 'admin.prod-online-config']) ? 'max-height: 500px;' : 'max-height: 0px;'); ?>">
                        <a href="<?php echo e(route('admin.prod-master')); ?>" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all <?php echo e(Route::currentRouteName() === 'admin.prod-master' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1'); ?>" data-page="prod-master">
                            <i data-lucide="package" class="w-3.5 h-3.5 <?php echo e(Route::currentRouteName() === 'admin.prod-master' ? 'text-maroon-950' : ''); ?>"></i>
                            <span>Product Master List</span>
                        </a>
                        <a href="<?php echo e(route('admin.prod-online-config')); ?>" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all <?php echo e(Route::currentRouteName() === 'admin.prod-online-config' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1'); ?>" data-page="prod-online-config">
                            <i data-lucide="refresh-cw" class="w-3.5 h-3.5 <?php echo e(Route::currentRouteName() === 'admin.prod-online-config' ? 'text-maroon-950' : 'text-cyan-400'); ?>"></i>
                            <span>Online Product Config</span>
                        </a>
                        <a href="<?php echo e(route('admin.supplier-master')); ?>" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all <?php echo e(Route::currentRouteName() === 'admin.supplier-master' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1'); ?>" data-page="supplier-master">
                            <i data-lucide="truck" class="w-3.5 h-3.5 <?php echo e(Route::currentRouteName() === 'admin.supplier-master' ? 'text-maroon-950' : 'text-blue-400'); ?>"></i>
                            <span>Supplier Master List</span>
                        </a>
                        <a href="<?php echo e(route('admin.customer-master')); ?>" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all <?php echo e(Route::currentRouteName() === 'admin.customer-master' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1'); ?>" data-page="customer-master">
                            <i data-lucide="users" class="w-3.5 h-3.5 <?php echo e(Route::currentRouteName() === 'admin.customer-master' ? 'text-maroon-950' : 'text-emerald-400'); ?>"></i>
                            <span>Customer Master List</span>
                        </a>
                        <a href="<?php echo e(route('admin.forwarder-master')); ?>" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all <?php echo e(Route::currentRouteName() === 'admin.forwarder-master' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1'); ?>" data-page="forwarder-master">
                            <i data-lucide="plane" class="w-3.5 h-3.5 <?php echo e(Route::currentRouteName() === 'admin.forwarder-master' ? 'text-maroon-950' : 'text-emerald-400'); ?>"></i>
                ...
                <div class="menu-dropdown">
                    <button onclick="toggleDropdown('dropdown-inventory', this)" class="w-full flex items-center justify-between px-3 py-3 rounded-lg hover:bg-maroon-800 text-gray-100 hover:text-white transition-all group" title="Inventory Management">
                        ...
                        <i data-lucide="chevron-down" class="dropdown-chevron w-4 h-4 text-goldlining-500 rotate-transition sidebar-text <?php echo e(in_array(Route::currentRouteName(), ['admin.inv-adjust', 'admin.sales-junk', 'admin.item-convert']) ? 'rotate-180' : ''); ?>"></i>
                    </button>
                    <div id="dropdown-inventory" class="submenu-transition overflow-hidden bg-maroon-950 bg-opacity-40 rounded-md mt-1 pl-4 space-y-1" style="<?php echo e(in_array(Route::currentRouteName(), ['admin.inv-adjust', 'admin.sales-junk', 'admin.item-convert']) ? 'max-height: 500px;' : 'max-height: 0px;'); ?>">
                        <a href="<?php echo e(route('admin.inv-adjust')); ?>" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all <?php echo e(Route::currentRouteName() === 'admin.inv-adjust' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1'); ?>" data-page="inv-adjust">
                            <i data-lucide="sliders-horizontal" class="w-3.5 h-3.5 <?php echo e(Route::currentRouteName() === 'admin.inv-adjust' ? 'text-maroon-950' : ''); ?>"></i>
                            <span>Inventory Adjustment</span>
                        </a>
                        <a href="<?php echo e(route('admin.sales-junk')); ?>" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all <?php echo e(Route::currentRouteName() === 'admin.sales-junk' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1'); ?>" data-page="sales-junk">
                            <i data-lucide="archive" class="w-3.5 h-3.5 <?php echo e(Route::currentRouteName() === 'admin.sales-junk' ? 'text-maroon-950' : ''); ?>"></i>
                            <span>Junk Items</span>
                        </a>
                         <a href="<?php echo e(route('admin.item-convert')); ?>" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all <?php echo e(Route::currentRouteName() === 'admin.item-convert' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1'); ?>" data-page="item-convert">
                            <i data-lucide="shuffle" class="w-3.5 h-3.5 <?php echo e(Route::currentRouteName() === 'admin.item-convert' ? 'text-maroon-950' : ''); ?>"></i>
                ...
                <div class="menu-dropdown">
                    <button onclick="toggleDropdown('dropdown-purchasing', this)" class="w-full flex items-center justify-between px-3 py-3 rounded-lg hover:bg-maroon-800 text-gray-100 hover:text-white transition-all group" title="Purchasing">
                        ...
                        <i data-lucide="chevron-down" class="dropdown-chevron w-4 h-4 text-goldlining-500 rotate-transition sidebar-text <?php echo e(in_array(Route::currentRouteName(), ['admin.purchase-viber', 'admin.purchase-note', 'admin.purchase-order', 'admin.purchase-return']) ? 'rotate-180' : ''); ?>"></i>
                    </button>
                    <div id="dropdown-purchasing" class="submenu-transition overflow-hidden bg-maroon-950 bg-opacity-40 rounded-md mt-1 pl-4 space-y-1" style="<?php echo e(in_array(Route::currentRouteName(), ['admin.purchase-viber', 'admin.purchase-note', 'admin.purchase-order', 'admin.purchase-return']) ? 'max-height: 500px;' : 'max-height: 0px;'); ?>">
                          <a href="<?php echo e(route('admin.purchase-viber')); ?>" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all <?php echo e(Route::currentRouteName() === 'admin.purchase-viber' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1'); ?>" data-page="viber-list">
                            <i data-lucide="file-text" class="w-3.5 h-3.5 <?php echo e(Route::currentRouteName() === 'admin.purchase-viber' ? 'text-maroon-950' : ''); ?>"></i>
                            <span>Purchase Entry</span>
                        </a>
                        <a href="<?php echo e(route('admin.purchase-note')); ?>" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all <?php echo e(Route::currentRouteName() === 'admin.purchase-note' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1'); ?>" data-page="purch-note">
                            <i data-lucide="file-text" class="w-3.5 h-3.5 <?php echo e(Route::currentRouteName() === 'admin.purchase-note' ? 'text-maroon-950' : ''); ?>"></i>
                            <span>Purchasing Note</span>
                        </a>
                        <a href="<?php echo e(route('admin.purchase-order')); ?>" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all <?php echo e(Route::currentRouteName() === 'admin.purchase-order' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1'); ?>" data-page="purch-order">
                            <i data-lucide="shopping-bag" class="w-3.5 h-3.5 <?php echo e(Route::currentRouteName() === 'admin.purchase-order' ? 'text-maroon-950' : ''); ?>"></i>
                            <span>Purchase Order</span>
                        </a>
                        <a href="<?php echo e(route('admin.purchase-return')); ?>" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all <?php echo e(Route::currentRouteName() === 'admin.purchase-return' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1'); ?>" data-page="purch-return">
                            <i data-lucide="undo-2" class="w-3.5 h-3.5 <?php echo e(Route::currentRouteName() === 'admin.purchase-return' ? 'text-maroon-950' : ''); ?>"></i>
                ...
                <div class="menu-dropdown">
                    <button onclick="toggleDropdown('dropdown-sales', this)" class="w-full flex items-center justify-between px-3 py-3 rounded-lg hover:bg-maroon-800 text-gray-100 hover:text-white transition-all group" title="Sales">
                        ...
                        <i data-lucide="chevron-down" class="dropdown-chevron w-4 h-4 text-goldlining-500 rotate-transition sidebar-text <?php echo e(in_array(Route::currentRouteName(), ['admin.sales-note', 'admin.sales-order', 'admin.consignment-invoice', 'admin.waybill']) ? 'rotate-180' : ''); ?>"></i>
                    </button>
                    <div id="dropdown-sales" class="submenu-transition overflow-hidden bg-maroon-950 bg-opacity-40 rounded-md mt-1 pl-4 space-y-1" style="<?php echo e(in_array(Route::currentRouteName(), ['admin.sales-note', 'admin.sales-order', 'admin.consignment-invoice', 'admin.waybill']) ? 'max-height: 500px;' : 'max-height: 0px;'); ?>">
                        <a href="<?php echo e(route('admin.sales-note')); ?>" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all <?php echo e(Route::currentRouteName() === 'admin.sales-note' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1'); ?>" data-page="sales-note">
                            <i data-lucide="receipt" class="w-3.5 h-3.5 <?php echo e(Route::currentRouteName() === 'admin.sales-note' ? 'text-maroon-950' : ''); ?>"></i>
                            <span>Sales Note</span>
                        </a>
                        <a href="<?php echo e(route('admin.sales-order')); ?>" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all <?php echo e(Route::currentRouteName() === 'admin.sales-order' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1'); ?>" data-page="sales-order">
                            <i data-lucide="file-symlink" class="w-3.5 h-3.5 <?php echo e(Route::currentRouteName() === 'admin.sales-order' ? 'text-maroon-950' : ''); ?>"></i>
                            <span>Sales Order</span>
                        </a>
                        <a href="<?php echo e(route('admin.consignment-invoice')); ?>" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all <?php echo e(Route::currentRouteName() === 'admin.consignment-invoice' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1'); ?>" data-page="cons-invoice">
                            <i data-lucide="file-digit" class="w-3.5 h-3.5 <?php echo e(Route::currentRouteName() === 'admin.consignment-invoice' ? 'text-maroon-950' : ''); ?>"></i>
                            <span>Consignment Invoice</span>
                        </a>
                        <a href="<?php echo e(route('admin.sales-return')); ?>" class="flex items-center space-x-2 py-2 px-3 text-xs <?php echo e(Request::routeIs('admin.sales-return') ? 'text-goldlining-400 bg-maroon/20' : 'text-gray-300'); ?> hover:text-goldlining-400 hover:translate-x-1 transition-all rounded" data-page="sales-return">
                            <i data-lucide="corner-up-left" class="w-3.5 h-3.5"></i>
                            <span>Sales Return</span>
                        </a>

                        <a href="<?php echo e(route('admin.waybill')); ?>" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all <?php echo e(Route::currentRouteName() === 'admin.waybill' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1'); ?>" data-page="waybill">
                            <i data-lucide="map" class="w-3.5 h-3.5 <?php echo e(Route::currentRouteName() === 'admin.waybill' ? 'text-maroon-950' : ''); ?>"></i>
                            <span>Waybill</span>
                        </a>
                    </div>
                </div>
                ...
                <!-- ACCOUNTING (DROPDOWN) -->
                <div class="menu-dropdown">
                    <button onclick="toggleDropdown('dropdown-accounting', this)" class="w-full flex items-center justify-between px-3 py-3 rounded-lg hover:bg-maroon-800 <?php echo e(in_array(Route::currentRouteName(), ['admin.payments', 'admin.payable-cheque-voucher', 'admin.expense-cheque-voucher']) ? 'bg-maroon-800 text-white shadow-inner' : 'text-gray-100'); ?> hover:text-white transition-all group" title="Accounting">
                        <div class="flex items-center space-x-3">
                            <i data-lucide="calculator" class="w-5 h-5 text-goldlining-400 group-hover:scale-110 transition-transform flex-shrink-0"></i>
                            <span class="sidebar-text text-sm whitespace-nowrap <?php echo e(in_array(Route::currentRouteName(), ['admin.payments', 'admin.payable-cheque-voucher', 'admin.expense-cheque-voucher']) ? 'font-bold text-goldlining-400' : ''); ?>">Accounting</span>
                        </div>
                        <i data-lucide="chevron-down" class="dropdown-chevron w-4 h-4 text-goldlining-500 rotate-transition sidebar-text <?php echo e(in_array(Route::currentRouteName(), ['admin.payments', 'admin.payable-cheque-voucher', 'admin.expense-cheque-voucher']) ? 'rotate-180' : ''); ?>"></i>
                    </button>
                    <div id="dropdown-accounting" class="submenu-transition overflow-hidden bg-maroon-950 bg-opacity-40 rounded-md mt-1 pl-4 space-y-1" style="<?php echo e(in_array(Route::currentRouteName(), ['admin.payments', 'admin.payable-cheque-voucher', 'admin.expense-cheque-voucher']) ? 'max-height: 500px;' : 'max-height: 0px;'); ?>">
                        <a href="<?php echo e(route('admin.payments')); ?>" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all <?php echo e(Route::currentRouteName() === 'admin.payments' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1'); ?>" data-page="payments">
                            <i data-lucide="credit-card" class="w-3.5 h-3.5 <?php echo e(Route::currentRouteName() === 'admin.payments' ? 'text-maroon-950' : ''); ?>"></i>
                            <span>Payments</span>
                        </a>
                        <a href="<?php echo e(route('admin.payable-cheque-voucher')); ?>" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all <?php echo e(Route::currentRouteName() === 'admin.payable-cheque-voucher' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1'); ?>" data-page="pay-cheque">
                            <i data-lucide="book-check" class="w-3.5 h-3.5 <?php echo e(Route::currentRouteName() === 'admin.payable-cheque-voucher' ? 'text-maroon-950' : ''); ?>"></i>
                            <span>Payable Cheque Voucher</span>
                        </a>
                        <a href="<?php echo e(route('admin.expense-cheque-voucher')); ?>" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all <?php echo e(Route::currentRouteName() === 'admin.expense-cheque-voucher' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1'); ?>" data-page="exp-cheque">
                            <i data-lucide="receipt" class="w-3.5 h-3.5 <?php echo e(Route::currentRouteName() === 'admin.expense-cheque-voucher' ? 'text-maroon-950' : ''); ?>"></i>
                ...
                <!-- REPORTS (DROPDOWN) -->
                <div class="menu-dropdown">
                    <button onclick="toggleDropdown('dropdown-reports', this)" class="w-full flex items-center justify-between px-3 py-3 rounded-lg hover:bg-maroon-800 <?php echo e(in_array(Route::currentRouteName(), ['admin.sales-report', 'admin.inventory-reports', 'admin.accounts-receivable', 'admin.cost-report', 'admin.top-products']) ? 'bg-maroon-800 text-white shadow-inner' : 'text-gray-100'); ?> hover:text-white transition-all group" title="Reports">
                        <div class="flex items-center space-x-3">
                            <i data-lucide="trending-up" class="w-5 h-5 text-goldlining-400 group-hover:scale-110 transition-transform flex-shrink-0"></i>
                            <span class="sidebar-text text-sm whitespace-nowrap <?php echo e(in_array(Route::currentRouteName(), ['admin.sales-report', 'admin.inventory-reports', 'admin.accounts-receivable', 'admin.cost-report', 'admin.top-products']) ? 'font-bold text-goldlining-400' : ''); ?>">Reports</span>
                        </div>
                        <i data-lucide="chevron-down" class="dropdown-chevron w-4 h-4 text-goldlining-500 rotate-transition sidebar-text <?php echo e(in_array(Route::currentRouteName(), ['admin.sales-report', 'admin.inventory-reports', 'admin.accounts-receivable', 'admin.cost-report', 'admin.top-products']) ? 'rotate-180' : ''); ?>"></i>
                    </button>
                    <div id="dropdown-reports" class="submenu-transition overflow-hidden bg-maroon-950 bg-opacity-40 rounded-md mt-1 pl-4 space-y-1" style="<?php echo e(in_array(Route::currentRouteName(), ['admin.sales-report', 'admin.inventory-reports', 'admin.accounts-receivable', 'admin.cost-report', 'admin.top-products']) ? 'max-height: 500px;' : 'max-height: 0px;'); ?>">
                        <a href="<?php echo e(route('admin.sales-report')); ?>" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all <?php echo e(Route::currentRouteName() === 'admin.sales-report' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1'); ?>" data-page="rep-sales">
                            <i data-lucide="bar-chart-3" class="w-3.5 h-3.5 <?php echo e(Route::currentRouteName() === 'admin.sales-report' ? 'text-maroon-950' : ''); ?>"></i>
                            <span>Account Receivable</span>
                        </a>
                        <a href="<?php echo e(route('admin.inventory-reports')); ?>" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all <?php echo e(Route::currentRouteName() === 'admin.inventory-reports' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1'); ?>" data-page="rep-inv">
                            <i data-lucide="package-search" class="w-3.5 h-3.5 <?php echo e(Route::currentRouteName() === 'admin.inventory-reports' ? 'text-maroon-950' : ''); ?>"></i>
                            <span>Unserved Details</span>
                        </a>
                        
                        <a href="<?php echo e(route('admin.accounts-receivable')); ?>" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all <?php echo e(Route::currentRouteName() === 'admin.accounts-receivable' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1'); ?>" data-page="rep-ar">
                            <i data-lucide="arrow-down-left" class="w-3.5 h-3.5 <?php echo e(Route::currentRouteName() === 'admin.accounts-receivable' ? 'text-maroon-950' : ''); ?>"></i>
                            <span>Accounts Receivable Reports</span>
                        </a>
                        <a href="<?php echo e(route('admin.cost-report')); ?>" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all <?php echo e(Route::currentRouteName() === 'admin.cost-report' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1'); ?>" data-page="rep-cost">
                            <i data-lucide="receipt" class="w-3.5 h-3.5 <?php echo e(Route::currentRouteName() === 'admin.cost-report' ? 'text-maroon-950' : ''); ?>"></i>
                            <span>Cost Report</span>
                        </a>
                        <a href="<?php echo e(route('admin.top-products')); ?>" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all <?php echo e(Route::currentRouteName() === 'admin.top-products' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1'); ?>" data-page="rep-top-products">
                            <i data-lucide="trophy" class="w-3.5 h-3.5 <?php echo e(Route::currentRouteName() === 'admin.top-products' ? 'text-maroon-950' : ''); ?>"></i>
        ...
        <main class="flex-1 flex flex-col min-w-0 overflow-hidden">
                    ...
                    <div class="relative">
                        <button id="notif-btn" class="p-2 rounded-full hover:bg-gray-100 text-gray-600 relative transition-all" title="View Notifications">
                            ...
                            <?php if($activeSystemThemeIcons['notification']): ?>
                                <img src="<?php echo e($systemThemeAssetSrc($activeSystemThemeIcons['notification'])); ?>" id="bell-icon" alt="<?php echo e($activeSystemThemeIcons['chat_label']); ?> notification" class="system-theme-navbar-icon">
                            <?php else: ?>
                    ...
                    <div class="relative">
                        ...
                        <button id="profile-dropdown-btn" class="flex items-center space-x-2.5 cursor-pointer hover:bg-gray-50 transition-all p-1.5 rounded-lg focus:outline-none" title="User Menu">
                            ...
                            <div class="hidden lg:block text-left">
                                <h5 class="text-xs font-bold text-gray-800 leading-tight"><?php echo e($sidebarFullName); ?></h5>
                                <span class="text-[10px] text-gray-500 block"><?php echo e($sidebarRoleLabel); ?></span>
                            </div>
                        </button>
                        ...
                        <div id="profile-dropdown" class="hidden absolute right-0 mt-3 w-48 bg-maroon-900 border border-goldlining-500 rounded-xl shadow-xl z-50 overflow-hidden py-1 text-white">
                            <a href="<?php echo e(route('admin.profile')); ?>" class="flex items-center space-x-2.5 px-4 py-2.5 text-sm text-gray-100 hover:bg-maroon-800 hover:text-goldlining-400 transition-colors">
            ...
            <div id="workspace" class="flex-1 overflow-y-auto p-6 md:p-8 space-y-6">
                        ...
                        <nav class="flex text-xs font-medium text-gray-500 space-x-2" aria-label="Breadcrumb">
                            ...
                            <span id="breadcrumb-current" class="text-maroon-700 font-semibold">
                                <?php if(Route::currentRouteName() === 'admin.usm'): ?>
                                    System Security / USM
                                <?php elseif(Route::currentRouteName() === 'admin.prod-master'): ?>
                                    Master List / Product Master
                                <?php elseif(Route::currentRouteName() === 'admin.prod-online-config'): ?>
                                    Master List / Online Product Config
                                <?php elseif(Route::currentRouteName() === 'admin.purchase-note'): ?>
                                    Purchasing / Purchasing Note
                                <?php elseif(Route::currentRouteName() === 'admin.purchase-order'): ?>
                                    Purchasing / Purchase Order
                                <?php elseif(Route::currentRouteName() === 'admin.purchase-return'): ?>
                                    Purchasing / Purchase Return
                                <?php elseif(Route::currentRouteName() === 'admin.purchase-viber'): ?>
                                    Purchasing / Viber List
                                <?php elseif(Route::currentRouteName() === 'admin.sales-note'): ?>
                                    Sales / Sales Note
                                <?php elseif(Route::currentRouteName() === 'admin.profile'): ?>
                                    Profile / Admin Profile
                                <?php elseif(Route::currentRouteName() === 'admin.payments'): ?>
                                    Accounting / Payments
                                <?php elseif(Route::currentRouteName() === 'admin.payable-cheque-voucher'): ?>
                                    Accounting / Payable Cheque Voucher
                                <?php elseif(Route::currentRouteName() === 'admin.expense-cheque-voucher'): ?>
                                    Accounting / Expense Cheque Voucher
                                <?php elseif(Route::currentRouteName() === 'admin.sales-junk'): ?>
                                    Inventory / Junk Items
                                <?php elseif(Route::currentRouteName() === 'admin.item-convert'): ?>
                                    Inventory / Convert Items
                                <?php elseif(Route::currentRouteName() === 'admin.cost-report'): ?>
                                    Reports / Cost Report
                                <?php elseif(Route::currentRouteName() === 'admin.top-products'): ?>
                ...
                <div id="page-dashboard" class="page-view space-y-6 <?php echo e(Route::currentRouteName() === 'admin.dashboard' ? '' : 'hidden'); ?>">
                ...
                <div id="page-prod-master-container" class="page-view space-y-6 <?php echo e(Route::currentRouteName() === 'admin.prod-master' ? '' : 'hidden'); ?>">
                    <?php echo $__env->yieldContent('prod_master_content'); ?>
                </div>

                <!-- PAGE: MASTER LIST -> ONLINE PRODUCT CONFIG -->
                <div id="page-prod-online-config-container" class="page-view space-y-6 <?php echo e(Route::currentRouteName() === 'admin.prod-online-config' ? '' : 'hidden'); ?>">
                    <?php echo $__env->yieldContent('prod_online_config_content'); ?>
                </div>

                <!-- PAGE: MASTER LIST -> SUPPLIER MASTER -->
                <div id="page-supplier-master-container" class="page-view space-y-6 <?php echo e(Route::currentRouteName() === 'admin.supplier-master' ? '' : 'hidden'); ?>">
                    <?php echo $__env->yieldContent('supplier_master_content'); ?>
                </div>

                <!-- PAGE: MASTER LIST -> CUSTOMER MASTER -->
                <div id="page-customer-master-container" class="page-view space-view space-y-6 <?php echo e(Route::currentRouteName() === 'admin.customer-master' ? '' : 'hidden'); ?>">
                    <?php echo $__env->yieldContent('customer_master_content'); ?>
                </div>

                <!-- PAGE: PURCHASING -> PURCHASING NOTE -->
                <div id="page-purchase-note-container" class="page-view space-y-6 <?php echo e(Route::currentRouteName() === 'admin.purchase-note' ? '' : 'hidden'); ?>">
                    <?php echo $__env->yieldContent('purchase_note_content'); ?>
                </div>

                <!-- PAGE: PURCHASING -> PURCHASE ORDER -->
                <div id="page-purchase-order-container" class="page-view space-y-6 <?php echo e(Route::currentRouteName() === 'admin.purchase-order' ? '' : 'hidden'); ?>">
                    <?php echo $__env->yieldContent('purchase_order_content'); ?>
                </div>

                <!-- PAGE: PURCHASING -> PURCHASE RETURN -->
                <div id="page-purchase-return-container" class="page-view space-y-6 <?php echo e(Route::currentRouteName() === 'admin.purchase-return' ? '' : 'hidden'); ?>">
                    <?php echo $__env->yieldContent('purchase_return_content'); ?>
                </div>

                <!-- PAGE: PURCHASING -> VIBER LIST -->
                <div id="page-purchase-viber-container" class="page-view space-y-6 <?php echo e(Route::currentRouteName() === 'admin.purchase-viber' ? '' : 'hidden'); ?>">
                    <?php echo $__env->yieldContent('purchase_viber_content'); ?>
                </div>

                <!-- PAGE: SALES -> SALES NOTE -->
                <div id="page-sales-note-container" class="page-view space-y-6 <?php echo e(in_array(Route::currentRouteName(), ['admin.sales-note', 'admin.sales-note.online-prices', 'admin.sales-note.report-redirect']) ? '' : 'hidden'); ?>">
                    <?php echo $__env->yieldContent('sales_note_content'); ?>
                </div>

                <!-- PAGE: SALES -> SALES ORDER -->
                <div id="page-sales-order-container" class="page-view space-y-6 <?php echo e(Route::currentRouteName() === 'admin.sales-order' ? '' : 'hidden'); ?>">
                    <?php echo $__env->yieldContent('sales_order_content'); ?>
                </div>

                <!-- PAGE: SALES -> CONSIGNMENT INVOICE -->
                <div id="page-cons-invoice" class="page-view space-y-6 <?php echo e(Route::currentRouteName() === 'admin.consignment-invoice' ? '' : 'hidden'); ?>">
                    <?php echo $__env->yieldContent('cons_invoice_content'); ?>
                </div>

                <!-- PAGE: SALES -> WAYBILL -->
                <div id="page-waybill" class="page-view space-y-6 <?php echo e(Route::currentRouteName() === 'admin.waybill' ? '' : 'hidden'); ?>">
                    <?php echo $__env->yieldContent('waybill_content'); ?>
                </div>

                <!-- PAGE: MASTER LIST -> FORWARDER MASTER -->
                <div id="page-forwarder-master-container" class="page-view space-y-6 <?php echo e(Route::currentRouteName() === 'admin.forwarder-master' ? '' : 'hidden'); ?>">
                    <?php echo $__env->yieldContent('forwarder_master_content'); ?>
                </div>

                <!-- PAGE: INVENTORY -> INVENTORY ADJUSTMENT -->
                <div id="page-inv-adjust-container" class="page-view space-y-6 <?php echo e(Route::currentRouteName() === 'admin.inv-adjust' ? '' : 'hidden'); ?>">
                    <?php echo $__env->yieldContent('inventory_adjustment_content'); ?>
                </div>

                <!-- PAGE: INVENTORY -> JUNK ITEMS -->
                <div id="page-sales-junk-container" class="page-view space-y-6 <?php echo e(Route::currentRouteName() === 'admin.sales-junk' ? '' : 'hidden'); ?>">
                    <?php echo $__env->yieldContent('sales_junk_content'); ?>
                </div>

                <!-- PAGE: INVENTORY -> ITEM CONVERT -->
                <div id="page-item-convert-container" class="page-view space-y-6 <?php echo e(Route::currentRouteName() === 'admin.item-convert' ? '' : 'hidden'); ?>">
                    <?php echo $__env->yieldContent('item_convert_content'); ?>
                </div>

                <!-- PAGE: SALES -> SALES RETURN -->
                <div id="page-sales-return-container" class="page-view space-y-6 <?php echo e(Route::currentRouteName() === 'admin.sales-return' ? '' : 'hidden'); ?>">
                    <?php echo $__env->yieldContent('sales_return_content'); ?>
                </div>

                <!-- PAGE: ACCOUNTING -> PAYMENTS -->
                <div id="page-payments" class="page-view space-y-6 <?php echo e(Route::currentRouteName() === 'admin.payments' ? '' : 'hidden'); ?>">
                    <?php echo $__env->yieldContent('payments_content'); ?>
                </div>

                <!-- PAGE: ADMIN PROFILE -->
                <div id="page-admin-profile" class="page-view space-y-6 <?php echo e(Route::currentRouteName() === 'admin.profile' ? '' : 'hidden'); ?>">
                    <?php echo $__env->yieldContent('admin_profile_content'); ?>
                </div>

                <!-- PAGE: ACCOUNTING -> PAYABLE CHEQUE VOUCHER -->
                <div id="page-payable-cheque-voucher-container" class="page-view space-y-6 <?php echo e(Route::currentRouteName() === 'admin.payable-cheque-voucher' ? '' : 'hidden'); ?>">
                    <?php echo $__env->yieldContent('payable_cheque_voucher_content'); ?>
                </div>

                <!-- PAGE: ACCOUNTING -> EXPENSE CHEQUE VOUCHER -->
                <div id="page-exp-cheque" class="page-view space-y-6 <?php echo e(Route::currentRouteName() === 'admin.expense-cheque-voucher' ? '' : 'hidden'); ?>">
                    <?php echo $__env->yieldContent('expense_cheque_voucher_content'); ?>
                </div>
                <!-- PAGE: REPORTS -> INVENTORY REPORTS -->
                <div id="page-rep-inv" class="page-view space-y-6 <?php echo e(Route::currentRouteName() === 'admin.inventory-reports' ? '' : 'hidden'); ?>">
                    <?php echo $__env->yieldContent('inventory_reports_content'); ?>
                </div>
                <!-- PAGE: REPORTS -> SALES REPORTS -->
                <div id="page-rep-sales" class="page-view space-y-6 <?php echo e(in_array(Route::currentRouteName(), ['admin.sales-report', 'admin.top-products']) ? '' : 'hidden'); ?>">
                    <?php echo $__env->yieldContent('sales_report_content'); ?>
                </div>
                <!-- PAGE: REPORTS -> ACCOUNTS RECEIVABLE -->
                <div id="page-rep-ar" class="page-view space-y-6 <?php echo e(Route::currentRouteName() === 'admin.accounts-receivable' ? '' : 'hidden'); ?>">
                    <?php echo $__env->yieldContent('accounts_receivable_content'); ?>
                </div>
                <!-- PAGE: REPORTS -> COST REPORT -->
                <div id="page-rep-cost" class="page-view space-y-6 <?php echo e(Route::currentRouteName() === 'admin.cost-report' ? '' : 'hidden'); ?>">
                ...
                <div id="page-audit" class="page-view space-y-6 <?php echo e(Route::currentRouteName() === 'admin.audit-trail' ? '' : 'hidden'); ?>">
                    <?php echo $__env->yieldContent('audit_trail_content'); ?>
                </div>
    ...
    <div id="chat-float-btn" class="fixed bottom-6 right-6 w-14 h-14 bg-maroon-900 border-2 border-goldlining-500 rounded-full flex items-center justify-center cursor-grab shadow-2xl z-[200] select-none" style="touch-action:none;" title="<?php echo e($activeSystemThemeIcons['chat_label']); ?>">
        <?php if($activeSystemThemeIcons['chat_image']): ?>
            <img src="<?php echo e($systemThemeAssetSrc($activeSystemThemeIcons['chat_image'])); ?>" alt="<?php echo e($activeSystemThemeIcons['chat_label']); ?>" class="system-theme-chat-icon pointer-events-none">
        <?php else: ?>
            <i data-lucide="<?php echo e($activeSystemThemeIcons['chat_lucide'] ?? 'message-circle'); ?>" class="w-7 h-7 text-goldlining-400 pointer-events-none"></i>
        <?php endif; ?>
    </div>
    ...
    <div id="chat-box" class="fixed hidden flex flex-col" style="width:360px;height:520px;z-index:200;border-radius:16px;background:#fff;border:1px solid #e5e7eb;box-shadow:0 20px 60px rgba(0,0,0,0.25);overflow:hidden;">
        <div class="bg-maroon-900 text-white px-4 py-3 flex items-center justify-between flex-shrink-0" id="chat-header" style="cursor:move;">
            <span class="font-bold text-sm flex items-center gap-2">
                <?php if($activeSystemThemeIcons['chat_image']): ?>
                    <img src="<?php echo e($systemThemeAssetSrc($activeSystemThemeIcons['chat_image'])); ?>" alt="<?php echo e($activeSystemThemeIcons['chat_label']); ?>" class="system-theme-chat-header-icon">
                <?php else: ?>
                    <i data-lucide="<?php echo e($activeSystemThemeIcons['chat_lucide'] ?? 'message-circle'); ?>" class="w-4 h-4 text-goldlining-400"></i>
                <?php endif; ?>
                AI Chat
            </span>
            <div class="flex items-center gap-2">
    ...
    <script>
        ...
        function executeLogout() {
            ...
            const successModal = document.getElementById('success-logout-modal');
        ...
        (function(){
            ...
            function addMessage(role, text, skipRedirect = false) {
                ...
                if (isUser) {
                    ...
                    // ── Auto-redirect logic ──
                    // Scan for [REDIRECT](url) links produced by AI and navigate browser
                    ...
                    if (redirectLink) {
                        ...
                        // Replace the [REDIRECT] link with a styled pill indicator
                        ...
                        // Navigate after a short delay so user can read the message
                        if (!skipRedirect) {
                            setTimeout(function() {
            ...
            // ── Slow Moving Products date range parser ──
            // Supports: 2020-2026, 2026, July 2026, January 2024-March 2026,
            //           2024-01-01-2026-07-15, 2026-07-15
            function parseSlowMovingDateRange(str) {
                var result = { startDate: null, endDate: null, label: '' };
                if (!str || str.length === 0) return result;
                var months = ['january','february','march','april','may','june','july','august','september','october','november','december'];

                // 1) ISO date range: 2024-01-01 - 2026-07-15
                var m = str.match(/^(\d{4}-\d{2}-\d{2})\s*[-–]\s*(\d{4}-\d{2}-\d{2})$/);
                if (m) { result.startDate = m[1]; result.endDate = m[2]; result.label = m[1] + ' - ' + m[2]; return result; }

                // 2) Single ISO date: 2026-07-15
                m = str.match(/^(\d{4}-\d{2}-\d{2})$/);
                if (m) { result.startDate = m[1]; result.endDate = m[1]; result.label = m[1]; return result; }

                // 3) Month range: January 2024 - March 2026
                m = str.match(/^([a-z]+)\s+(\d{4})\s*[-–]\s*([a-z]+)\s+(\d{4})$/i);
                if (m) {
                    var mi1 = months.indexOf(m[1].toLowerCase()), mi2 = months.indexOf(m[3].toLowerCase());
                    if (mi1 >= 0 && mi2 >= 0) {
                        var y1 = parseInt(m[2]), y2 = parseInt(m[4]);
                        result.startDate = y1 + '-' + String(mi1+1).padStart(2,'0') + '-01';
                        var ld = new Date(y2, mi2+1, 0).getDate();
                        result.endDate = y2 + '-' + String(mi2+1).padStart(2,'0') + '-' + String(ld).padStart(2,'0');
                        result.label = m[1] + ' ' + y1 + ' - ' + m[3] + ' ' + y2;
                        return result;
                    }
                }

                // 4) Single month: July 2026
                m = str.match(/^([a-z]+)\s+(\d{4})$/i);
                if (m) {
                    var mi = months.indexOf(m[1].toLowerCase());
                    if (mi >= 0) {
                        var yr = parseInt(m[2]);
                        result.startDate = yr + '-' + String(mi+1).padStart(2,'0') + '-01';
                        var ld2 = new Date(yr, mi+1, 0).getDate();
                        result.endDate = yr + '-' + String(mi+1).padStart(2,'0') + '-' + String(ld2).padStart(2,'0');
                        result.label = m[1] + ' ' + yr;
                        return result;
                    }
                }

                // 5) Year range: 2020 - 2026
                m = str.match(/^(\d{4})\s*[-–]\s*(\d{4})$/);
                if (m) { result.startDate = m[1] + '-01-01'; result.endDate = m[2] + '-12-31'; result.label = m[1] + ' - ' + m[2]; return result; }

                // 6) Single year: 2026
                m = str.match(/^(\d{4})$/);
                if (m) { result.startDate = m[1] + '-01-01'; result.endDate = m[1] + '-12-31'; result.label = m[1]; return result; }
            ...
            function sendMessage() {
                ...
                // ── Slow Moving Products trigger (with date range support) ──
                var smpMatch = text.match(/^slow moving products(?:\s+(.+))?$/i);
                if (smpMatch) {
                    var dateStr = (smpMatch[1] || '').trim();
                    var dateInfo = parseSlowMovingDateRange(dateStr);
                    var genUrl = '<?php echo e(route("admin.ai.slow-moving-products.generate")); ?>';
                    var estUrl = '<?php echo e(route("admin.ai.slow-moving-products.estimate")); ?>';
                    var csrfToken = document.querySelector('meta[name="csrf-token"]').getAttribute('content');

                    addMessage('model', dateInfo.label
                        ? 'Generating Slow Moving Products report for period ' + dateInfo.label + '...'
                        : 'Slow moving products are products with little or no outgoing movement.'
                    );
                    setLoading(true);

                    // ── Timer / status UI ──
                    var timerDiv = document.createElement('div');
                    timerDiv.className = 'flex justify-start gap-2';
                    timerDiv.innerHTML = '<div class="max-w-[85%] px-3 py-2 rounded-2xl text-xs bg-white text-gray-800 border border-gray-200">' +
                        '<div class="font-semibold text-gray-900 mb-1">' + (dateInfo.label ? 'Slow Moving Products — ' + dateInfo.label : 'Slow Moving Products') + '</div>' +
                        '<div class="text-gray-500 flex items-center gap-2">' +
                            '<span class="inline-block w-3 h-3 border-2 border-maroon-900 border-t-transparent rounded-full animate-spin"></span> ' +
                            '<span id="smp-timer-text">Estimated time: calculating...</span>' +
                        '</div>' +
                        '<div id="smp-status-text" class="text-gray-400 mt-1"></div>' +
                    '</div>';
                    messagesEl.appendChild(timerDiv);
                    messagesEl.scrollTop = messagesEl.scrollHeight;
                    if (typeof lucide !== 'undefined') lucide.createIcons();
                    ...
                    fetch(estUrl, {
                        ...
                        body: JSON.stringify({
                            start_date: dateInfo.startDate || null,
                            end_date: dateInfo.endDate || null
                        })
                    }).then(function(r) { return r.json(); }).then(function(est) {
                        var timerText = document.getElementById('smp-timer-text');
                        var statusText = document.getElementById('smp-status-text');
                        if (!timerText) return startGeneration(null);

                        if (!est.success) {
                            timerText.textContent = 'Unable to estimate. Generating...';
                            return startGeneration(null);
                        }

                        var estimatedSeconds = est.estimated_seconds;
                        var mins = Math.floor(estimatedSeconds / 60);
                        var secs = estimatedSeconds % 60;
                        var timeStr = String(mins).padStart(2,'0') + ':' + String(secs).padStart(2,'0');
                        timerText.textContent = 'Estimated time: ' + timeStr;
                        if (statusText) statusText.textContent = 'Status: Collecting product ledger data...';
                        ...
                        var ci = setInterval(function() {
                            remaining--;
                            totalElapsed++;
                            var tt = document.getElementById('smp-timer-text');
                            if (!tt) { clearInterval(ci); return; }
                            if (remaining > 0) {
                                var m = Math.floor(remaining / 60);
                                var s = remaining % 60;
                                tt.textContent = 'Please wait: ' + String(m).padStart(2,'0') + ':' + String(s).padStart(2,'0') + ' remaining';
                            } else {
                                // Show overtime (elapsed since estimate expired)
                                var overM = Math.floor(totalElapsed / 60);
                                var overS = totalElapsed % 60;
                                tt.textContent = 'Still generating... (+' + String(overM).padStart(2,'0') + ':' + String(overS).padStart(2,'0') + ')';
                            }
                        }, 1000);
                    ...
                    // ── Step 2: generate ──
                    function startGeneration(ci) {
                        var bodyData = {
                            start_date: dateInfo.startDate || null,
                            end_date: dateInfo.endDate || null,
                            date_range_label: dateInfo.label || ''
                        };
                        fetch(genUrl, {
                            method: 'POST',
                            headers: { 'Content-Type': 'application/json', 'X-CSRF-TOKEN': csrfToken },
        ...
        // Allows AI to deep link with pre-filled searches and selected tabs on ANY page
        window.addEventListener('DOMContentLoaded', function() {
            var urlParams = new URLSearchParams(window.location.search);
            
            // Use a slight delay to ensure all page-specific scripts (like Waybill.js) have initialized
            setTimeout(function() {
                // 1. Process search/filter parameters dynamically
                urlParams.forEach(function(value, key) {
                    var match = key.match(/^(?:search|filter)\[([^\]]+)\]$/);
                    if (match && value) {
                        var colKey = match[1];
                        // Find the matching column search input field
                        var inputField = document.querySelector('input[data-col="' + colKey + '"], input[name="' + colKey + '"], .column-search-input[data-col="' + colKey + '"]');
                        
                        // Fallback: Find by placeholder (e.g., placeholder="Search WB...")
                        if (!inputField) {
                        ...
                        if (inputField) {
                            // NEW: Auto-switch tab if the input belongs to a hidden tab pane
                            ...
                            // Dispatch both input and keyup to satisfy different page listeners
                ...
                // 2. Process tab parameter dynamically (if explicitly provided)
                var tab = urlParams.get('tab');
                if (tab) {
                    var tabBtn = document.querySelector('[data-tab="' + tab + '"]');
                    
                    // Fallback: Find by id (e.g., id="tab-btn-history" or id="tab-history")
                    if (!tabBtn) {
    ...
    <!-- Rush Notification System -->
    <script>
        // Fetch and display all notifications (rush orders + overdue invoices)
        function loadRushNotifications() {
            // Use absolute URL from root because of <base> tag
            const baseUrl = document.querySelector('base')?.getAttribute('href') || '';
            const rushUrl = baseUrl + 'admin/sales/sales-note/rush-notifications';
            const invoiceUrl = baseUrl + 'admin/payments/overdue-notifications';
            ...
            .then(([rushData, invoiceData]) => {
                console.log('Rush notifications:', rushData);
                console.log('Invoice notifications:', invoiceData);
                ...
                if (totalCount > 0) {
                    ...
                    if (rushNotifications.length > 0) {
                        ...
                        rushNotifications.forEach(note => {
                            ...
                            html += `
                                <a href="javascript:void(0)" onclick="navigateToRushNote('${note.sales_number}')" class="block p-3.5 hover:bg-gray-50 transition-colors cursor-pointer border-b border-gray-100">
                                    <div class="flex space-x-3">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <div class="flex items-center gap-2 mt-1">
                                                <span class="px-2 py-0.5 ${statusClass} text-[9px] font-bold rounded-full uppercase">${note.status}</span>
                                                <p class="text-[10px] text-red-500 font-bold">${note.days_overdue} days overdue</p>
                                            </div>
                                        </div>
                                    </div>
                                </a>
                    ...
                    if (invoiceNotifications.length > 0) {
                        ...
                        invoiceNotifications.forEach(invoice => {
                            html += `
                                <a href="javascript:void(0)" onclick="navigateToInvoice('${invoice.customer_name.replace(/'/g, "\\'")}')" class="block p-3.5 hover:bg-gray-50 transition-colors cursor-pointer border-b border-gray-100">
                                    <div class="flex space-x-3">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <div class="flex items-center gap-2 mt-1">
                                                <span class="px-2 py-0.5 bg-slate-100 text-slate-600 text-[9px] font-bold rounded-full">₱${parseFloat(invoice.total_amount).toLocaleString()}</span>
                                                <p class="text-[10px] text-orange-500 font-bold">${invoice.days_overdue} days past ${invoice.customer_terms}-day terms</p>
                                            </div>
                                        </div>
                                    </div>
                                </a>
                ...
                // Store overdue notes for table highlighting
                ...
                console.log('Stored overdue rush notes:', window.overdueRushNotes);
                console.log('Stored overdue invoices:', window.overdueInvoices);

                // Dispatch custom event so Sales Order can re-render with blink class
        ...
        // Navigate to sales order page and highlight the row
        function navigateToRushNote(salesNumber) {
            // Store the sales number to highlight (same key expected by Sales-Order.js)
            sessionStorage.setItem('highlightRushNote', salesNumber);
            // Navigate to sales order page (relative to base)
            window.location.href = 'admin/sales/sales-order';
        }
        
        // Navigate to payments page and scroll to the payor
        function navigateToInvoice(customerName) {
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            loadRushNotifications();
            
            // Refresh notifications every 2 minutes
            setInterval(loadRushNotifications, 120000);
        });
    </script>
    
    <!-- Rush Notification CSS -->
    <style>
        @keyframes bellRing {
    ...
    <script>
        (function () {
            const onlineOrderRoutes = {
                list: <?php echo json_encode(route('online-orders.notifications'), 15, 512) ?>,
                noteBase: <?php echo json_encode(url('/online-orders/sales-note'), 15, 512) ?>
            };
...
<?php /**PATH C:\xampp\htdocs\hatdog\resources\views/partials/admin/admin_sidebar_navbar.blade.php ENDPATH**/ ?>