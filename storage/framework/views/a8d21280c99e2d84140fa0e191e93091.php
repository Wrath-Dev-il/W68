<?php $__env->startSection('inventory_reports_content'); ?>
...
<?php $__env->startPush('styles'); ?>
    <?php echo app('Illuminate\Foundation\Vite')(['resources/css/inventory_reports.css']); ?>
<?php $__env->stopPush(); ?>

<?php $__env->startPush('scripts'); ?>
    <script>
        window.inventoryReportsRoutes = {
            searchDescriptions: "<?php echo e(route('api.products.search-descriptions')); ?>",
            searchCategories: "<?php echo e(route('api.products.search-categories')); ?>",
            reportData: "<?php echo e(route('api.reports.inventory-data')); ?>"
        };
    </script>
    <?php
        $inventoryReportsScript = file_get_contents(resource_path('js/inventory_reports.js'));
    ?>
    <script><?php echo $inventoryReportsScript; ?></script>
<?php $__env->stopPush(); ?>




<?php echo $__env->make('partials.special_user.special_sidebar_navbar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\hatdog\resources\views\Special_User\Reports\Inventory-Reports.blade.php ENDPATH**/ ?>