...
<body>
    ...
    <table class="items">
        <thead>
            <tr>
                ...
                <th style="width:8%" rowspan="<?php echo e(count($yearRange) > 0 ? 2 : 1); ?>">ITEM CODE</th>
                <th style="width:8%" rowspan="<?php echo e(count($yearRange) > 0 ? 2 : 1); ?>">PART NUMBER</th>
                <th style="width:28%" rowspan="<?php echo e(count($yearRange) > 0 ? 2 : 1); ?>">DESCRIPTION</th>
        ...
        <tbody>
            ...
            ?>
            <tr>
                <td class="c"><?php echo e($qtyLabel ? $qtyLabel : $displayQty); ?></td>
                ...
                <td class="r"><?php echo e(isset($latestCostByProductId[$item['product_id']]) ? number_format($latestCostByProductId[$item['product_id']], 2) : 'N/A'); ?></td>
                <td class="r"><?php echo e(number_format($item['price_online'] ?? 0, 2)); ?></td>
                <?php $__currentLoopData = $yearRange; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $yr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <td class="c"><?php echo e($yearlySales[$yr] ?? 0); ?></td>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </tbody>
    ...
    <div style="text-align:center;margin-top:15px;margin-bottom:10px;">
        <span style="font-size:25px;font-family:'Arial Black','Arial',sans-serif;font-weight:bold;color:#000000;">RUSH</span>
    </div>
    <?php endif; ?>
    ...
    <div style="text-align:center;margin-top:15px;margin-bottom:10px;">
        <span style="font-size:25px;font-family:'Arial Black','Arial',sans-serif;font-weight:bold;">
            <?php echo e($paymentType === 'cod-30' ? 'COD' : 'COD'); ?>
...
<?php /**PATH C:\xampp\htdocs\hatdog\resources\views\Admin\sales\sales-note-print.blade.php ENDPATH**/ ?>