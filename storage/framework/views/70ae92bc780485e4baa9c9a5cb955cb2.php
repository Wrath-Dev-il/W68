...
<?php $__env->startPush('scripts'); ?>
    <script>
        window.paymentsRoutes = {
            data: "<?php echo e(route('regular.payments.data')); ?>",
            customer: "<?php echo e(route('regular.payments.customer', ['customerId' => ':customerId'])); ?>",
            customerReturns: "<?php echo e(route('regular.payments.customer.returns', ['customerId' => ':customerId'])); ?>",
            returnLookup: "<?php echo e(route('regular.payments.return.lookup', ['returnId' => ':returnId'])); ?>",
            process: "<?php echo e(route('regular.payments.process')); ?>",
            historyData: "<?php echo e(route('regular.payments.history.data')); ?>",
            payors: "<?php echo e(route('regular.payments.history.payors')); ?>",
            payorHistory: "<?php echo e(route('regular.payments.history.payor', ['customerId' => ':customerId'])); ?>",
            historyItems: "<?php echo e(route('regular.payments.history.items', ['sourceType' => ':sourceType', 'sourceId' => ':sourceId'])); ?>",
            historyLedger: "<?php echo e(route('regular.payments.history.ledger', ['paymentId' => ':paymentId'])); ?>",
            historyDetail: "<?php echo e(route('regular.payments.history.detail', ['paymentId' => ':paymentId'])); ?>",
            historyUpdate: "<?php echo e(route('regular.payments.history.update', ['paymentId' => ':paymentId'])); ?>",
            historyDelete: "<?php echo e(route('regular.payments.history.delete', ['paymentId' => ':paymentId'])); ?>",
            historyPrint: "<?php echo e(route('regular.payments.history.print')); ?>",
            groupsData: "<?php echo e(route('regular.payments.groups.data')); ?>",
            groupsStore: "<?php echo e(route('regular.payments.groups.store')); ?>",
            groupDelete: "<?php echo e(route('regular.payments.groups.delete', ['groupId' => ':groupId'])); ?>",
            groupDetail: "<?php echo e(route('regular.payments.groups.detail', ['groupId' => ':groupId'])); ?>",
            groupPrint: "<?php echo e(route('regular.payments.groups.print', ['groupId' => ':groupId'])); ?>",
            groupProcess: "<?php echo e(route('regular.payments.groups.process', ['groupId' => ':groupId'])); ?>",
            groupsItems: "<?php echo e(route('regular.payments.groups.items', ['groupId' => ':groupId'])); ?>",

            groupItemUpdate: "<?php echo e(route('regular.payments.groups.item.update', ['groupId' => ':groupId', 'itemId' => ':itemId'])); ?>",
            groupItemDelete: "<?php echo e(route('regular.payments.groups.item.delete', ['groupId' => ':groupId', 'itemId' => ':itemId'])); ?>"
        };
    </script>
    <script src="<?php echo e(asset('js/payments.js')); ?>?v=<?php echo e(time()); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('partials.special_user.special_sidebar_navbar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\hatdog\resources\views\Regular_User\Accounting\Payments.blade.php ENDPATH**/ ?>