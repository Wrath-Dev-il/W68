...
<?php $__env->startSection('cons_invoice_content'); ?>
...
<?php $__env->startPush('scripts'); ?>
    <script>
        ...
        function loadCIDashboard() {
            fetch('<?php echo e(route("regular.consignment-invoice.dashboard")); ?>')
                .then(r => r.json())
                .then(res => {
        ...
        function loadCIActiveNotes() {
            ...
            fetch('<?php echo e(route("regular.consignment-invoice.active")); ?>')
                .then(r => r.json())
                .then(res => {
        ...
        function loadCIHistory() {
            ...
            fetch('<?php echo e(route("regular.consignment-invoice.history")); ?>')
                .then(r => r.json())
                .then(res => {
        ...
        function loadCINoteDetail(id) {
            ...
            fetch('<?php echo e(route("regular.consignment-invoice.note-detail", ["id" => "__ID__"])); ?>'.replace('__ID__', id))
                .then(r => r.json())
                .then(res => {
        ...
        window.finalizeConsignmentInvoice = function() {
            ...
            fetch('<?php echo e(route("regular.consignment-invoice.proceed")); ?>', {
                method: 'POST',
        ...
        window.submitCIPrintReceipt = function() {
            ...
            fetch('<?php echo e(route("regular.consignment-invoice.receipt-print")); ?>', {
                method: 'POST',
                headers: {
        ...
        function loadCIOrderDetail(id) {
            ...
            fetch('<?php echo e(route("regular.consignment-invoice.detail", ["id" => "__ID__"])); ?>'.replace('__ID__', id))
                .then(r => r.json())
                .then(res => {
                    if (!res.success) {
...
<?php echo $__env->make('partials.special_user.special_sidebar_navbar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\hatdog\resources\views\Special_User\sales\consignment-invoicing.blade.php ENDPATH**/ ?>