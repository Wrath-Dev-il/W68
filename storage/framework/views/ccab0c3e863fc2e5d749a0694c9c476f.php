...
<body class="bg-slate-200 font-sans">
    ...
    <div class="fixed top-5 left-5 z-[250] no-print">
        <a href="<?php echo e(route('regular.prod-master')); ?>" class="px-6 py-3 bg-gold text-maroon-900 font-black rounded-2xl shadow-2xl hover:bg-goldlining-500 transition-all flex items-center gap-3 border border-goldlining-500">
    ...
    <?php $exportQuery = http_build_query(request()->only(['description', 'brand', 'application', 'year'])); ?>
    <div class="fixed top-5 right-5 z-[110] no-print flex flex-col gap-2">
        ...
        <a id="excel-export-btn" href="<?php echo e(route('regular.prod-master.price-list.export-excel')); ?><?php echo e($exportQuery ? '?' . $exportQuery : ''); ?>" class="px-8 py-3 bg-emerald-700 text-white font-black rounded-2xl shadow-2xl hover:bg-emerald-800 transition-all flex items-center gap-3 border-2 border-emerald-300">
    ...
    <div id="print-report">
        <table class="print-table">
            ...
            <tbody>
                <?php $__currentLoopData = $groupedProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $desc => $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td colspan="5" class="desc-header" style="background:#f1f5f9;border:2px solid black;text-align:left;padding:6px 10px;font-size:18px;font-weight:900;color:black;text-transform:uppercase;">
                        <?php echo e(strtoupper($desc)); ?>

                    </td>
                </tr>
                <?php $__currentLoopData = $group; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
...
<?php /**PATH C:\xampp\htdocs\hatdog\resources\views\Regular_User\master_list\Product_PriceList.blade.php ENDPATH**/ ?>