...
<?php $__env->startSection('sales_junk_content'); ?>
...
<?php $__env->startPush('scripts'); ?>
    <script>
        window.salesJunkRoutes = {
            data: '<?php echo e(route("admin.sales-junk.data")); ?>',
            restore: '<?php echo e(route("admin.sales-junk.restore")); ?>'
        };
        ...
        window.confirmRestore = function() {
            if (!pendingRestoreProductId || !pendingRestoreQty) return;
            closeRestoreModal();
            fetch(window.salesJunkRoutes.restore, {
                method: 'POST',
                headers: { 'Content-Type': 'application/json', 'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>' },
                body: JSON.stringify({ product_id: pendingRestoreProductId, junk_qty: pendingRestoreQty })
            })
            .then(function (r) { return r.json(); })
            .then(function (res) {
                if (res.success) {
...
<?php /**PATH C:\xampp\htdocs\hatdog\resources\views\Warehouse_User\inventory\sales-junk.blade.php ENDPATH**/ ?>