...
<body class="bg-gray-50 text-gray-800 font-sans h-screen flex flex-col overflow-hidden" data-system-theme="<?php echo e($activeSystemTheme); ?>">
    ...
    <div class="flex flex-1 h-screen overflow-hidden">
        ...
        <aside id="sidebar" class="sidebar-transition bg-maroon-900 border-r-4 border-goldlining-500 w-64 flex flex-col h-full text-white z-[250] shadow-2xl relative no-print">
            ...
            <div class="flex-1 min-h-0 overflow-y-auto px-3 pt-4 pb-28 space-y-1.5 scroll-pb-28" id="nav-container">
                ...
                <div>
                    <a href="<?php echo e(route('regular.dashboard')); ?>" class="nav-item flex items-center space-x-3 px-3 py-3 rounded-lg transition-all duration-150 group <?php echo e(Route::currentRouteName() === 'regular.dashboard' ? 'active bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'hover:bg-maroon-800 text-gray-100'); ?>" title="Dashboard">
                ...
                <div class="menu-dropdown">
                    <button onclick="toggleDropdown('dropdown-master', this)" class="w-full flex items-center justify-between px-3 py-3 rounded-lg hover:bg-maroon-800 text-gray-100 hover:text-white transition-all group" title="Master List">
                        ...
                        <i data-lucide="chevron-down" class="dropdown-chevron w-4 h-4 text-goldlining-500 rotate-transition sidebar-text <?php echo e(in_array(Route::currentRouteName(), ['regular.prod-master', 'regular.prod-online-config', 'regular.supplier-master', 'regular.customer-master', 'regular.forwarder-master']) ? 'rotate-180' : ''); ?>"></i>
                    </button>
                    <div id="dropdown-master" class="submenu-transition overflow-hidden bg-maroon-950 bg-opacity-40 rounded-md mt-1 pl-4 space-y-1" style="<?php echo e(in_array(Route::currentRouteName(), ['regular.prod-master', 'regular.prod-online-config', 'regular.supplier-master', 'regular.customer-master', 'regular.forwarder-master']) ? 'max-height: 500px;' : 'max-height: 0px;'); ?>">
                        <a href="<?php echo e(route('regular.prod-master')); ?>" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all <?php echo e(Route::currentRouteName() === 'regular.prod-master' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1'); ?>" data-page="prod-master">
                            <i data-lucide="package" class="w-3.5 h-3.5 <?php echo e(Route::currentRouteName() === 'regular.prod-master' ? 'text-maroon-950' : ''); ?>"></i>
                            <span>Product Master List</span>
                        </a>
                        <a href="<?php echo e(route('regular.prod-online-config')); ?>" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all <?php echo e(Route::currentRouteName() === 'regular.prod-online-config' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1'); ?>" data-page="prod-online-config">
                            <i data-lucide="refresh-cw" class="w-3.5 h-3.5 <?php echo e(Route::currentRouteName() === 'regular.prod-online-config' ? 'text-maroon-950' : 'text-cyan-400'); ?>"></i>
                            <span>Online Product Config</span>
                        </a>
                        <a href="<?php echo e(route('regular.supplier-master')); ?>" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all <?php echo e(Route::currentRouteName() === 'regular.supplier-master' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1'); ?>" data-page="supplier-master">
                            <i data-lucide="truck" class="w-3.5 h-3.5 <?php echo e(Route::currentRouteName() === 'regular.supplier-master' ? 'text-maroon-950' : 'text-blue-400'); ?>"></i>
                            <span>Supplier Master List</span>
                        </a>
                        <a href="<?php echo e(route('regular.customer-master')); ?>" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all <?php echo e(Route::currentRouteName() === 'regular.customer-master' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1'); ?>" data-page="customer-master">
                            <i data-lucide="users" class="w-3.5 h-3.5 <?php echo e(Route::currentRouteName() === 'regular.customer-master' ? 'text-maroon-950' : 'text-emerald-400'); ?>"></i>
                            <span>Customer Master List</span>
                        </a>
                        <a href="<?php echo e(route('regular.forwarder-master')); ?>" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all <?php echo e(Route::currentRouteName() === 'regular.forwarder-master' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1'); ?>" data-page="forwarder-master">
                            <i data-lucide="plane" class="w-3.5 h-3.5 <?php echo e(Route::currentRouteName() === 'regular.forwarder-master' ? 'text-maroon-950' : 'text-emerald-400'); ?>"></i>
                ...
                <div class="menu-dropdown">
                    <button onclick="toggleDropdown('dropdown-inventory', this)" class="w-full flex items-center justify-between px-3 py-3 rounded-lg hover:bg-maroon-800 text-gray-100 hover:text-white transition-all group" title="Inventory Management">
                        ...
                        <i data-lucide="chevron-down" class="dropdown-chevron w-4 h-4 text-goldlining-500 rotate-transition sidebar-text <?php echo e(in_array(Route::currentRouteName(), ['regular.inv-adjust', 'regular.sales-junk']) ? 'rotate-180' : ''); ?>"></i>
                    </button>
                    <div id="dropdown-inventory" class="submenu-transition overflow-hidden bg-maroon-950 bg-opacity-40 rounded-md mt-1 pl-4 space-y-1" style="<?php echo e(in_array(Route::currentRouteName(), ['regular.inv-adjust', 'regular.sales-junk']) ? 'max-height: 500px;' : 'max-height: 0px;'); ?>">
                        <a href="<?php echo e(route('regular.inv-adjust')); ?>" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all <?php echo e(Route::currentRouteName() === 'regular.inv-adjust' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1'); ?>" data-page="inv-adjust">
                            <i data-lucide="sliders-horizontal" class="w-3.5 h-3.5 <?php echo e(Route::currentRouteName() === 'regular.inv-adjust' ? 'text-maroon-950' : ''); ?>"></i>
                            <span>Inventory Adjustment</span>
                        </a>
                        <a href="<?php echo e(route('regular.sales-junk')); ?>" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all <?php echo e(Route::currentRouteName() === 'regular.sales-junk' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1'); ?>" data-page="sales-junk">
                            <i data-lucide="archive" class="w-3.5 h-3.5 <?php echo e(Route::currentRouteName() === 'regular.sales-junk' ? 'text-maroon-950' : ''); ?>"></i>
                ...
                <div class="menu-dropdown">
                    <button onclick="toggleDropdown('dropdown-purchasing', this)" class="w-full flex items-center justify-between px-3 py-3 rounded-lg hover:bg-maroon-800 text-gray-100 hover:text-white transition-all group" title="Purchasing">
                        ...
                        <i data-lucide="chevron-down" class="dropdown-chevron w-4 h-4 text-goldlining-500 rotate-transition sidebar-text <?php echo e(in_array(Route::currentRouteName(), ['regular.purchase-viber', 'regular.purchase-note', 'regular.purchase-order', 'regular.purchase-return']) ? 'rotate-180' : ''); ?>"></i>
                    </button>
                    <div id="dropdown-purchasing" class="submenu-transition overflow-hidden bg-maroon-950 bg-opacity-40 rounded-md mt-1 pl-4 space-y-1" style="<?php echo e(in_array(Route::currentRouteName(), ['regular.purchase-viber', 'regular.purchase-note', 'regular.purchase-order', 'regular.purchase-return']) ? 'max-height: 500px;' : 'max-height: 0px;'); ?>">
                        <a href="<?php echo e(route('regular.purchase-viber')); ?>" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all <?php echo e(Route::currentRouteName() === 'regular.purchase-viber' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1'); ?>" data-page="viber-list">
                            <i data-lucide="message-square" class="w-3.5 h-3.5 <?php echo e(Route::currentRouteName() === 'regular.purchase-viber' ? 'text-maroon-950' : ''); ?>"></i>
                            <span>Purchase Entry</span>
                        </a>
                        <a href="<?php echo e(route('regular.purchase-note')); ?>" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all <?php echo e(Route::currentRouteName() === 'regular.purchase-note' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1'); ?>" data-page="purch-note">
                            <i data-lucide="file-text" class="w-3.5 h-3.5 <?php echo e(Route::currentRouteName() === 'regular.purchase-note' ? 'text-maroon-950' : ''); ?>"></i>
                            <span>Purchasing Note</span>
                        </a>
                        <a href="<?php echo e(route('regular.purchase-order')); ?>" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all <?php echo e(Route::currentRouteName() === 'regular.purchase-order' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1'); ?>" data-page="purch-order">
                            <i data-lucide="shopping-bag" class="w-3.5 h-3.5 <?php echo e(Route::currentRouteName() === 'regular.purchase-order' ? 'text-maroon-950' : ''); ?>"></i>
                            <span>Purchase Order</span>
                        </a>
                        <a href="<?php echo e(route('regular.purchase-return')); ?>" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all <?php echo e(Route::currentRouteName() === 'regular.purchase-return' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1'); ?>" data-page="purch-return">
                            <i data-lucide="undo-2" class="w-3.5 h-3.5 <?php echo e(Route::currentRouteName() === 'regular.purchase-return' ? 'text-maroon-950' : ''); ?>"></i>
                ...
                <div class="menu-dropdown">
                    <button onclick="toggleDropdown('dropdown-sales', this)" class="w-full flex items-center justify-between px-3 py-3 rounded-lg hover:bg-maroon-800 text-gray-100 hover:text-white transition-all group" title="Sales">
                        ...
                        <i data-lucide="chevron-down" class="dropdown-chevron w-4 h-4 text-goldlining-500 rotate-transition sidebar-text <?php echo e(in_array(Route::currentRouteName(), ['regular.sales-note', 'regular.sales-order', 'regular.consignment-invoice', 'regular.sales-return', 'regular.waybill']) ? 'rotate-180' : ''); ?>"></i>
                    </button>
                    <div id="dropdown-sales" class="submenu-transition overflow-hidden bg-maroon-950 bg-opacity-40 rounded-md mt-1 pl-4 space-y-1" style="<?php echo e(in_array(Route::currentRouteName(), ['regular.sales-note', 'regular.sales-order', 'regular.consignment-invoice', 'regular.sales-return', 'regular.waybill']) ? 'max-height: 500px;' : 'max-height: 0px;'); ?>">
                        <a href="<?php echo e(route('regular.sales-note')); ?>" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all <?php echo e(Route::currentRouteName() === 'regular.sales-note' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1'); ?>" data-page="sales-note">
                            <i data-lucide="receipt" class="w-3.5 h-3.5 <?php echo e(Route::currentRouteName() === 'regular.sales-note' ? 'text-maroon-950' : ''); ?>"></i>
                            <span>Sales Note</span>
                        </a>
                        <a href="<?php echo e(route('regular.sales-order')); ?>" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all <?php echo e(Route::currentRouteName() === 'regular.sales-order' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1'); ?>" data-page="sales-order">
                            <i data-lucide="file-symlink" class="w-3.5 h-3.5 <?php echo e(Route::currentRouteName() === 'regular.sales-order' ? 'text-maroon-950' : ''); ?>"></i>
                            <span>Sales Order</span>
                        </a>
                        <a href="<?php echo e(route('regular.consignment-invoice')); ?>" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all <?php echo e(Route::currentRouteName() === 'regular.consignment-invoice' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1'); ?>" data-page="cons-invoice">
                            <i data-lucide="file-digit" class="w-3.5 h-3.5 <?php echo e(Route::currentRouteName() === 'regular.consignment-invoice' ? 'text-maroon-950' : ''); ?>"></i>
                            <span>Consignment Invoice</span>
                        </a>
                        <a href="<?php echo e(route('regular.sales-return')); ?>" class="flex items-center space-x-2 py-2 px-3 text-xs <?php echo e(Request::routeIs('regular.sales-return') ? 'text-goldlining-400 bg-maroon/20' : 'text-gray-300'); ?> hover:text-goldlining-400 hover:translate-x-1 transition-all rounded" data-page="sales-return">
                            <i data-lucide="corner-up-left" class="w-3.5 h-3.5"></i>
                            <span>Sales Return</span>
                        </a>

                        <a href="<?php echo e(route('regular.waybill')); ?>" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all <?php echo e(Route::currentRouteName() === 'regular.waybill' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1'); ?>" data-page="waybill">
                            <i data-lucide="map" class="w-3.5 h-3.5 <?php echo e(Route::currentRouteName() === 'regular.waybill' ? 'text-maroon-950' : ''); ?>"></i>
                            <span>Waybill</span>
                        </a>
                    </div>
                </div>
                ...
                <!-- ACCOUNTING (DROPDOWN) -->
                <div class="menu-dropdown">
                    <button onclick="toggleDropdown('dropdown-accounting', this)" class="w-full flex items-center justify-between px-3 py-3 rounded-lg hover:bg-maroon-800 <?php echo e(in_array(Route::currentRouteName(), ['regular.payments', 'regular.payable-cheque-voucher', 'regular.expense-cheque-voucher']) ? 'bg-maroon-800 text-white shadow-inner' : 'text-gray-100'); ?> hover:text-white transition-all group" title="Accounting">
                        <div class="flex items-center space-x-3">
                            <i data-lucide="calculator" class="w-5 h-5 text-goldlining-400 group-hover:scale-110 transition-transform flex-shrink-0"></i>
                            <span class="sidebar-text text-sm whitespace-nowrap <?php echo e(in_array(Route::currentRouteName(), ['regular.payments', 'regular.payable-cheque-voucher', 'regular.expense-cheque-voucher']) ? 'font-bold text-goldlining-400' : ''); ?>">Accounting</span>
                        </div>
                        <i data-lucide="chevron-down" class="dropdown-chevron w-4 h-4 text-goldlining-500 rotate-transition sidebar-text <?php echo e(in_array(Route::currentRouteName(), ['regular.payments', 'regular.payable-cheque-voucher', 'regular.expense-cheque-voucher']) ? 'rotate-180' : ''); ?>"></i>
                    </button>
                    <div id="dropdown-accounting" class="submenu-transition overflow-hidden bg-maroon-950 bg-opacity-40 rounded-md mt-1 pl-4 space-y-1" style="<?php echo e(in_array(Route::currentRouteName(), ['regular.payments', 'regular.payable-cheque-voucher', 'regular.expense-cheque-voucher']) ? 'max-height: 500px;' : 'max-height: 0px;'); ?>">
                        <a href="<?php echo e(route('regular.payments')); ?>" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all <?php echo e(Route::currentRouteName() === 'regular.payments' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1'); ?>" data-page="payments">
                            <i data-lucide="credit-card" class="w-3.5 h-3.5 <?php echo e(Route::currentRouteName() === 'regular.payments' ? 'text-maroon-950' : ''); ?>"></i>
                            <span>Payments</span>
                        </a>
                        <a href="<?php echo e(route('regular.payable-cheque-voucher')); ?>" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all <?php echo e(Route::currentRouteName() === 'regular.payable-cheque-voucher' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1'); ?>" data-page="pay-cheque">
                            <i data-lucide="book-check" class="w-3.5 h-3.5 <?php echo e(Route::currentRouteName() === 'regular.payable-cheque-voucher' ? 'text-maroon-950' : ''); ?>"></i>
                            <span>Payable Cheque Voucher</span>
                        </a>
                        <a href="<?php echo e(route('regular.expense-cheque-voucher')); ?>" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all <?php echo e(Route::currentRouteName() === 'regular.expense-cheque-voucher' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1'); ?>" data-page="exp-cheque">
                            <i data-lucide="receipt" class="w-3.5 h-3.5 <?php echo e(Route::currentRouteName() === 'regular.expense-cheque-voucher' ? 'text-maroon-950' : ''); ?>"></i>
                ...
                <!-- REPORTS (DROPDOWN) -->
                <div class="menu-dropdown">
                    <button onclick="toggleDropdown('dropdown-reports', this)" class="w-full flex items-center justify-between px-3 py-3 rounded-lg hover:bg-maroon-800 <?php echo e(in_array(Route::currentRouteName(), ['regular.sales-report', 'regular.inventory-reports', 'regular.accounts-receivable', 'regular.cost-report', 'regular.top-products']) ? 'bg-maroon-800 text-white shadow-inner' : 'text-gray-100'); ?> hover:text-white transition-all group" title="Reports">
                        <div class="flex items-center space-x-3">
                            <i data-lucide="trending-up" class="w-5 h-5 text-goldlining-400 group-hover:scale-110 transition-transform flex-shrink-0"></i>
                            <span class="sidebar-text text-sm whitespace-nowrap <?php echo e(in_array(Route::currentRouteName(), ['regular.sales-report', 'regular.inventory-reports', 'regular.accounts-receivable', 'regular.cost-report', 'regular.top-products']) ? 'font-bold text-goldlining-400' : ''); ?>">Reports</span>
                        </div>
                        <i data-lucide="chevron-down" class="dropdown-chevron w-4 h-4 text-goldlining-500 rotate-transition sidebar-text <?php echo e(in_array(Route::currentRouteName(), ['regular.sales-report', 'regular.inventory-reports', 'regular.accounts-receivable', 'regular.cost-report', 'regular.top-products']) ? 'rotate-180' : ''); ?>"></i>
                    </button>
                    <div id="dropdown-reports" class="submenu-transition overflow-hidden bg-maroon-950 bg-opacity-40 rounded-md mt-1 pl-4 space-y-1" style="<?php echo e(in_array(Route::currentRouteName(), ['regular.sales-report', 'regular.inventory-reports', 'regular.accounts-receivable', 'regular.cost-report', 'regular.top-products']) ? 'max-height: 500px;' : 'max-height: 0px;'); ?>">
                        <a href="<?php echo e(route('regular.sales-report')); ?>" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all <?php echo e(Route::currentRouteName() === 'regular.sales-report' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1'); ?>" data-page="rep-sales">
                            <i data-lucide="bar-chart-3" class="w-3.5 h-3.5 <?php echo e(Route::currentRouteName() === 'regular.sales-report' ? 'text-maroon-950' : ''); ?>"></i>
                            <span>Account Receivable</span>
                        </a>
                        <a href="<?php echo e(route('regular.inventory-reports')); ?>" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all <?php echo e(Route::currentRouteName() === 'regular.inventory-reports' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1'); ?>" data-page="rep-inv">
                            <i data-lucide="package-search" class="w-3.5 h-3.5 <?php echo e(Route::currentRouteName() === 'regular.inventory-reports' ? 'text-maroon-950' : ''); ?>"></i>
                            <span>Inventory Reports</span>
                        </a>
                        
                        <a href="<?php echo e(route('regular.accounts-receivable')); ?>" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all <?php echo e(Route::currentRouteName() === 'regular.accounts-receivable' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1'); ?>" data-page="rep-ar">
                            <i data-lucide="arrow-down-left" class="w-3.5 h-3.5 <?php echo e(Route::currentRouteName() === 'regular.accounts-receivable' ? 'text-maroon-950' : ''); ?>"></i>
                            <span>Accounts Receivable Reports</span>
                        </a>

                        <a href="<?php echo e(route('regular.cost-report')); ?>" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all <?php echo e(Route::currentRouteName() === 'regular.cost-report' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1'); ?>" data-page="rep-cost">
                            <i data-lucide="receipt" class="w-3.5 h-3.5 <?php echo e(Route::currentRouteName() === 'regular.cost-report' ? 'text-maroon-950' : ''); ?>"></i>
                            <span>Cost Report</span>
                        </a>
                        <a href="<?php echo e(route('regular.top-products')); ?>" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all <?php echo e(Route::currentRouteName() === 'regular.top-products' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1'); ?>" data-page="rep-top-products">
                            <i data-lucide="trophy" class="w-3.5 h-3.5 <?php echo e(Route::currentRouteName() === 'regular.top-products' ? 'text-maroon-950' : ''); ?>"></i>
        ...
        <main class="flex-1 flex flex-col min-w-0 overflow-hidden">
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <div class="relative">
                        ...
                        <div id="profile-dropdown" class="hidden absolute right-0 mt-3 w-48 bg-maroon-900 border border-goldlining-500 rounded-xl shadow-xl z-50 overflow-hidden py-1 text-white">
                            <a href="<?php echo e(route('regular.profile')); ?>" class="flex items-center space-x-2.5 px-4 py-2.5 text-sm text-gray-100 hover:bg-maroon-800 hover:text-goldlining-400 transition-colors">
            ...
            <div id="workspace" class="flex-1 overflow-y-auto p-6 md:p-8 space-y-6">
                        ...
                        <nav class="flex text-xs font-medium text-gray-500 space-x-2" aria-label="Breadcrumb">
                            ...
                            <span id="breadcrumb-current" class="text-maroon-700 font-semibold">
                                <?php if(Route::currentRouteName() === 'admin.usm'): ?>
                                    System Security / USM
                                <?php elseif(Route::currentRouteName() === 'regular.prod-master'): ?>
                                    Master List / Product Master
                                <?php elseif(Route::currentRouteName() === 'regular.prod-online-config'): ?>
                                    Master List / Online Product Config
                                <?php elseif(Route::currentRouteName() === 'regular.supplier-master'): ?>
                                    Master List / Supplier Master
                                <?php elseif(Route::currentRouteName() === 'regular.customer-master'): ?>
                                    Master List / Customer Master
                                <?php elseif(Route::currentRouteName() === 'regular.forwarder-master'): ?>
                                    Master List / Forwarder Master
                                <?php elseif(Route::currentRouteName() === 'regular.inv-adjust'): ?>
                                    Inventory / Inventory Adjustment
                                <?php elseif(Route::currentRouteName() === 'regular.sales-junk'): ?>
                                    Inventory / Junk Items
                                <?php elseif(Route::currentRouteName() === 'regular.purchase-viber'): ?>
                                    Purchasing / Purchase Entry
                                <?php elseif(Route::currentRouteName() === 'regular.purchase-note'): ?>
                                    Purchasing / Purchasing Note
                                <?php elseif(Route::currentRouteName() === 'regular.purchase-order'): ?>
                                    Purchasing / Purchase Order
                                <?php elseif(Route::currentRouteName() === 'regular.purchase-return'): ?>
                                    Purchasing / Purchase Return
                                <?php elseif(Route::currentRouteName() === 'regular.sales-note'): ?>
                                    Sales / Sales Note
                                <?php elseif(Route::currentRouteName() === 'regular.sales-order'): ?>
                                    Sales / Sales Order
                                <?php elseif(Route::currentRouteName() === 'regular.sales-return'): ?>
                                    Sales / Sales Return
                                <?php elseif(Route::currentRouteName() === 'regular.consignment-invoice'): ?>
                                    Sales / Consignment Invoice
                                <?php elseif(Route::currentRouteName() === 'regular.waybill'): ?>
                                    Sales / Waybill
                                <?php elseif(Route::currentRouteName() === 'admin.profile'): ?>
                                    Profile / Admin Profile
                                <?php elseif(Route::currentRouteName() === 'regular.payments'): ?>
                                    Accounting / Payments
                                <?php elseif(Route::currentRouteName() === 'regular.payable-cheque-voucher'): ?>
                                    Accounting / Payable Cheque Voucher
                                <?php elseif(Route::currentRouteName() === 'regular.expense-cheque-voucher'): ?>
                                    Accounting / Expense Cheque Voucher
                                <?php elseif(Route::currentRouteName() === 'regular.sales-report'): ?>
                                    Statement Of Account
                                <?php elseif(Route::currentRouteName() === 'regular.inventory-reports'): ?>
                                    Reports / Inventory Reports
                                <?php elseif(Route::currentRouteName() === 'regular.accounts-receivable'): ?>
                                    Reports / Accounts Receivable
                                <?php elseif(Route::currentRouteName() === 'regular.cost-report'): ?>
                                    Reports / Cost Report
                                <?php elseif(Route::currentRouteName() === 'regular.top-products'): ?>
                ...
                <div id="page-dashboard" class="page-view space-y-6 <?php echo e(Route::currentRouteName() === 'regular.dashboard' ? '' : 'hidden'); ?>">
                ...
                <div id="page-prod-master-container" class="page-view space-y-6 <?php echo e(Route::currentRouteName() === 'regular.prod-master' ? '' : 'hidden'); ?>">
                    <?php echo $__env->yieldContent('prod_master_content'); ?>
                </div>

                <!-- PAGE: MASTER LIST -> ONLINE PRODUCT CONFIG -->
                <div id="page-prod-online-config-container" class="page-view space-y-6 <?php echo e(Route::currentRouteName() === 'regular.prod-online-config' ? '' : 'hidden'); ?>">
                    <?php echo $__env->yieldContent('prod_online_config_content'); ?>
                </div>

                <!-- PAGE: MASTER LIST -> SUPPLIER MASTER -->
                <div id="page-supplier-master-container" class="page-view space-y-6 <?php echo e(Route::currentRouteName() === 'regular.supplier-master' ? '' : 'hidden'); ?>">
                    <?php echo $__env->yieldContent('supplier_master_content'); ?>
                </div>

                <!-- PAGE: MASTER LIST -> CUSTOMER MASTER -->
                <div id="page-customer-master-container" class="page-view space-view space-y-6 <?php echo e(Route::currentRouteName() === 'regular.customer-master' ? '' : 'hidden'); ?>">
                    <?php echo $__env->yieldContent('customer_master_content'); ?>
                </div>

                <!-- PAGE: PURCHASING -> PURCHASE ENTRY / VIBER LIST -->
                <div id="page-purchase-viber-container" class="page-view space-y-6 <?php echo e(Route::currentRouteName() === 'regular.purchase-viber' ? '' : 'hidden'); ?>">
                    <?php echo $__env->yieldContent('purchase_viber_content'); ?>
                </div>

                <!-- PAGE: PURCHASING -> PURCHASING NOTE -->
                <div id="page-purchase-note-container" class="page-view space-y-6 <?php echo e(Route::currentRouteName() === 'regular.purchase-note' ? '' : 'hidden'); ?>">
                    <?php echo $__env->yieldContent('purchase_note_content'); ?>
                </div>

                <!-- PAGE: PURCHASING -> PURCHASE ORDER -->
                <div id="page-purchase-order-container" class="page-view space-y-6 <?php echo e(Route::currentRouteName() === 'regular.purchase-order' ? '' : 'hidden'); ?>">
                    <?php echo $__env->yieldContent('purchase_order_content'); ?>
                </div>

                <!-- PAGE: PURCHASING -> PURCHASE RETURN -->
                <div id="page-purchase-return-container" class="page-view space-y-6 <?php echo e(Route::currentRouteName() === 'regular.purchase-return' ? '' : 'hidden'); ?>">
                    <?php echo $__env->yieldContent('purchase_return_content'); ?>
                </div>

                <!-- PAGE: SALES -> SALES NOTE -->
                <div id="page-sales-note-container" class="page-view space-y-6 <?php echo e(in_array(Route::currentRouteName(), ['regular.sales-note', 'admin.sales-note.online-prices', 'admin.sales-note.report-redirect']) ? '' : 'hidden'); ?>">
                    <?php echo $__env->yieldContent('sales_note_content'); ?>
                </div>

                <!-- PAGE: SALES -> SALES ORDER -->
                <div id="page-sales-order-container" class="page-view space-y-6 <?php echo e(Route::currentRouteName() === 'regular.sales-order' ? '' : 'hidden'); ?>">
                    <?php echo $__env->yieldContent('sales_order_content'); ?>
                </div>

                <!-- PAGE: SALES -> CONSIGNMENT INVOICE -->
                <div id="page-cons-invoice" class="page-view space-y-6 <?php echo e(Route::currentRouteName() === 'regular.consignment-invoice' ? '' : 'hidden'); ?>">
                    <?php echo $__env->yieldContent('cons_invoice_content'); ?>
                </div>

                <!-- PAGE: SALES -> WAYBILL -->
                <div id="page-waybill" class="page-view space-y-6 <?php echo e(Route::currentRouteName() === 'regular.waybill' ? '' : 'hidden'); ?>">
                    <?php echo $__env->yieldContent('waybill_content'); ?>
                </div>

                <!-- PAGE: MASTER LIST -> FORWARDER MASTER -->
                <div id="page-forwarder-master-container" class="page-view space-y-6 <?php echo e(Route::currentRouteName() === 'regular.forwarder-master' ? '' : 'hidden'); ?>">
                    <?php echo $__env->yieldContent('forwarder_master_content'); ?>
                </div>

                <!-- PAGE: INVENTORY -> INVENTORY ADJUSTMENT -->
                <div id="page-inv-adjust-container" class="page-view space-y-6 <?php echo e(Route::currentRouteName() === 'regular.inv-adjust' ? '' : 'hidden'); ?>">
                    <?php echo $__env->yieldContent('inventory_adjustment_content'); ?>
                </div>

                <!-- PAGE: INVENTORY -> JUNK ITEMS -->
                <div id="page-sales-junk-container" class="page-view space-y-6 <?php echo e(Route::currentRouteName() === 'regular.sales-junk' ? '' : 'hidden'); ?>">
                    <?php echo $__env->yieldContent('sales_junk_content'); ?>
                </div>

                <!-- PAGE: SALES -> SALES RETURN -->
                <div id="page-sales-return-container" class="page-view space-y-6 <?php echo e(Route::currentRouteName() === 'regular.sales-return' ? '' : 'hidden'); ?>">
                    <?php echo $__env->yieldContent('sales_return_content'); ?>
                </div>

                <!-- PAGE: ACCOUNTING -> PAYMENTS -->
                <div id="page-payments" class="page-view space-y-6 <?php echo e(Route::currentRouteName() === 'regular.payments' ? '' : 'hidden'); ?>">
                    <?php echo $__env->yieldContent('payments_content'); ?>
                </div>

                <!-- PAGE: ADMIN PROFILE -->
                <div id="page-admin-profile" class="page-view space-y-6 <?php echo e(in_array(Route::currentRouteName(), ['admin.profile', 'regular.profile']) ? '' : 'hidden'); ?>">
                    <?php echo $__env->yieldContent('admin_profile_content'); ?>
                </div>

                <!-- PAGE: ACCOUNTING -> PAYABLE CHEQUE VOUCHER -->
                <div id="page-payable-cheque-voucher-container" class="page-view space-y-6 <?php echo e(Route::currentRouteName() === 'regular.payable-cheque-voucher' ? '' : 'hidden'); ?>">
                    <?php echo $__env->yieldContent('payable_cheque_voucher_content'); ?>
                </div>

                <!-- PAGE: ACCOUNTING -> EXPENSE CHEQUE VOUCHER -->
                <div id="page-exp-cheque" class="page-view space-y-6 <?php echo e(Route::currentRouteName() === 'regular.expense-cheque-voucher' ? '' : 'hidden'); ?>">
                    <?php echo $__env->yieldContent('expense_cheque_voucher_content'); ?>
                </div>
                <!-- PAGE: REPORTS -> INVENTORY REPORTS -->
                <div id="page-rep-inv" class="page-view space-y-6 <?php echo e(Route::currentRouteName() === 'regular.inventory-reports' ? '' : 'hidden'); ?>">
                    <?php echo $__env->yieldContent('inventory_reports_content'); ?>
                </div>
                <!-- PAGE: REPORTS -> SALES REPORTS -->
                <div id="page-rep-sales" class="page-view space-y-6 <?php echo e(in_array(Route::currentRouteName(), ['regular.sales-report', 'regular.top-products']) ? '' : 'hidden'); ?>">
                    <?php echo $__env->yieldContent('sales_report_content'); ?>
                </div>
                <!-- PAGE: REPORTS -> ACCOUNTS RECEIVABLE -->
                <div id="page-rep-ar" class="page-view space-y-6 <?php echo e(Route::currentRouteName() === 'regular.accounts-receivable' ? '' : 'hidden'); ?>">
                    <?php echo $__env->yieldContent('accounts_receivable_content'); ?>
                </div>
                <!-- PAGE: REPORTS -> COST REPORT -->
                <div id="page-rep-cost" class="page-view space-y-6 <?php echo e(Route::currentRouteName() === 'regular.cost-report' ? '' : 'hidden'); ?>">
        ...
        (function(){
            ...
            function sendMessage() {
                ...
                if (/^slow moving products$/i.test(text)) {
                    ...
                    setLoading(true);
                    var genUrl = '<?php echo e(route("regular.ai.slow-moving-products.generate")); ?>';
                    fetch(genUrl, {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                ...
                fetch('<?php echo e(route("regular.chat.send")); ?>', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
            ...
            function fetchUsage() {
                fetch('<?php echo e(route("regular.chat.usage")); ?>', {
    ...
    <script>
        window.userNavbarNotificationRoutes = {
            rush: <?php echo json_encode(route('regular.sales-note.rush-notifications'), 15, 512) ?>,
            invoice: <?php echo json_encode(route('regular.payments.overdue-notifications'), 15, 512) ?>,
            salesOrder: <?php echo json_encode(route('regular.sales-order'), 15, 512) ?>,
            payments: <?php echo json_encode(route('regular.payments'), 15, 512) ?>,
        };

        function hatdogUserNavbarEscapeHtml(value) {
        ...
        function loadRushNotifications() {
            const routes = window.userNavbarNotificationRoutes || {};
            const rushUrl = routes.rush;
            const invoiceUrl = routes.invoice;

            if (!rushUrl || !invoiceUrl) return;

            Promise.all([
                fetch(rushUrl, { headers: { 'Accept': 'application/json' } }).then(function(response) {
                    if (!response.ok) throw new Error('Rush API error: ' + response.status);
                    return response.json();
                }),
                fetch(invoiceUrl, { headers: { 'Accept': 'application/json' } }).then(function(response) {
                    if (!response.ok) throw new Error('Invoice API error: ' + response.status);
                    return response.json();
                }),
            ])
            .then(function(results) {
                const rushData = results[0] || {};
                const invoiceData = results[1] || {};
                ...
                if (totalCount > 0) {
                    ...
                    if (rushNotifications.length > 0) {
                        ...
                        rushNotifications.forEach(function(note) {
                            const salesNumber = hatdogUserNavbarEscapeHtml(note.sales_number);
                            const customerName = hatdogUserNavbarEscapeHtml(note.customer_name);
                            const status = hatdogUserNavbarEscapeHtml(note.status);
                            const daysOverdue = hatdogUserNavbarEscapeHtml(note.days_overdue);
                            const statusClass = note.status === 'Partial' ? 'bg-blue-100 text-blue-600' : 'bg-amber-100 text-amber-600';

                            html += `
                                <button type="button" data-rush-sales-number="${salesNumber}" class="user-rush-notif-item block w-full text-left p-3.5 hover:bg-gray-50 transition-colors cursor-pointer border-b border-gray-100">
                                    <div class="flex space-x-3">
                                        <div class="bg-red-100 text-red-600 p-1.5 rounded-lg h-fit">
                                            <i data-lucide="alert-triangle" class="w-4 h-4"></i>
                                        </div>
                                        <div class="flex-1">
                                            <p class="text-xs font-semibold text-gray-800">Rush Order - ${salesNumber}</p>
                                            <p class="text-[10px] text-gray-600 mt-0.5">${customerName}</p>
                                            <div class="flex items-center gap-2 mt-1">
                                                <span class="px-2 py-0.5 ${statusClass} text-[9px] font-bold rounded-full uppercase">${status}</span>
                                                <p class="text-[10px] text-red-500 font-bold">${daysOverdue} days overdue</p>
                                            </div>
                                        </div>
                                    </div>
                                </button>
                    ...
                    if (invoiceNotifications.length > 0) {
                        ...
                        invoiceNotifications.forEach(function(invoice) {
                            const customerName = hatdogUserNavbarEscapeHtml(invoice.customer_name);
                            const orderNumber = hatdogUserNavbarEscapeHtml(invoice.order_number);
                            const daysOverdue = hatdogUserNavbarEscapeHtml(invoice.days_overdue);
                            const customerTerms = hatdogUserNavbarEscapeHtml(invoice.customer_terms);
                            const totalAmount = Number.parseFloat(invoice.total_amount || 0).toLocaleString();

                            html += `
                                <button type="button" data-invoice-customer="${customerName}" class="user-invoice-notif-item block w-full text-left p-3.5 hover:bg-gray-50 transition-colors cursor-pointer border-b border-gray-100">
                                    <div class="flex space-x-3">
                                        <div class="bg-orange-100 text-orange-600 p-1.5 rounded-lg h-fit">
                                            <i data-lucide="credit-card" class="w-4 h-4"></i>
                                        </div>
                                        <div class="flex-1">
                                            <p class="text-xs font-semibold text-gray-800">${customerName}</p>
                                            <p class="text-[10px] text-gray-600 mt-0.5">${orderNumber}</p>
                                            <div class="flex items-center gap-2 mt-1">
                                                <span class="px-2 py-0.5 bg-slate-100 text-slate-600 text-[9px] font-bold rounded-full">PHP ${totalAmount}</span>
                                                <p class="text-[10px] text-orange-500 font-bold">${daysOverdue} days past ${customerTerms}-day terms</p>
                                            </div>
                                        </div>
                                    </div>
                                </button>
                ...
                window.overdueRushNotes = rushNotifications.map(function(note) { return note.sales_number; });
                window.overdueInvoices = invoiceNotifications.map(function(invoice) { return invoice.order_number; });
            ...
            .catch(function(error) {
                ...
                console.warn('Unable to load user navbar notifications:', error.message);
            });
        }

        function navigateToRushNote(salesNumber) {
            sessionStorage.setItem('highlightRushNote', salesNumber || '');
            window.location.href = window.userNavbarNotificationRoutes.salesOrder;
        }
        ...
        function navigateToInvoice(customerName) {
            ...
            window.location.href = window.userNavbarNotificationRoutes.payments;
        }

        document.addEventListener('click', function(event) {
            const rushItem = event.target.closest('.user-rush-notif-item');
            if (rushItem) {
                navigateToRushNote(rushItem.dataset.rushSalesNumber || '');
                return;
            }

            const invoiceItem = event.target.closest('.user-invoice-notif-item');
            if (invoiceItem) {
                navigateToInvoice(invoiceItem.dataset.invoiceCustomer || '');
            }
        });
...
<?php /**PATH C:\xampp\htdocs\hatdog\resources\views\partials\user_account\user_sidebar_navbar.blade.php ENDPATH**/ ?>