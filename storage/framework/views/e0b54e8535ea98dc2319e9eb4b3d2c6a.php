    ...
    (function() {
        ...
        window.fetch = function(input, init) {
            if (typeof input === 'string') {
                // If the URL starts with /regular/masterlist/supplier and we are in /hatdog/public
                if (input.startsWith('/regular/masterlist/supplier') && window.location.pathname.includes('/hatdog/public')) {
...
<?php $__env->startPush('scripts'); ?>
    <script>
        window.supplierRoutes = {
            fetchData: '<?php echo e(route("regular.supplier-master.data")); ?>',
            fetchLifecycle: '<?php echo e(route("regular.supplier-master.lifecycle")); ?>',
            create: '<?php echo e(route("regular.supplier-master.create")); ?>',
            update: '<?php echo e(route("regular.supplier-master.update", ["id" => ":id"])); ?>',
            delete: '<?php echo e(route("regular.supplier-master.delete", ["id" => ":id"])); ?>',
            fetchLedgerItems: '<?php echo e(route("regular.masterlist.supplier.ledger-items", ["supplierId" => ":id"])); ?>',
            fetchUnregisteredPurchaseOrders: '<?php echo e(route("regular.masterlist.supplier.unregistered-purchase-orders", ["supplierId" => ":id"])); ?>',
            fetchHistory: '<?php echo e(route("regular.supplier-master.history", ["id" => ":id"])); ?>',
            fetchLedger: '<?php echo e(route("regular.supplier-master.ledger", ["id" => ":id"])); ?>',
            purchaseOrderDetail: '<?php echo e(route("regular.purchase-order.detail", ["poId" => ":id"])); ?>',
            purchaseOrderPage: '<?php echo e(route("regular.purchase-order")); ?>',
        };
    </script>
...
<?php echo $__env->make('partials.user_account.user_sidebar_navbar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\hatdog\resources\views/Regular_User/master_list/Supplier_Master-list.blade.php ENDPATH**/ ?>