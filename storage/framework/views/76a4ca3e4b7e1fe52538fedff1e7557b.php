...
<script>
    window.prodRoutes = {
        fetch: '<?php echo e(route("admin.prod-master.data")); ?>',
        create: '<?php echo e(route("admin.prod-master.create")); ?>',
        update: '<?php echo e(route("admin.prod-master.update", ["id" => ":id"])); ?>',
        delete: '<?php echo e(route("admin.prod-master.delete", ["id" => ":id"])); ?>',
       'ledger': '<?php echo e(route("admin.prod-master.ledger", ["id" => ":id"])); ?>',
        'select': '<?php echo e(route("admin.prod-master.select")); ?>',
        'reorderLevel': '<?php echo e(route("admin.prod-master.reorder-level")); ?>',
        'catalog': '<?php echo e(route("admin.prod-master.catalog")); ?>',
        'priceList': '<?php echo e(route("admin.prod-master.price-list")); ?>',
        'selectedFilters': '<?php echo e(route("admin.prod-master.selected-filters")); ?>',
        'activeNotes': '<?php echo e(route("admin.prod-master.active-notes", ["id" => ":id"])); ?>',
        'priceCodesUpdate': '<?php echo e(route("admin.prod-master.price-codes.update", ["id" => ":id"])); ?>'
    };
...
<?php /**PATH C:\xampp\htdocs\hatdog\resources\views/Admin/master_list/Product_Master-list.blade.php ENDPATH**/ ?>