...
<?php $__env->startPush('scripts'); ?>
    <script>
        ...
        window.adminProfileRoutes = {
            updateProfile: "<?php echo e(route('regular.profile.update')); ?>",
            uploadPicture: "<?php echo e(route('regular.profile.picture')); ?>"
        };
    </script>
    <script src="<?php echo e(asset('js/admin-profile.js')); ?>?v=<?php echo e(time()); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('partials.user_account.user_sidebar_navbar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\hatdog\resources\views\partials\user_account\User-profile.blade.php ENDPATH**/ ?>