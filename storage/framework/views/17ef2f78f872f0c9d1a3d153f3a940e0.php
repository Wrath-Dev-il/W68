...
<?php $__env->startPush('scripts'); ?>
    <script>
        ...
        window.viberRoutes = {
            suppliers: '<?php echo e(route("admin.purchase-viber.suppliers")); ?>',
            products: '<?php echo e(route("admin.purchase-viber.products")); ?>',
            list: '<?php echo e(route("admin.purchase-viber.list")); ?>',
            storeSupplier: '<?php echo e(route("admin.purchase-viber.store-supplier")); ?>',
            storeItems: '<?php echo e(route("admin.purchase-viber.store-items")); ?>',
            items: '<?php echo e(route("admin.purchase-viber.items", ["viberListId" => ":viberListId"])); ?>',
            destroySupplier: '<?php echo e(route("admin.purchase-viber.destroy", ["id" => ":id"])); ?>',
            destroyItem: '<?php echo e(route("admin.purchase-viber.items.destroy", ["id" => ":id"])); ?>',
            updateItem: '<?php echo e(route("admin.purchase-viber.items.update", ["id" => ":id"])); ?>',
            prepareNote: '<?php echo e(route("admin.purchase-viber.prepare-note")); ?>',
            counts: '<?php echo e(route("admin.purchase-viber.counts")); ?>',
            invoicedItems: '<?php echo e(route("admin.purchase-viber.invoiced-items")); ?>',
            notArrivedItems: '<?php echo e(route("admin.purchase-viber.not-arrived-items")); ?>',
            notArrivedRollback: '<?php echo e(route("admin.purchase-viber.not-arrived-rollback")); ?>',
            purchaseNote: '<?php echo e(route("admin.purchase-note")); ?>',
            shippedPrintItems: '<?php echo e(route("admin.purchase-viber.shipped-print-items", ["viberListId" => ":viberListId"])); ?>',
        };
    </script>
    <script src="<?php echo e(asset('js/Purchase-Viber.js')); ?>?v=<?php echo e(time()); ?>"></script>
<?php $__env->stopPush(); ?>

<?php $__env->stopSection(); ?>

<?php echo $__env->make('partials.admin.admin_sidebar_navbar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php /**PATH C:\xampp\htdocs\hatdog\resources\views\Admin\Purchase\Purchase-Viber.blade.php ENDPATH**/ ?>