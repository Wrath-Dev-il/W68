...
<body class="bg-slate-200 font-sans">
    ...
    <div class="fixed top-5 left-5 z-[250] no-print">
        <a href="<?php echo e(route('admin.prod-master')); ?>" class="px-6 py-3 bg-gold text-maroon-900 font-black rounded-2xl shadow-2xl hover:bg-goldlining-500 transition-all flex items-center gap-3 border border-goldlining-500">
...
<?php /**PATH C:\xampp\htdocs\hatdog\resources\views/Admin/master_list/Product_Catalog.blade.php ENDPATH**/ ?>