...
<?php $__env->startPush('scripts'); ?>
    <script>
        ...
        window.salesRoutes = {
            customersUrl: '<?php echo e(route("admin.sales-note.customers")); ?>',
            productsUrl: '<?php echo e(route("admin.sales-note.products")); ?>',
            processUrl: '<?php echo e(route("admin.sales-note.process")); ?>',
            stockCheckUrl: '<?php echo e(route("admin.sales-note.check-stock")); ?>',
            dashboardUrl: '<?php echo e(route("admin.sales-note.dashboard")); ?>',
            activeUrl: '<?php echo e(route("admin.sales-note.active")); ?>',
            historyUrl: '<?php echo e(route("admin.sales-note.history")); ?>',
            detailUrl: '<?php echo e(route("admin.sales-note.detail", ["id" => ":id"])); ?>',
            deleteUrl: '<?php echo e(route("admin.sales-note.delete", ["id" => ":id"])); ?>',
            updateUrl: '<?php echo e(route("admin.sales-note.update", ["id" => ":id"])); ?>',
            ...
            printUrl: '<?php echo e(route("admin.sales-note.print")); ?>',
            salesOrderUrl: '<?php echo e(route("admin.sales-order")); ?>',
            customerPartialsUrl: '<?php echo e(route("admin.sales-note.customer.partials", ["customerId" => ":customerId"])); ?>',
            remainingItemsUrl: '<?php echo e(route("admin.sales-note.remaining-items", ["noteId" => ":noteId"])); ?>'
        };
    ...
    <script>
        ...
        window.loadInvoicesForEdit = async function() {
            ...
            try {
                const url = `<?php echo e(url('/admin/sales/sales-note')); ?>/${noteId}/invoices`;
        ...
        window.selectInvoiceForEdit = async function(invoiceId, invoiceNumber) {
            ...
            try {
                const url = `<?php echo e(url('/admin/sales/sales-note/invoice')); ?>/${invoiceId}/items`;
                const res = await fetch(url);
                const result = await res.json();
        ...
        window.proceedEditRemainingItems = async function() {
            ...
            try {
                const url = `<?php echo e(url('/admin/sales/sales-note')); ?>/${window.activeEditNoteId}/invoices`;
                const res = await fetch(url);
                const result = await res.json();
...
<?php /**PATH C:\xampp\htdocs\hatdog\resources\views\Admin\sales\sales-note.blade.php ENDPATH**/ ?>