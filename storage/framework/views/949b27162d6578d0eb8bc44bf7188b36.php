...
<div id="page-waybill-root" class="space-y-8 animate-fade-in text-slate-800">
    ...
    <div class="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden text-slate-800">
        <div class="border-b border-slate-100 bg-slate-50/30 flex justify-between items-center px-6">
            <div class="flex">
                <button onclick="switchMainTab('pending')" id="tab-btn-pending" class="px-6 py-4 text-xs font-bold border-b-2 border-maroon text-maroon transition-all flex items-center space-x-2">
                    <i data-lucide="list" class="w-4 h-4"></i>
                    <span>Pending Orders</span>
                </button>
                <button onclick="switchMainTab('history')" id="tab-btn-history" class="px-6 py-4 text-xs font-bold border-b-2 border-transparent text-slate-400 hover:text-maroon transition-all flex items-center space-x-2">
                    <i data-lucide="history" class="w-4 h-4"></i>
                    <span>Waybill History</span>
                </button>
            </div>
            <div id="history-actions" class="hidden flex items-center space-x-3 py-2">
...
<!-- ============== CONFIRM MODAL ============== -->
<div id="wb-confirm-modal" class="fixed inset-0 z-[950] hidden flex items-center justify-center">
...
<!-- ============== EDIT CONFIRM MODAL ============== -->
<div id="wb-edit-confirm-modal" class="fixed inset-0 z-[950] hidden flex items-center justify-center">
...
<div id="wb-invoice-products-modal" class="fixed inset-0 z-[900] hidden flex items-center justify-center">
    ...
    <div class="flex justify-between items-start mb-8">
        <div class="space-y-1 w-1/2">
            ...
            <div class="flex">
                ...
                <span id="print-customer-address" contenteditable="true" spellcheck="false" class="border-b border-slate-300 flex-1 min-w-0 min-h-5 h-auto whitespace-normal break-words leading-5"></span>
            </div>
            <div class="flex">
...
<?php $__env->startPush('scripts'); ?>
    <script>
        window.waybillRoutes = {
            stats: "<?php echo e(route('special.waybill.stats')); ?>",
            pending: "<?php echo e(route('special.waybill.pending')); ?>",
            soItems: "<?php echo e(route('special.waybill.so-items', ':id')); ?>",
            finalize: "<?php echo e(route('special.waybill.finalize')); ?>",
            forwarderSuggestions: "<?php echo e(route('special.waybill.forwarder-suggestions')); ?>",
            history: "<?php echo e(route('special.waybill.history')); ?>",
            historyDetails: "<?php echo e(route('special.waybill.history-details', ':id')); ?>",
            batchPrint: "<?php echo e(route('special.waybill.batch-print')); ?>",
            update: "<?php echo e(route('special.waybill.update', ':id')); ?>",
            editData: "<?php echo e(route('special.waybill.edit-data', ':id')); ?>"
        };
...
<?php echo $__env->make('partials.special_user.special_sidebar_navbar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\hatdog\resources\views\Special_User\sales\Waybill.blade.php ENDPATH**/ ?>