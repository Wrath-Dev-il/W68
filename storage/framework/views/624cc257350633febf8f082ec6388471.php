...
<body class="print-<?php echo e($printType === 'invoice' ? 'invoice' : 'order'); ?>">
    ...
    <script>
        ...
        function exportPdf() {
            ...
            const opt = {
                margin: [<?php echo e($printType === 'invoice' ? 47 : 49); ?>, 6, 50, <?php echo e($printType === 'invoice' ? 8 : 8); ?>],
...
<?php /**PATH C:\xampp\htdocs\hatdog\resources\views/Special_User/sales/receipt-print.blade.php ENDPATH**/ ?>