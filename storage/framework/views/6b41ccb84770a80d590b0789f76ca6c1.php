...
<?php $__env->startPush('scripts'); ?>
    <script>
        window.returnRoutes = {
            invoicesUrl: '<?php echo e(route("admin.purchase-return.invoices")); ?>',
            poItemsUrl: '<?php echo e(route("admin.purchase-return.po-items", ["poId" => ":poId"])); ?>',
            processUrl: '<?php echo e(route("admin.purchase-return.process")); ?>',
            updateUrl: '<?php echo e(route("admin.purchase-return.update", ["id" => ":id"])); ?>',
            deleteUrl: '<?php echo e(route("admin.purchase-return.delete", ["id" => ":id"])); ?>',
            historyUrl: '<?php echo e(route("admin.purchase-return.history")); ?>',
            dashboardUrl: '<?php echo e(route("admin.purchase-return.dashboard")); ?>',
            detailUrl: '<?php echo e(route("admin.purchase-return.detail", ["id" => ":id"])); ?>'
        };
...
<?php /**PATH C:\xampp\htdocs\hatdog\resources\views/Admin/Purchase/Purchase-Return.blade.php ENDPATH**/ ?>