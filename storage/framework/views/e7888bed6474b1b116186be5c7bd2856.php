    ...
    <div class="flex flex-1 h-screen overflow-hidden">
            ...
            <div class="flex-1 min-h-0 overflow-y-auto px-3 pt-4 pb-28 space-y-1.5 scroll-pb-28" id="nav-container">
                ...
                <div class="menu-dropdown">
                    <button onclick="toggleDropdown('dropdown-inventory', this)" class="w-full flex items-center justify-between px-3 py-3 rounded-lg hover:bg-maroon-800 text-gray-100 hover:text-white transition-all group" title="Inventory Management">
                        ...
                        <i data-lucide="chevron-down" class="dropdown-chevron w-4 h-4 text-goldlining-500 rotate-transition sidebar-text <?php echo e(in_array(Route::currentRouteName(), ['warehouse.inv-adjust', 'warehouse.sales-junk', 'warehouse.item-convert']) ? 'rotate-180' : ''); ?>"></i>
                    </button>
                    <div id="dropdown-inventory" class="submenu-transition overflow-hidden bg-maroon-950 bg-opacity-40 rounded-md mt-1 pl-4 space-y-1" style="<?php echo e(in_array(Route::currentRouteName(), ['warehouse.inv-adjust', 'warehouse.sales-junk', 'warehouse.item-convert']) ? 'max-height: 500px;' : 'max-height: 0px;'); ?>">
                        <a href="<?php echo e(route('warehouse.inv-adjust')); ?>" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all <?php echo e(Route::currentRouteName() === 'warehouse.inv-adjust' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1'); ?>" data-page="inv-adjust">
                            <i data-lucide="sliders-horizontal" class="w-3.5 h-3.5 <?php echo e(Route::currentRouteName() === 'warehouse.inv-adjust' ? 'text-maroon-950' : ''); ?>"></i>
                            <span>Inventory Adjustment</span>
                        </a>
                        <a href="<?php echo e(route('warehouse.sales-junk')); ?>" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all <?php echo e(Route::currentRouteName() === 'warehouse.sales-junk' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1'); ?>" data-page="sales-junk">
                            <i data-lucide="archive" class="w-3.5 h-3.5 <?php echo e(Route::currentRouteName() === 'warehouse.sales-junk' ? 'text-maroon-950' : ''); ?>"></i>
                            <span>Junk Items</span>
                        </a>
                         <a href="<?php echo e(route('warehouse.item-convert')); ?>" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all <?php echo e(Route::currentRouteName() === 'warehouse.item-convert' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1'); ?>" data-page="item-convert">
                            <i data-lucide="shuffle" class="w-3.5 h-3.5 <?php echo e(Route::currentRouteName() === 'warehouse.item-convert' ? 'text-maroon-950' : ''); ?>"></i>
        ...
        <main class="flex-1 flex flex-col min-w-0 overflow-hidden">
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <div class="relative">
                        ...
                        <div id="profile-dropdown" class="hidden absolute right-0 mt-3 w-48 bg-maroon-900 border border-goldlining-500 rounded-xl shadow-xl z-50 overflow-hidden py-1 text-white">
                            <a href="<?php echo e(route('warehouse.profile')); ?>" class="flex items-center space-x-2.5 px-4 py-2.5 text-sm text-gray-100 hover:bg-maroon-800 hover:text-goldlining-400 transition-colors">
            ...
            <div id="workspace" class="flex-1 overflow-y-auto p-6 md:p-8 space-y-6">
                    ...
                    <div>
                        <nav class="flex text-xs font-medium text-gray-500 space-x-2" aria-label="Breadcrumb">
                            ...
                            <span id="breadcrumb-current" class="text-maroon-700 font-semibold">
                                ...
                                <?php elseif(Route::currentRouteName() === 'warehouse.profile'): ?>
                                    Profile / Warehouse Profile
                                <?php elseif(Route::currentRouteName() === 'warehouse.inv-adjust'): ?>
                                    Inventory / Inventory Adjustment
                                <?php elseif(Route::currentRouteName() === 'warehouse.sales-junk'): ?>
                                    Inventory / Junk Items
                                <?php elseif(Route::currentRouteName() === 'warehouse.item-convert'): ?>
                ...
                <div id="page-warehouse-dashboard" class="page-view space-y-6 <?php echo e(Route::currentRouteName() === 'warehouse.dashboard' ? '' : 'hidden'); ?>">
                    <?php echo $__env->yieldContent('warehouse_dashboard_content'); ?>
                </div>
                ...
                <div id="page-inv-adjust-container" class="page-view space-y-6 <?php echo e(Route::currentRouteName() === 'warehouse.inv-adjust' ? '' : 'hidden'); ?>">
                    <?php echo $__env->yieldContent('inventory_adjustment_content'); ?>
                </div>

                <!-- PAGE: INVENTORY -> JUNK ITEMS -->
                <div id="page-sales-junk-container" class="page-view space-y-6 <?php echo e(Route::currentRouteName() === 'warehouse.sales-junk' ? '' : 'hidden'); ?>">
                    <?php echo $__env->yieldContent('sales_junk_content'); ?>
                </div>

                <!-- PAGE: INVENTORY -> ITEM CONVERT -->
                <div id="page-item-convert-container" class="page-view space-y-6 <?php echo e(Route::currentRouteName() === 'warehouse.item-convert' ? '' : 'hidden'); ?>">
                ...
                <div id="page-warehouse-profile" class="page-view space-y-6 <?php echo e(Route::currentRouteName() === 'warehouse.profile' ? '' : 'hidden'); ?>">
                ...
                <div id="page-rep-sales" class="page-view space-y-6 <?php echo e(Route::currentRouteName() === 'admin.sales-report' ? '' : 'hidden'); ?>">
...
<?php /**PATH C:\xampp\htdocs\hatdog\resources\views\partials\Warehouse_User\WareHouse-sidebar_navbar.blade.php ENDPATH**/ ?>