<?php $__env->startPush('styles'); ?>
    <link rel="stylesheet" href="<?php echo e(asset('css/purchase-viber.css')); ?>?v=<?php echo e(time()); ?>">
<?php $__env->stopPush(); ?>

<?php $__env->startSection('purchase_viber_content'); ?>
...
<?php $__env->startPush('scripts'); ?>
    <script>
        ...
        window.viberRoutes = {
            suppliers: '<?php echo e(route("regular.purchase-viber.suppliers")); ?>',
            products: '<?php echo e(route("regular.purchase-viber.products")); ?>',
            list: '<?php echo e(route("regular.purchase-viber.list")); ?>',
            storeSupplier: '<?php echo e(route("regular.purchase-viber.store-supplier")); ?>',
            storeItems: '<?php echo e(route("regular.purchase-viber.store-items")); ?>',
            items: '<?php echo e(route("regular.purchase-viber.items", ["viberListId" => ":viberListId"])); ?>',
            counts: '<?php echo e(route("regular.purchase-viber.counts")); ?>',
            invoicedItems: '<?php echo e(route("regular.purchase-viber.invoiced-items")); ?>',
            notArrivedItems: '<?php echo e(route("regular.purchase-viber.not-arrived-items")); ?>',
            updateItem: '<?php echo e(route("regular.purchase-viber.items.update", ["id" => ":id"])); ?>',
            prepareNote: '<?php echo e(route("regular.purchase-viber.prepare-note")); ?>',
            purchaseNote: '<?php echo e(route("regular.purchase-note")); ?>',
            shippedPrintItems: '<?php echo e(route("regular.purchase-viber.shipped-print-items", ["viberListId" => ":viberListId"])); ?>',
            destroySupplier: '<?php echo e(route("regular.purchase-viber.destroy", ["id" => ":id"])); ?>',
            destroyItem: '<?php echo e(route("regular.purchase-viber.items.destroy", ["id" => ":id"])); ?>',
            notArrivedRollback: '<?php echo e(route("regular.purchase-viber.not-arrived-rollback")); ?>',
        };
    </script>
    <script src="<?php echo e(asset('js/Regular-Purchase-Viber.js')); ?>?v=<?php echo e(time()); ?>"></script>
<?php $__env->stopPush(); ?>

<?php $__env->stopSection(); ?>

<?php echo $__env->make('partials.user_account.user_sidebar_navbar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\hatdog\resources\views/Regular_User/Purchase/Viber-List.blade.php ENDPATH**/ ?>