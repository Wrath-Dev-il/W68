...
$colCount = count($years) > 0 ? count($years) : 1;
?>
...
<table class="info-table">
    <tr>
        <td style="width:50%;" class="label">INVOICE NO.: <span style="color:red"><?php echo e($note['invoice_no'] ?: '________________________'); ?></span> <?php if(!empty($note['is_rush'])): ?><span style="background:#800000;color:#fff;padding:2px 8px;font-size:11px;margin-left:6px;border-radius:3px;">RUSH</span><?php endif; ?></td>
        <td style="width:50%;text-align:right;" class="label">DATE: <?php echo e($reportDate); ?> | SN NO.: <?php echo e($note['sales_number']); ?></td>
    </tr>
    <tr>
...
foreach ($note['items'] as $item) {
    $grandTotalAmount += $item['_total'] ?? 0;
}
?>
...
<div class="side">
    ...
    <?php echo $_costInline($leftItem, '', $_lUnit); ?>
...
<div class="side">
    ...
    <?php echo $_costInline($leftItem, 'cp_', $_cUnit); ?>
    ...
    <?php echo $_costInline($rightItem, '', $_rUnit); ?>
...
<?php /**PATH C:\xampp\htdocs\hatdog\resources\views\Admin\sales\online-report-print.blade.php ENDPATH**/ ?>