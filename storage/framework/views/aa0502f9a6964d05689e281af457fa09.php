...
<div class="max-w-7xl mx-auto py-8 px-6 space-y-6">
    ...
    <form id="redirect-form" method="GET" action="<?php echo e(route('regular.sales-note.report-redirect')); ?>" style="display:none">
...
window.submitPrices = async function() {
    ...
    try {
        const res = await fetch('<?php echo e(route("regular.sales-note.online-prices.save")); ?>', {
            method: 'POST',
...
<?php /**PATH C:\xampp\htdocs\hatdog\resources\views\Regular_User\sales\online-price-editor.blade.php ENDPATH**/ ?>