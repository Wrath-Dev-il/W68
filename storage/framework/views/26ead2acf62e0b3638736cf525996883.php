    ...
    <div class="bg-white border border-slate-200 rounded-xl p-6 shadow-sm no-print">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="space-y-2 relative">
                ...
                <div class="sales-report-searchable" data-endpoint="<?php echo e(route('regular.sales-report.customers')); ?>" data-type="object" data-input-id="sales-report-customer" data-default-label="Select All">
                    <div class="relative">
            ...
            <div class="space-y-2 relative">
                ...
                <div class="sales-report-searchable" data-endpoint="<?php echo e(route('regular.sales-report.descriptions')); ?>" data-type="text" data-input-id="sales-report-description">
                    <div class="relative">
            ...
            <div class="space-y-2 relative">
                ...
                <div class="sales-report-searchable" data-endpoint="<?php echo e(route('regular.sales-report.categories')); ?>" data-type="text" data-input-id="sales-report-category">
                    <div class="relative">
            ...
            <div class="space-y-2 relative">
                ...
                <div class="sales-report-searchable" data-endpoint="<?php echo e(route('regular.sales-report.agents')); ?>" data-type="text" data-input-id="sales-report-agent">
                    <div class="relative">
...
<?php $__env->startPush('scripts'); ?>
    <script>
        window.salesReportRoutes = {
            customers: "<?php echo e(route('regular.sales-report.customers')); ?>",
            descriptions: "<?php echo e(route('regular.sales-report.descriptions')); ?>",
            categories: "<?php echo e(route('regular.sales-report.categories')); ?>",
            agents: "<?php echo e(route('regular.sales-report.agents')); ?>",
            printData: "<?php echo e(route('regular.sales-report.print-data')); ?>",
            printSoa: "<?php echo e(route('regular.sales-report.print-soa')); ?>"
        };
    </script>
...
<?php echo $__env->make('partials.user_account.user_sidebar_navbar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\hatdog\resources\views\Regular_User\Reports\sales-report.blade.php ENDPATH**/ ?>