...
<body class="bg-slate-200 font-sans">
        ...
        <div class="no-print bg-amber-50 border-l-4 border-amber-400 p-4 mb-6 rounded-r-xl shadow-sm mx-auto max-w-[215.9mm]">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-xs text-amber-700">Showing first 120 items for preview. Use the <b>PRINT CATALOG</b> button to generate the full report for all <?php echo e(number_format($totalCount)); ?> items.</p>
                </div>
            </div>
        </div>
    <?php endif; ?>

    <?php $__currentLoopData = $previewChunks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pageIndex => $productChunk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="catalog-page catalog-page-item">
            ...
            <div class="catalog-content">
                    ...
                    <?php $__currentLoopData = $productChunk; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="item-card">
                            <div class="item-image-container">
                                ...
                                ?>
                                <?php if($firstImg): ?>
                                    <img src="<?php echo e($firstImg); ?>" class="max-w-full max-h-full object-contain">
                                <?php else: ?>
                            ...
                            <div class="item-details">
                                <div class="detail-row">
                                    ...
                                    <span class="font-black text-black uppercase text-[11px] truncate-text"><?php echo e($product->product_code); ?></span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label">Part No#:</span>
                                    <span class="font-mono text-black font-bold text-[9px]"><?php echo e($product->part_number); ?></span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label">Application:</span>
                                    <span class="text-black font-bold text-[9px] truncate-text leading-tight">
                                        <?php echo e($product->application ?: $product->Application ?: '---'); ?>

                                        <?php if($product->position ?: $product->Position): ?>
                                            <span class="text-[8px] text-slate-500 ml-1">(<?php echo e($product->position ?: $product->Position); ?>)</span>
                                        <?php endif; ?>
                                    </span>
                                </div>
                                <div class="detail-row">
                                    <span class="detail-label">Brand:</span>
                                    <span class="text-black uppercase font-bold text-[9px]"><?php echo e($product->category); ?></span>
                                </div>
                                <div class="mt-1 pt-1 border-t border-dashed border-slate-300 flex justify-between items-center">
                                    <span class="detail-label">Price:</span>
                                    <span class="price-text">₱<?php echo e(number_format($product->selling_price, 2)); ?></span>
                                </div>
                            </div>
                        </div>
                ...
                <div class="mt-auto pt-4 border-t-2 border-slate-300 flex justify-between items-center">
                    ...
                    <p class="text-[12px] text-black font-bold uppercase">PAGE <?php echo e($pageIndex + 1); ?> OF <?php echo e($previewTotalPages); ?></p>
                </div>
            </div>
        </div>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <div id="print-catalog">
        <?php $__currentLoopData = $allChunks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pageIndex => $productChunk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="catalog-page <?php echo e(!$loop->last ? 'page-break' : ''); ?>">
                <div class="catalog-content">
                    <!-- Header -->
                    <div class="flex justify-between items-end border-b-4 border-maroon pb-2 mb-4">
                        <div>
                    ...
                    <div class="mt-auto pt-4 border-t-2 border-slate-300 flex justify-between items-center">
                        ...
                        <p class="text-[12px] text-black font-bold uppercase">PAGE <?php echo e($pageIndex + 1); ?> OF <?php echo e($totalPrintPages); ?></p>
                    </div>
                </div>
            </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH C:\xampp\htdocs\hatdog\resources\views\Special_User\master_list\Product_Catalog.blade.php ENDPATH**/ ?>