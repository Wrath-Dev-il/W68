...
<div id="page-purchase-return-root" class="space-y-8 animate-fade-in text-slate-800">
            ...
            <table class="w-full text-left border-collapse">
                <thead class="bg-slate-50/80 border-b border-slate-100">
                    <tr>
                        ...
                        <th class="p-4 px-6 text-[10px] font-bold text-slate-500 uppercase tracking-widest">Date</th>
                    ...
                    <tr class="bg-slate-50/30 border-b border-slate-100">
                        <th class="p-2 px-5"><input type="text" onkeyup="filterTable('main-return-tbody', 0, this.value)" placeholder="Search Inv..." class="column-search-input"></th>
                        <th class="p-2 px-5"><input type="text" onkeyup="filterTable('main-return-tbody', 1, this.value)" placeholder="Search Date..." class="column-search-input"></th>
                        <th class="p-2 px-5"><input type="text" onkeyup="filterTable('main-return-tbody', 2, this.value)" placeholder="Search Name..." class="column-search-input"></th>
                        <th class="p-2 px-5"><input type="text" onkeyup="filterTable('main-return-tbody', 3, this.value)" placeholder="Search Contact..." class="column-search-input"></th>
                        <th class="p-2 px-5"><input type="text" onkeyup="filterTable('main-return-tbody', 4, this.value)" placeholder="Search Person..." class="column-search-input"></th>
                        <th class="p-2 px-5"><input type="text" onkeyup="filterTable('main-return-tbody', 5, this.value)" placeholder="Search Address..." class="column-search-input"></th>
                ...
                <tbody id="main-return-tbody" class="divide-y divide-slate-100 text-sm">
                    <tr class="hover:bg-slate-50 transition-colors group">
                        ...
                        <td class="p-4 px-6 text-slate-600">2026-09-04</td>
                            ...
                            <table class="w-full text-left border-collapse">
                                <thead class="bg-slate-50 border-b border-slate-100">
                                    <tr>
                                        ...
                                        <th class="p-4 px-6 text-[10px] font-bold text-slate-500 uppercase tracking-widest text-center">OUT</th>
                                        <th class="p-4 px-6 text-[10px] font-bold text-slate-500 uppercase tracking-widest text-center">JUNK</th>
                                ...
                                <tbody id="return-items-tbody" class="divide-y divide-slate-100 text-sm">
                                    <tr class="hover:bg-slate-50 transition-colors">
                                        ...
                                        <td class="p-4 px-6 text-center">
                                            <div class="inline-flex items-center gap-1"><input type="number" value="10" min="0" max="10" oninput="updateReturnItemSubtotal(this)" class="item-qty w-16 px-2 py-1.5 border border-slate-200 rounded-lg text-center"><span class="text-xs font-bold text-slate-400">/10</span></div>
                                        </td>
                                        <td class="p-4 px-6 text-center"><input type="number" value="" min="0" max="10" placeholder="0" oninput="updateReturnOut(this)" class="item-out w-16 px-2 py-1.5 border border-slate-200 rounded-lg text-center"></td>
                                        <td class="p-4 px-6 text-center font-bold text-amber-600 item-junk">10</td>
                                ...
                                <tfoot class="bg-slate-50 border-t-2 border-slate-200">
                                    <tr>
                                        <td colspan="9" class="p-3 px-6 text-right text-xs font-bold text-slate-600 uppercase tracking-wider">Total:</td>
                                        <td class="p-3 px-6 text-right font-bold text-slate-700" id="return-total">₱ 0.00</td>
                                    </tr>
                                    <tr>
                                        <td colspan="9" class="p-3 px-6 text-right text-xs font-bold text-slate-600 uppercase tracking-wider">Additional Discount:</td>
                                    ...
                                    <tr class="bg-blue-50">
                                        <td colspan="9" class="p-3 px-6 text-right text-xs font-bold text-slate-700 uppercase tracking-wider">Grand Total:</td>
                                    ...
                                    <table class="w-full text-left border-collapse">
                                        <thead class="sticky top-0 bg-slate-50 z-10">
                                            <tr class="text-[9px] font-bold text-slate-400 uppercase tracking-widest border-b border-slate-100">
                                                ...
                                                <th class="p-4 text-center">JUNK</th>
    ...
    <div id="invoice-search-modal" class="fixed inset-0 z-[500] hidden flex items-center justify-center" role="dialog" aria-modal="true">
                        ...
                        <table class="w-full text-left border-collapse">
                            <thead class="sticky top-0 bg-slate-50 z-10">
                                <tr class="text-[10px] font-bold text-slate-500 uppercase tracking-widest border-b border-slate-100">
                                    ...
                                    <th class="p-4 px-6 text-center">OUT</th>
                                    <th class="p-4 px-6 text-center">JUNK</th>
                            ...
                            <tbody id="view-items-tbody" class="divide-y divide-slate-100 text-sm">
                                <tr><td colspan="9" class="p-4 text-center text-slate-300 italic">No items to display.</td></tr>
                            </tbody>
                            <tfoot class="sticky bottom-0 bg-slate-100 border-t-2 border-slate-200">
                                <tr class="text-sm font-bold text-slate-600">
                                    <td colspan="8" class="p-3 px-6 text-right uppercase tracking-wider">Subtotal:</td>
                                    <td id="view-subtotal-amount" class="p-3 px-6 text-right">₱ 0.00</td>
                                </tr>
                                <tr class="text-sm font-bold text-orange-600">
                                    <td colspan="8" class="p-3 px-6 text-right uppercase tracking-wider">Additional Discount:</td>
                                ...
                                <tr class="text-sm font-extrabold text-slate-700 bg-blue-50">
                                    <td colspan="8" class="p-4 px-6 text-right uppercase tracking-wider">Total:</td>
...
<?php $__env->startPush('scripts'); ?>
    <script>
        window.returnRoutes = {
            invoicesUrl: '<?php echo e(route("special.purchase-return.invoices")); ?>',
            poItemsUrl: '<?php echo e(route("special.purchase-return.po-items", ["poId" => ":poId"])); ?>',
            processUrl: '<?php echo e(route("special.purchase-return.process")); ?>',
            updateUrl: '<?php echo e(route("special.purchase-return.update", ["id" => ":id"])); ?>',
            deleteUrl: '<?php echo e(route("special.purchase-return.delete", ["id" => ":id"])); ?>',
            historyUrl: '<?php echo e(route("special.purchase-return.history")); ?>',
            dashboardUrl: '<?php echo e(route("special.purchase-return.dashboard")); ?>',
            detailUrl: '<?php echo e(route("special.purchase-return.detail", ["id" => ":id"])); ?>'
        };
...
<?php echo $__env->make('partials.special_user.special_sidebar_navbar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\hatdog\resources\views/Special_User/Purchase/Purchase-Return.blade.php ENDPATH**/ ?>