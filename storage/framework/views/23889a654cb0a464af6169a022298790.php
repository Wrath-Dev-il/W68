    ...
    <div class="bg-white border border-slate-200 rounded-xl p-6 shadow-sm no-print">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
            <div class="space-y-2 relative">
                ...
                <div class="sales-report-searchable" data-endpoint="<?php echo e(url('/regular/reports/cost-report/product-codes')); ?>" data-type="text" data-input-id="cr-product-code" data-multi-select="true">
                    <div class="relative">
            ...
            <div class="space-y-2 relative">
                ...
                <div class="sales-report-searchable" data-endpoint="<?php echo e(url('/regular/reports/cost-report/part-numbers')); ?>" data-type="text" data-input-id="cr-part-number" data-multi-select="true">
                    <div class="relative">
            ...
            <div class="space-y-2 relative">
                ...
                <div class="sales-report-searchable" data-endpoint="<?php echo e(route('regular.cost-report.descriptions')); ?>" data-type="text" data-input-id="cr-description">
                    <div class="relative">
            ...
            <div class="space-y-2 relative">
                ...
                <div class="sales-report-searchable" data-endpoint="<?php echo e(route('regular.cost-report.applications')); ?>" data-type="text" data-input-id="cr-application">
                    <div class="relative">
            ...
            <div class="space-y-2 relative">
                ...
                <div class="sales-report-searchable" data-endpoint="<?php echo e(route('regular.cost-report.categories')); ?>" data-type="text" data-input-id="cr-category">
                    <div class="relative">
            ...
            <div class="space-y-2 relative">
                ...
                <div class="sales-report-searchable" data-endpoint="<?php echo e(url('/regular/reports/cost-report/pricelist-codes')); ?>" data-type="text" data-input-id="cr-pricelist-code">
                    <div class="relative">
    ...
    <script>
        (function () {
            ...
            function crGenerate() {
                ...
                fetch('<?php echo e(route("regular.cost-report.data")); ?>?' + params.toString())
...
<?php /**PATH C:\xampp\htdocs\hatdog\resources\views\Regular_User\Reports\Cost-Report.blade.php ENDPATH**/ ?>