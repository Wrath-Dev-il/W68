...
<script>
    window.prodRoutes = {
        fetch: '<?php echo e(route("special.prod-master.data")); ?>',
        create: '<?php echo e(route("special.prod-master.create")); ?>',
        update: '<?php echo e(route("special.prod-master.update", ["id" => ":id"])); ?>',
        delete: '<?php echo e(route("special.prod-master.delete", ["id" => ":id"])); ?>',
       'ledger': '<?php echo e(route("special.prod-master.ledger", ["id" => ":id"])); ?>',
        'select': '<?php echo e(route("special.prod-master.select")); ?>',
        'reorderLevel': '<?php echo e(route("special.prod-master.reorder-level")); ?>',
        'catalog': '<?php echo e(route("special.prod-master.catalog")); ?>',
        'priceList': '<?php echo e(route("special.prod-master.price-list")); ?>',
        'activeNotes': '<?php echo e(route("special.prod-master.active-notes", ["id" => ":id"])); ?>',
        'priceCodesUpdate': '<?php echo e(route("special.prod-master.price-codes.update", ["id" => ":id"])); ?>'
    };
...
<?php echo $__env->make('partials.special_user.special_sidebar_navbar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\hatdog\resources\views\Special_User\master_list\Product_Master-list.blade.php ENDPATH**/ ?>