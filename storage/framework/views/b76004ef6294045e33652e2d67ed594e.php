...
<script>
    window.purchaseRoutes = {
        process: '<?php echo e(route("special.purchase-order.process")); ?>',
        updatePO: '<?php echo e(route("special.purchase-order.update")); ?>',
        itemsUrl: '<?php echo e(url("/special/purchase/purchase-order/items")); ?>',
        openNotesUrl: '<?php echo e(route("special.purchase.open-notes")); ?>',
        dashboardDataUrl: '<?php echo e(route("special.purchase-order.dashboard")); ?>',
        activeDataUrl: '<?php echo e(route("special.purchase-order.active")); ?>',
        historyDataUrl: '<?php echo e(route("special.purchase-order.history")); ?>',
        poItemsUrl: '<?php echo e(route("special.purchase-order.po-items", ["poId" => ":poId"])); ?>',
        detailsByNumberUrl: '<?php echo e(url("/special/purchase/purchase-note/details-by-number")); ?>',
        poDetailUrl: '<?php echo e(route("special.purchase-order.detail", ["poId" => ":poId"])); ?>',
        resyncCostsUrl: '<?php echo e(route("special.purchase-order.resync-product-costs", ["poId" => ":poId"])); ?>',
        forceCloseUrl: '<?php echo e(route("special.purchase-order.force-close.submit", ["purchaseNoteId" => ":purchaseNoteId"])); ?>',
    };
                        ...
                        <table class="w-full text-left border-collapse">
                            <thead class="bg-slate-50/80 border-b border-slate-100">
                                <tr>
                                    ...
                                    <th class="p-4 px-6 text-[10px] font-bold text-slate-500 uppercase tracking-widest text-nowrap">PO NO.</th>
                                ...
                                <tr class="bg-slate-50/30 border-b border-slate-100">
                                    ...
                                    <th class="p-2 px-5"><input type="text" id="col-search-h-poNo" onkeyup="filterTable('history-purchase-order-tbody', 2, this.value)" placeholder="Search PO..." class="column-search-input"></th>
                                    <th class="p-2 px-5"><input type="text" id="col-search-h-invNo" name="supplier_invoice_number" onkeyup="filterTable('history-purchase-order-tbody', 3, this.value)" placeholder="Search Inv..." class="column-search-input"></th>
                                    <th class="p-2 px-5"><input type="text" id="col-search-h-name" onkeyup="filterTable('history-purchase-order-tbody', 4, this.value)" placeholder="Search Name..." class="column-search-input"></th>
                                    <th class="p-2 px-5"><input type="text" id="col-search-h-totalAmount" onkeyup="filterTable('history-purchase-order-tbody', 5, this.value)" placeholder="Search Amount..." class="column-search-input text-right"></th>
                                    <th class="p-2 px-5"><input type="text" id="col-search-h-remarks" onkeyup="filterTable('history-purchase-order-tbody', 6, this.value)" placeholder="Search Remarks..." class="column-search-input"></th>
                                    <th class="p-2 px-5"></th>
                                </tr>
                            </thead>
...
<?php echo $__env->make('partials.special_user.special_sidebar_navbar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\hatdog\resources\views\Special_User\Purchase\Purchase-Order.blade.php ENDPATH**/ ?>