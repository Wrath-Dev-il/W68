...
<?php $__env->startPush('styles'); ?>
    <link rel="stylesheet" href="<?php echo e(asset('css/supplier_master_list.css')); ?>?v=<?php echo e(time()); ?>">
...
<?php $__env->startSection('supplier_master_content'); ?>
<script>
    ...
    (function() {
        ...
        window.fetch = function(input, init) {
            if (typeof input === 'string') {
                // If the URL starts with /special/masterlist/supplier and we are in /hatdog/public
                if (input.startsWith('/special/masterlist/supplier') && window.location.pathname.includes('/hatdog/public')) {
...
<?php $__env->startPush('scripts'); ?>
    <script>
        window.supplierRoutes = {
            fetchData: '<?php echo e(route("special.supplier-master.data")); ?>',
            fetchLifecycle: '<?php echo e(route("special.supplier-master.lifecycle")); ?>',
            create: '<?php echo e(route("special.supplier-master.create")); ?>',
            update: '<?php echo e(route("special.supplier-master.update", ["id" => ":id"])); ?>',
            delete: '<?php echo e(route("special.supplier-master.delete", ["id" => ":id"])); ?>',
            fetchLedgerItems: '<?php echo e(route("special.masterlist.supplier.ledger-items", ["supplierId" => ":id"])); ?>',
            fetchUnregisteredPurchaseOrders: '<?php echo e(route("special.masterlist.supplier.unregistered-purchase-orders", ["supplierId" => ":id"])); ?>',
            fetchHistory: '<?php echo e(route("special.supplier-master.history", ["id" => ":id"])); ?>',
            fetchLedger: '<?php echo e(route("special.supplier-master.ledger", ["id" => ":id"])); ?>',
            purchaseOrderDetail: '<?php echo e(route("special.purchase-order.detail", ["poId" => ":id"])); ?>',
            purchaseOrderPage: '<?php echo e(route("special.purchase-order")); ?>',
        };
    </script>
    <!-- Leaflet JS for OpenStreetMap -->
    <script src="https://unpkg.com/leaflet@1.9.4/dist/leaflet.js" integrity="sha256-20nQCchB9co0qIjJZRGuk2/Z9VM+kNiyxNV1lvTlZBo=" crossorigin=""></script>
    <script src="<?php echo e(asset('js/supplier_master_list.js')); ?>?v=<?php echo e(time()); ?>"></script>
<?php $__env->stopPush(); ?>




<?php echo $__env->make('partials.special_user.special_sidebar_navbar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\hatdog\resources\views/Special_User/master_list/Supplier_Master-list.blade.php ENDPATH**/ ?>