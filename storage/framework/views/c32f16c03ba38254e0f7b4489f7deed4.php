    ...
    <div class="flex items-center justify-center min-h-screen p-4">
        ...
        <div class="animate-slide-up relative bg-white rounded-3xl shadow-2xl max-w-sm w-full p-8 text-center space-y-6">
            ...
            <div>
                ...
                <p class="text-xs text-slate-400 font-medium leading-relaxed mt-2">This will convert the source item quantity to the target product. This action cannot be undone.</p>
            </div>
...
<?php $__env->startPush('scripts'); ?>
    <script>
        ...
        function loadAllData() {
            ...
            fetch('<?php echo e(route("warehouse.item-convert.data")); ?>' + params)
        ...
        document.getElementById('confirm-yes-btn')?.addEventListener('click', function () {
            ...
            fetch('<?php echo e(route("warehouse.item-convert.save")); ?>', {
                method: 'POST',
        ...
        function loadTargets() {
            ...
            fetch('<?php echo e(route("warehouse.item-convert.targets")); ?>' + params)
                .then(function (r) { return r.json(); })
                .then(function (res) {
                    if (!res.success) {
...
<?php /**PATH C:\xampp\htdocs\hatdog\resources\views\Warehouse_User\inventory\item-convert.blade.php ENDPATH**/ ?>