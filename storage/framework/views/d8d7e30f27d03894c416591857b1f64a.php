...
<?php $__env->startPush('scripts'); ?>
    <script>
        window.supplierRoutes = {
            fetchData: '<?php echo e(route("admin.supplier-master.data")); ?>',
            fetchLifecycle: '<?php echo e(route("admin.supplier-master.lifecycle")); ?>',
            create: '<?php echo e(route("admin.supplier-master.create")); ?>',
            update: '<?php echo e(route("admin.supplier-master.update", ["id" => ":id"])); ?>',
            delete: '<?php echo e(route("admin.supplier-master.delete", ["id" => ":id"])); ?>',
            fetchLedgerItems: '<?php echo e(route("admin.masterlist.supplier.ledger-items", ["supplierId" => ":id"])); ?>',
            fetchUnregisteredPurchaseOrders: '<?php echo e(route("admin.masterlist.supplier.unregistered-purchase-orders", ["supplierId" => ":id"])); ?>',
            fetchHistory: '<?php echo e(route("admin.supplier-master.history", ["id" => ":id"])); ?>',
            fetchLedger: '<?php echo e(route("admin.supplier-master.ledger", ["id" => ":id"])); ?>',
            purchaseOrderDetail: '<?php echo e(route("admin.purchase-order.detail", ["poId" => ":id"])); ?>',
            purchaseOrderPage: '<?php echo e(route("admin.purchase-order")); ?>',
        };
    </script>
...
<?php /**PATH C:\xampp\htdocs\hatdog\resources\views\Admin\master_list\Supplier_Master-list.blade.php ENDPATH**/ ?>