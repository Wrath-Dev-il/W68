...
<script>
    window.adjustmentRoutes = {
        fetch: '<?php echo e(route("regular.inv-adjust.data")); ?>',
        adjust: '<?php echo e(route("regular.inv-adjust.save")); ?>',
        adjusted: '<?php echo e(route("regular.inv-adjust.adjusted")); ?>',
        adjustedUpdate: '<?php echo e(route("regular.inv-adjust.adjusted.update", ["id" => ":id"])); ?>',
        adjustedDelete: '<?php echo e(route("regular.inv-adjust.adjusted.delete", ["id" => ":id"])); ?>',
...
<?php echo $__env->make('partials.user_account.user_sidebar_navbar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\hatdog\resources\views\Regular_User\Inventory\inventory_adjustment.blade.php ENDPATH**/ ?>