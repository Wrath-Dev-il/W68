...
<?php $__env->startSection('unserved_report_content'); ?>
<div id="unserved-report-root"
     class="unserved-report-page"
     data-customers-url="<?php echo e(route('special.unserved-report.customers')); ?>"
     data-salesmen-url="<?php echo e(route('special.unserved-report.salesmen')); ?>"
     data-data-url="<?php echo e(route('special.unserved-report.data')); ?>"
     data-print-url="<?php echo e(route('special.unserved-report.print')); ?>">
...
<?php $__env->startPush('scripts'); ?>
    <script src="<?php echo e(asset('js/unserved-report.js')); ?>?v=<?php echo e(@filemtime(public_path('js/unserved-report.js')) ?: time()); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('partials.special_user.special_sidebar_navbar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\hatdog\resources\views/Special_User/sales/unserved-report.blade.php ENDPATH**/ ?>