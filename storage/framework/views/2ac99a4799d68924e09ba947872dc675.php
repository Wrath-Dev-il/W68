...
<?php $__env->startSection('warehouse_dashboard_content'); ?>
...
<div class="dashboard-main p-6 bg-gray-50">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <a href="<?php echo e(route('admin.inv-adjust')); ?>" class="group block bg-gradient-to-br from-maroon-900 to-maroon-950 rounded-2xl shadow-xl p-6 hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 border border-maroon-800">
        ...
        <!-- Card 2: Sale's Junk -->
        <a href="<?php echo e(route('admin.sales-junk')); ?>" class="group block bg-gradient-to-br from-maroon-900 to-maroon-950 rounded-2xl shadow-xl p-6 hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 border border-maroon-800">
            <div class="flex flex-col items-center text-center space-y-4">
                <div class="icon-bg p-5 rounded-2xl">
...
<?php /**PATH C:\xampp\htdocs\hatdog\resources\views\Warehouse_User\Dashboards\WareHouse-Dashboard.blade.php ENDPATH**/ ?>