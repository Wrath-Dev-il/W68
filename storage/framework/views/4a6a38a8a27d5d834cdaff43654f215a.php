...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        window.pcvRoutes = {
            data: "<?php echo e(route('regular.payable-cheque-voucher.data')); ?>",
            supplier: "<?php echo e(url('/regular/accounting/payable-cheque-voucher/supplier')); ?>",
            process: "<?php echo e(route('regular.payable-cheque-voucher.process')); ?>",
            returns: "<?php echo e(url('/regular/accounting/payable-cheque-voucher/returns')); ?>",
            suddenReturns: "<?php echo e(url('/regular/accounting/payable-cheque-voucher/sudden-returns')); ?>",
            history: "<?php echo e(url('/regular/accounting/payable-cheque-voucher/history')); ?>",
            historyDetail: "<?php echo e(url('/regular/accounting/payable-cheque-voucher/history')); ?>",
            show: "<?php echo e(url('/regular/accounting/payable-cheque-voucher/show')); ?>",
            updateNew: "<?php echo e(url('/regular/accounting/payable-cheque-voucher/update-new')); ?>",
            draftSave: "<?php echo e(url('/regular/accounting/payable-cheque-voucher/draft/save')); ?>",
            draftGet: "<?php echo e(url('/regular/accounting/payable-cheque-voucher/draft/get')); ?>",
            draftClear: "<?php echo e(url('/regular/accounting/payable-cheque-voucher/draft/clear')); ?>",
            recommendations: "<?php echo e(url('/regular/accounting/payable-cheque-voucher/supplier')); ?>"
        };
        ...
        (() => {
            ...
            async function openPrintModal(supplierId) {
                ...
                try {
                    ...
                    const res = await fetch(`<?php echo e(url('/regular/accounting/payable-cheque-voucher/history/supplier')); ?>/${supplierId}/vouchers`);
                    const data = await res.json();
            ...
            window.pcvSubmitDeleteVoucher = async function() {
                ...
                try {
                    const res = await fetch(`<?php echo e(url('/regular/accounting/payable-cheque-voucher/delete')); ?>/${deleteVoucherId}`, {
                        method: 'DELETE',
                        headers: {
...
<?php echo $__env->make('partials.user_account.user_sidebar_navbar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php /**PATH C:\xampp\htdocs\hatdog\resources\views/Regular_User/Accounting/Payable-Cheque-Voucher.blade.php ENDPATH**/ ?>