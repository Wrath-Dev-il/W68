...
<?php $__currentLoopData = $pages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="page">
        ...
        <div class="company-header">
            ...
            <div class="soa-date"><?php echo e(date('F d, Y')); ?></div>
        </div>

        <!-- Date Range -->
        <div class="date-range"><?php echo e($dateRangeLabel); ?></div>

        <!-- Customer Box (shown only on first page of each customer) -->
        <?php if($page['show_customer_box']): ?>
            <div class="customer-box">
                <div class="customer-name"><?php echo e($page['customer']['name']); ?></div>
                <div><?php echo e($page['customer']['address']); ?></div>
                <div class="customer-code"><?php echo e(str_pad($page['customer']['id'], 8, '0', STR_PAD_LEFT)); ?></div>
            </div>
        <?php endif; ?>
        ...
        <table class="soa-table">
            ...
            <tbody>
                <?php $__currentLoopData = $page['rows']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td><?php echo e($row['date'] ? \Carbon\Carbon::parse($row['date'])->format('d-M-y') : ''); ?></td>
                        <td class="mono"><?php echo e($row['invoice_no']); ?></td>
                        <td class="right"><?php echo e($row['debits'] > 0 ? number_format($row['debits'], 2) : ''); ?></td>
                        <td class="right"><?php echo e($row['credits'] > 0 ? number_format($row['credits'], 2) : ''); ?></td>
                        <td class="right"><?php echo e(number_format($row['balance'], 2)); ?></td>
                        <td class="col-remarks"><?php echo e($row['remarks']); ?></td>
                    </tr>
        ...
        <?php if($page['show_payment_summary']): ?>
            <div class="payment-summary">
                Please pay this amount &nbsp;&nbsp;&nbsp;&nbsp;
                <span class="amount"><?php echo e(number_format($page['total_balance'], 2)); ?></span>
            </div>
...
<?php /**PATH C:\xampp\htdocs\hatdog\resources\views\Admin\Reports\prints\sales-report-print.blade.php ENDPATH**/ ?>