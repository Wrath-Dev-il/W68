        ...
        <?php $__currentLoopData = [
            ...
            <div class="bg-white border border-slate-200 rounded-xl p-5 shadow-sm">
                <div class="flex items-center justify-between gap-4">
                    <div class="min-w-0">
                        <p class="text-[10px] font-black uppercase tracking-widest text-slate-400"><?php echo e($card['label']); ?></p>
                        <p id="ecv-stat-<?php echo e($card['id']); ?>" class="mt-3 text-2xl font-black text-slate-900">0</p>
                    </div>
...
<?php /**PATH C:\xampp\htdocs\hatdog\resources\views\partials\admin\accounting\expense-cheque-voucher-content.blade.php ENDPATH**/ ?>