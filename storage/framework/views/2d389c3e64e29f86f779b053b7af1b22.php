...
<div id="invoice-search-modal" class="fixed inset-0 z-[980] hidden flex items-center justify-center p-4">
...
<div id="edit-return-confirm-modal" class="fixed inset-0 z-[1000] hidden flex items-center justify-center" role="dialog" aria-modal="true">
...
<?php $__env->startPush('scripts'); ?>
    <script>
        window.salesReturnRoutes = {
            invoices: "<?php echo e(route('admin.sales-return.invoices')); ?>",
            items: "<?php echo e(route('admin.sales-return.items', ':id')); ?>",
            history: "<?php echo e(route('admin.sales-return.history')); ?>",
            historyDetail: "<?php echo e(route('admin.sales-return.history-detail', ':id')); ?>",
            finalize: "<?php echo e(route('admin.sales-return.finalize')); ?>",
            dashboard: "<?php echo e(route('admin.sales-return.dashboard')); ?>",
            editData: "<?php echo e(route('admin.sales-return.edit-data', ':id')); ?>",
            update: "<?php echo e(route('admin.sales-return.update', ':id')); ?>",
            delete: "<?php echo e(route('admin.sales-return.delete', ':id')); ?>",
        };
...
<?php /**PATH C:\xampp\htdocs\hatdog\resources\views\Admin\sales\sales-return.blade.php ENDPATH**/ ?>