    ...
    <div class="flex flex-1 h-screen overflow-hidden">
        ...
        <aside id="sidebar" class="sidebar-transition bg-maroon-900 border-r-4 border-goldlining-500 w-64 flex flex-col h-full text-white z-[250] shadow-2xl relative no-print">
            ...
            <div class="flex-1 min-h-0 overflow-y-auto px-3 pt-4 pb-28 space-y-1.5 scroll-pb-28" id="nav-container">
                ...
                <div>
                    <a href="{{ route('special.dashboard') }}" class="nav-item flex items-center space-x-3 px-3 py-3 rounded-lg transition-all duration-150 group {{ Route::currentRouteName() === 'special.dashboard' ? 'active bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'hover:bg-maroon-800 text-gray-100' }}" title="Dashboard">
                ...
                <div class="menu-dropdown">
                    <button onclick="toggleDropdown('dropdown-master', this)" class="w-full flex items-center justify-between px-3 py-3 rounded-lg hover:bg-maroon-800 text-gray-100 hover:text-white transition-all group" title="Master List">
                        ...
                        <i data-lucide="chevron-down" class="dropdown-chevron w-4 h-4 text-goldlining-500 rotate-transition sidebar-text {{ in_array(Route::currentRouteName(), ['regular.prod-master', 'regular.supplier-master', 'regular.customer-master', 'regular.forwarder-master', 'special.prod-master', 'special.prod-online-config', 'special.supplier-master', 'special.customer-master', 'special.forwarder-master']) ? 'rotate-180' : '' }}"></i>
                    </button>
                    <div id="dropdown-master" class="submenu-transition overflow-hidden bg-maroon-950 bg-opacity-40 rounded-md mt-1 pl-4 space-y-1" style="{{ in_array(Route::currentRouteName(), ['regular.prod-master', 'regular.supplier-master', 'regular.customer-master', 'regular.forwarder-master', 'special.prod-master', 'special.prod-online-config', 'special.supplier-master', 'special.customer-master', 'special.forwarder-master']) ? 'max-height: 500px;' : 'max-height: 0px;' }}">
                        <a href="{{ route('special.prod-master') }}" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all {{ Route::currentRouteName() === 'special.prod-master' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1' }}" data-page="prod-master">
                            <i data-lucide="package" class="w-3.5 h-3.5 {{ Route::currentRouteName() === 'special.prod-master' ? 'text-maroon-950' : '' }}"></i>
                            <span>Product Master List</span>
                        </a>
                         <a href="{{ route('special.prod-online-config') }}" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all {{ Route::currentRouteName() === 'special.prod-online-config' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1' }}" data-page="prod-online-config">
                            <i data-lucide="refresh-cw" class="w-3.5 h-3.5 {{ Route::currentRouteName() === 'special.prod-online-config' ? 'text-maroon-950' : 'text-cyan-400' }}"></i>
                            <span>Online Product Config</span>
                        </a>
                        <a href="{{ route('special.supplier-master') }}" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all {{ Route::currentRouteName() === 'special.supplier-master' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1' }}" data-page="supplier-master">
                            <i data-lucide="truck" class="w-3.5 h-3.5 {{ Route::currentRouteName() === 'special.supplier-master' ? 'text-maroon-950' : 'text-blue-400' }}"></i>
                            <span>Supplier Master List</span>
                        </a>
                        <a href="{{ route('special.customer-master') }}" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all {{ Route::currentRouteName() === 'special.customer-master' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1' }}" data-page="customer-master">
                            <i data-lucide="users" class="w-3.5 h-3.5 {{ Route::currentRouteName() === 'special.customer-master' ? 'text-maroon-950' : 'text-emerald-400' }}"></i>
                            <span>Customer Master List</span>
                        </a>
                        <a href="{{ route('special.forwarder-master') }}" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all {{ Route::currentRouteName() === 'special.forwarder-master' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1' }}" data-page="forwarder-master">
                            <i data-lucide="plane" class="w-3.5 h-3.5 {{ Route::currentRouteName() === 'special.forwarder-master' ? 'text-maroon-950' : 'text-emerald-400' }}"></i>
                ...
                <div class="menu-dropdown">
                    <button onclick="toggleDropdown('dropdown-inventory', this)" class="w-full flex items-center justify-between px-3 py-3 rounded-lg hover:bg-maroon-800 text-gray-100 hover:text-white transition-all group" title="Inventory Management">
                        ...
                        <i data-lucide="chevron-down" class="dropdown-chevron w-4 h-4 text-goldlining-500 rotate-transition sidebar-text {{ in_array(Route::currentRouteName(), ['special.inv-adjust', 'special.sales-junk', 'special.item-convert']) ? 'rotate-180' : '' }}"></i>
                    </button>
                    <div id="dropdown-inventory" class="submenu-transition overflow-hidden bg-maroon-950 bg-opacity-40 rounded-md mt-1 pl-4 space-y-1" style="{{ in_array(Route::currentRouteName(), ['special.inv-adjust', 'special.sales-junk', 'special.item-convert']) ? 'max-height: 500px;' : 'max-height: 0px;' }}">
                        <a href="{{ route('special.inv-adjust') }}" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all {{ Route::currentRouteName() === 'special.inv-adjust' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1' }}" data-page="inv-adjust">
                            <i data-lucide="sliders-horizontal" class="w-3.5 h-3.5 {{ Route::currentRouteName() === 'special.inv-adjust' ? 'text-maroon-950' : '' }}"></i>
                            <span>Inventory Adjustment</span>
                        </a>
                        <a href="{{ route('special.sales-junk') }}" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all {{ Route::currentRouteName() === 'special.sales-junk' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1' }}" data-page="sales-junk">
                            <i data-lucide="archive" class="w-3.5 h-3.5 {{ Route::currentRouteName() === 'special.sales-junk' ? 'text-maroon-950' : '' }}"></i>
                            <span>Junk Items</span>
                        </a>
                         <a href="{{ route('special.item-convert') }}" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all {{ Route::currentRouteName() === 'special.item-convert' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1' }}" data-page="item-convert">
                            <i data-lucide="shuffle" class="w-3.5 h-3.5 {{ Route::currentRouteName() === 'special.item-convert' ? 'text-maroon-950' : '' }}"></i>
                ...
                <div class="menu-dropdown">
                    <button onclick="toggleDropdown('dropdown-purchasing', this)" class="w-full flex items-center justify-between px-3 py-3 rounded-lg hover:bg-maroon-800 text-gray-100 hover:text-white transition-all group" title="Purchasing">
                        ...
                        <i data-lucide="chevron-down" class="dropdown-chevron w-4 h-4 text-goldlining-500 rotate-transition sidebar-text {{ in_array(Route::currentRouteName(), ['special.purchase-note', 'special.purchase-order', 'special.purchase-return', 'special.purchase-viber']) ? 'rotate-180' : '' }}"></i>
                    </button>
                    <div id="dropdown-purchasing" class="submenu-transition overflow-hidden bg-maroon-950 bg-opacity-40 rounded-md mt-1 pl-4 space-y-1" style="{{ in_array(Route::currentRouteName(), ['special.purchase-note', 'special.purchase-order', 'special.purchase-return', 'special.purchase-viber']) ? 'max-height: 500px;' : 'max-height: 0px;' }}">
                          <a href="{{ route('special.purchase-viber') }}" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all {{ Route::currentRouteName() === 'special.purchase-viber' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1' }}" data-page="viber-list">
                            <i data-lucide="file-text" class="w-3.5 h-3.5 {{ Route::currentRouteName() === 'special.purchase-viber' ? 'text-maroon-950' : '' }}"></i>
                            <span>Purchase Entry</span>
                        </a>
                        <a href="{{ route('special.purchase-note') }}" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all {{ Route::currentRouteName() === 'special.purchase-note' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1' }}" data-page="purch-note">
                            <i data-lucide="file-text" class="w-3.5 h-3.5 {{ Route::currentRouteName() === 'special.purchase-note' ? 'text-maroon-950' : '' }}"></i>
                            <span>Purchasing Note</span>
                        </a>
                        <a href="{{ route('special.purchase-order') }}" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all {{ Route::currentRouteName() === 'special.purchase-order' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1' }}" data-page="purch-order">
                            <i data-lucide="shopping-bag" class="w-3.5 h-3.5 {{ Route::currentRouteName() === 'special.purchase-order' ? 'text-maroon-950' : '' }}"></i>
                            <span>Purchase Order</span>
                        </a>
                        <a href="{{ route('special.purchase-return') }}" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all {{ Route::currentRouteName() === 'special.purchase-return' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1' }}" data-page="purch-return">
                            <i data-lucide="undo-2" class="w-3.5 h-3.5 {{ Route::currentRouteName() === 'special.purchase-return' ? 'text-maroon-950' : '' }}"></i>
                ...
                <div class="menu-dropdown">
                    <button onclick="toggleDropdown('dropdown-sales', this)" class="w-full flex items-center justify-between px-3 py-3 rounded-lg hover:bg-maroon-800 text-gray-100 hover:text-white transition-all group" title="Sales">
                        ...
                        <i data-lucide="chevron-down" class="dropdown-chevron w-4 h-4 text-goldlining-500 rotate-transition sidebar-text {{ in_array(Route::currentRouteName(), ['regular.sales-note', 'regular.sales-order', 'regular.consignment-invoice', 'regular.sales-return', 'regular.waybill', 'special.sales-note', 'special.sales-order', 'special.consignment-invoice', 'special.sales-return', 'special.waybill']) ? 'rotate-180' : '' }}"></i>
                    </button>
                    <div id="dropdown-sales" class="submenu-transition overflow-hidden bg-maroon-950 bg-opacity-40 rounded-md mt-1 pl-4 space-y-1" style="{{ in_array(Route::currentRouteName(), ['regular.sales-note', 'regular.sales-order', 'regular.consignment-invoice', 'regular.sales-return', 'regular.waybill', 'special.sales-note', 'special.sales-order', 'special.consignment-invoice', 'special.sales-return', 'special.waybill']) ? 'max-height: 500px;' : 'max-height: 0px;' }}">
                        <a href="{{ route('special.sales-note') }}" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all {{ Route::currentRouteName() === 'special.sales-note' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1' }}" data-page="sales-note">
                            <i data-lucide="receipt" class="w-3.5 h-3.5 {{ Route::currentRouteName() === 'special.sales-note' ? 'text-maroon-950' : '' }}"></i>
                            <span>Sales Note</span>
                        </a>
                        <a href="{{ route('special.sales-order') }}" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all {{ Route::currentRouteName() === 'special.sales-order' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1' }}" data-page="sales-order">
                            <i data-lucide="file-symlink" class="w-3.5 h-3.5 {{ Route::currentRouteName() === 'special.sales-order' ? 'text-maroon-950' : '' }}"></i>
                            <span>Sales Order</span>
                        </a>
                        <a href="{{ route('special.consignment-invoice') }}" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all {{ Route::currentRouteName() === 'special.consignment-invoice' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1' }}" data-page="cons-invoice">
                            <i data-lucide="file-digit" class="w-3.5 h-3.5 {{ Route::currentRouteName() === 'special.consignment-invoice' ? 'text-maroon-950' : '' }}"></i>
                            <span>Consignment Invoice</span>
                        </a>
                        <a href="{{ route('special.sales-return') }}" class="flex items-center space-x-2 py-2 px-3 text-xs {{ Request::routeIs('special.sales-return') ? 'text-goldlining-400 bg-maroon/20' : 'text-gray-300' }} hover:text-goldlining-400 hover:translate-x-1 transition-all rounded" data-page="sales-return">
                            <i data-lucide="corner-up-left" class="w-3.5 h-3.5"></i>
                            <span>Sales Return</span>
                        </a>

                        <a href="{{ route('special.waybill') }}" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all {{ Route::currentRouteName() === 'special.waybill' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1' }}" data-page="waybill">
                            <i data-lucide="map" class="w-3.5 h-3.5 {{ Route::currentRouteName() === 'special.waybill' ? 'text-maroon-950' : '' }}"></i>
                            <span>Waybill</span>
                        </a>
                    </div>
                </div>
                ...
                <!-- ACCOUNTING (DROPDOWN) -->
                <div class="menu-dropdown">
                    <button onclick="toggleDropdown('dropdown-accounting', this)" class="w-full flex items-center justify-between px-3 py-3 rounded-lg hover:bg-maroon-800 {{ in_array(Route::currentRouteName(), ['regular.payments', 'regular.payable-cheque-voucher', 'regular.expense-cheque-voucher', 'special.payments', 'special.payable-cheque-voucher', 'special.expense-cheque-voucher']) ? 'bg-maroon-800 text-white shadow-inner' : 'text-gray-100' }} hover:text-white transition-all group" title="Accounting">
                        <div class="flex items-center space-x-3">
                            <i data-lucide="calculator" class="w-5 h-5 text-goldlining-400 group-hover:scale-110 transition-transform flex-shrink-0"></i>
                            <span class="sidebar-text text-sm whitespace-nowrap {{ in_array(Route::currentRouteName(), ['regular.payments', 'regular.payable-cheque-voucher', 'regular.expense-cheque-voucher', 'special.payments', 'special.payable-cheque-voucher', 'special.expense-cheque-voucher']) ? 'font-bold text-goldlining-400' : '' }}">Accounting</span>
                        </div>
                        <i data-lucide="chevron-down" class="dropdown-chevron w-4 h-4 text-goldlining-500 rotate-transition sidebar-text {{ in_array(Route::currentRouteName(), ['regular.payments', 'regular.payable-cheque-voucher', 'regular.expense-cheque-voucher', 'special.payments', 'special.payable-cheque-voucher', 'special.expense-cheque-voucher']) ? 'rotate-180' : '' }}"></i>
                    </button>
                    <div id="dropdown-accounting" class="submenu-transition overflow-hidden bg-maroon-950 bg-opacity-40 rounded-md mt-1 pl-4 space-y-1" style="{{ in_array(Route::currentRouteName(), ['regular.payments', 'regular.payable-cheque-voucher', 'regular.expense-cheque-voucher', 'special.payments', 'special.payable-cheque-voucher', 'special.expense-cheque-voucher']) ? 'max-height: 500px;' : 'max-height: 0px;' }}">
                        <a href="{{ route('special.payments') }}" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all {{ Route::currentRouteName() === 'special.payments' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1' }}" data-page="payments">
                            <i data-lucide="credit-card" class="w-3.5 h-3.5 {{ Route::currentRouteName() === 'special.payments' ? 'text-maroon-950' : '' }}"></i>
                            <span>Payments</span>
                        </a>
                        <a href="{{ route('special.payable-cheque-voucher') }}" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all {{ Route::currentRouteName() === 'special.payable-cheque-voucher' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1' }}" data-page="pay-cheque">
                            <i data-lucide="book-check" class="w-3.5 h-3.5 {{ Route::currentRouteName() === 'special.payable-cheque-voucher' ? 'text-maroon-950' : '' }}"></i>
                            <span>Payable Cheque Voucher</span>
                        </a>
                        <a href="{{ route('special.expense-cheque-voucher') }}" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all {{ Route::currentRouteName() === 'special.expense-cheque-voucher' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1' }}" data-page="exp-cheque">
                            <i data-lucide="receipt" class="w-3.5 h-3.5 {{ Route::currentRouteName() === 'special.expense-cheque-voucher' ? 'text-maroon-950' : '' }}"></i>
                ...
                <!-- REPORTS (DROPDOWN) -->
                <div class="menu-dropdown">
                    <button onclick="toggleDropdown('dropdown-reports', this)" class="w-full flex items-center justify-between px-3 py-3 rounded-lg hover:bg-maroon-800 {{ in_array(Route::currentRouteName(), ['regular.sales-report', 'regular.inventory-reports', 'regular.accounts-receivable', 'special.sales-report', 'special.inventory-reports', 'special.accounts-receivable', 'special.unserved-report', 'special.cost-report', 'special.top-products']) ? 'bg-maroon-800 text-white shadow-inner' : 'text-gray-100' }} hover:text-white transition-all group" title="Reports">
                        <div class="flex items-center space-x-3">
                            <i data-lucide="trending-up" class="w-5 h-5 text-goldlining-400 group-hover:scale-110 transition-transform flex-shrink-0"></i>
                            <span class="sidebar-text text-sm whitespace-nowrap {{ in_array(Route::currentRouteName(), ['regular.sales-report', 'regular.inventory-reports', 'regular.accounts-receivable', 'special.sales-report', 'special.inventory-reports', 'special.accounts-receivable', 'special.unserved-report', 'special.cost-report', 'special.top-products']) ? 'font-bold text-goldlining-400' : '' }}">Reports</span>
                        </div>
                        <i data-lucide="chevron-down" class="dropdown-chevron w-4 h-4 text-goldlining-500 rotate-transition sidebar-text {{ in_array(Route::currentRouteName(), ['regular.sales-report', 'regular.inventory-reports', 'regular.accounts-receivable', 'special.sales-report', 'special.inventory-reports', 'special.accounts-receivable', 'special.unserved-report', 'special.cost-report', 'special.top-products']) ? 'rotate-180' : '' }}"></i>
                    </button>
                    <div id="dropdown-reports" class="submenu-transition overflow-hidden bg-maroon-950 bg-opacity-40 rounded-md mt-1 pl-4 space-y-1" style="{{ in_array(Route::currentRouteName(), ['regular.sales-report', 'regular.inventory-reports', 'regular.accounts-receivable', 'special.sales-report', 'special.inventory-reports', 'special.accounts-receivable', 'special.unserved-report', 'special.cost-report', 'special.top-products']) ? 'max-height: 500px;' : 'max-height: 0px;' }}">
                        <a href="{{ route('special.sales-report') }}" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all {{ Route::currentRouteName() === 'special.sales-report' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1' }}" data-page="rep-sales">
                            <i data-lucide="bar-chart-3" class="w-3.5 h-3.5 {{ Route::currentRouteName() === 'special.sales-report' ? 'text-maroon-950' : '' }}"></i>
                            <span>Account Receivable</span>
                        </a>
                        <a href="{{ route('special.inventory-reports') }}" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all {{ Route::currentRouteName() === 'special.inventory-reports' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1' }}" data-page="rep-inv">
                            <i data-lucide="package-search" class="w-3.5 h-3.5 {{ Route::currentRouteName() === 'special.inventory-reports' ? 'text-maroon-950' : '' }}"></i>
                            <span>Inventory Reports</span>
                        </a>

                        <a href="{{ route('special.unserved-report') }}" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all {{ Route::currentRouteName() === 'special.unserved-report' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1' }}" data-page="rep-unserved">
                            <i data-lucide="arrow-down-left" class="w-3.5 h-3.5 {{ Route::currentRouteName() === 'special.unserved-report' ? 'text-maroon-950' : '' }}"></i>
                            <span>Unserved Details</span>
                        </a>

                        <a href="{{ route('special.accounts-receivable') }}" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all {{ Route::currentRouteName() === 'special.accounts-receivable' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1' }}" data-page="rep-ar">
                            <i data-lucide="arrow-down-left" class="w-3.5 h-3.5 {{ Route::currentRouteName() === 'special.accounts-receivable' ? 'text-maroon-950' : '' }}"></i>
        ...
        <main class="flex-1 flex flex-col min-w-0 overflow-hidden">
                    ...
                    <div class="relative">
                        <button id="notif-btn" class="p-2 rounded-full hover:bg-gray-100 text-gray-600 relative transition-all" title="View Notifications">
                            ...
                            @if($activeSystemThemeIcons['notification'])
                                <img src="{{ $systemThemeAssetSrc($activeSystemThemeIcons['notification']) }}" id="bell-icon" alt="{{ $activeSystemTheme }} notification" class="system-theme-navbar-icon">
                            @else
                    ...
                    <div class="relative">
                        ...
                        <button id="profile-dropdown-btn" class="flex items-center space-x-2.5 cursor-pointer hover:bg-gray-50 transition-all p-1.5 rounded-lg focus:outline-none" title="User Menu">
                            ...
                            <div class="hidden lg:block text-left">
                                <h5 class="text-xs font-bold text-gray-800 leading-tight">{{ $sidebarFullName ?? 'User' }}</h5>
                                <span class="text-[10px] text-gray-500 block">{{ $sidebarRoleLabel ?? 'Staff' }}</span>
                            </div>
                        </button>
                        ...
                        <div id="profile-dropdown" class="hidden absolute right-0 mt-3 w-48 bg-maroon-900 border border-goldlining-500 rounded-xl shadow-xl z-50 overflow-hidden py-1 text-white">
                            <a href="{{ route('special.profile') }}" class="flex items-center space-x-2.5 px-4 py-2.5 text-sm text-gray-100 hover:bg-maroon-800 hover:text-goldlining-400 transition-colors">
            ...
            <div id="workspace" class="flex-1 overflow-y-auto p-6 md:p-8 space-y-6">
                        ...
                        <nav class="flex text-xs font-medium text-gray-500 space-x-2" aria-label="Breadcrumb">
                            ...
                            <span id="breadcrumb-current" class="text-maroon-700 font-semibold">
                                @if(Route::currentRouteName() === 'admin.usm')
                                    System Security / USM
                                @elseif(in_array(Route::currentRouteName(), ['regular.prod-master', 'special.prod-master']))
                                    Master List / Product Master
                                @elseif(in_array(Route::currentRouteName(), ['regular.supplier-master', 'special.supplier-master']))
                                    Master List / Supplier Master
                                @elseif(in_array(Route::currentRouteName(), ['regular.customer-master', 'special.customer-master']))
                                    Master List / Customer Master
                                @elseif(in_array(Route::currentRouteName(), ['regular.forwarder-master', 'special.forwarder-master']))
                                    Master List / Forwarder Master
                                @elseif(in_array(Route::currentRouteName(), ['regular.inv-adjust', 'special.inv-adjust']))
                                    Inventory / Inventory Adjustment
                                @elseif(Route::currentRouteName() === 'special.sales-junk')
                                    Inventory / Junk Items
                                @elseif(Route::currentRouteName() === 'special.item-convert')
                                    Inventory / Convert Items
                                @elseif(in_array(Route::currentRouteName(), ['regular.purchase-note', 'special.purchase-note']))
                                    Purchasing / Purchasing Note
                                @elseif(in_array(Route::currentRouteName(), ['regular.purchase-order', 'special.purchase-order']))
                                    Purchasing / Purchase Order
                                @elseif(in_array(Route::currentRouteName(), ['regular.purchase-return', 'special.purchase-return']))
                                    Purchasing / Purchase Return
                                @elseif(Route::currentRouteName() === 'special.purchase-viber')
                                    Purchasing / Purchase Entry
                                @elseif(in_array(Route::currentRouteName(), ['regular.sales-note', 'special.sales-note']))
                                    Sales / Sales Note
                                @elseif(in_array(Route::currentRouteName(), ['regular.sales-order', 'special.sales-order']))
                                    Sales / Sales Order
                                @elseif(in_array(Route::currentRouteName(), ['regular.sales-return', 'special.sales-return']))
                                    Sales / Sales Return
                                @elseif(in_array(Route::currentRouteName(), ['regular.consignment-invoice', 'special.consignment-invoice']))
                                    Sales / Consignment Invoice
                                @elseif(in_array(Route::currentRouteName(), ['regular.waybill', 'special.waybill']))
                                    Sales / Waybill
                                @elseif(Route::currentRouteName() === 'special.profile')
                                    Profile / Admin Profile
                                @elseif(in_array(Route::currentRouteName(), ['regular.payments', 'special.payments']))
                                    Accounting / Payments
                                @elseif(in_array(Route::currentRouteName(), ['regular.payable-cheque-voucher', 'special.payable-cheque-voucher']))
                                    Accounting / Payable Cheque Voucher
                                @elseif(in_array(Route::currentRouteName(), ['regular.expense-cheque-voucher', 'special.expense-cheque-voucher']))
                                    Accounting / Expense Cheque Voucher
                                @elseif(in_array(Route::currentRouteName(), ['regular.sales-report', 'special.sales-report']))
                                    Statement Of Account
                                @elseif(in_array(Route::currentRouteName(), ['regular.inventory-reports', 'special.inventory-reports']))
                                    Reports / Inventory Reports
                                @elseif(Route::currentRouteName() === 'special.unserved-report')
                ...
                <div id="page-dashboard" class="page-view space-y-6 {{ in_array(Route::currentRouteName(), ['regular.dashboard', 'special.dashboard']) ? '' : 'hidden' }}">
                ...
                <div id="page-prod-master-container" class="page-view space-y-6 {{ in_array(Route::currentRouteName(), ['regular.prod-master', 'special.prod-master']) ? '' : 'hidden' }}">
                    @yield('prod_master_content')
                </div>

                <!-- PAGE: MASTER LIST -> ONLINE PRODUCT CONFIG -->
                <div id="page-prod-online-config-container" class="page-view space-y-6 {{ Route::currentRouteName() === 'special.prod-online-config' ? '' : 'hidden' }}">
                    @yield('prod_online_config_content')
                </div>

                <!-- PAGE: MASTER LIST -> SUPPLIER MASTER -->
                <div id="page-supplier-master-container" class="page-view space-y-6 {{ in_array(Route::currentRouteName(), ['regular.supplier-master', 'special.supplier-master']) ? '' : 'hidden' }}">
                    @yield('supplier_master_content')
                </div>

                <!-- PAGE: MASTER LIST -> CUSTOMER MASTER -->
                <div id="page-customer-master-container" class="page-view space-view space-y-6 {{ in_array(Route::currentRouteName(), ['regular.customer-master', 'special.customer-master']) ? '' : 'hidden' }}">
                    @yield('customer_master_content')
                </div>

                <!-- PAGE: PURCHASING -> PURCHASING NOTE -->
                <div id="page-purchase-note-container" class="page-view space-y-6 {{ in_array(Route::currentRouteName(), ['regular.purchase-note', 'special.purchase-note']) ? '' : 'hidden' }}">
                    @yield('purchase_note_content')
                </div>

                <!-- PAGE: PURCHASING -> PURCHASE ORDER -->
                <div id="page-purchase-order-container" class="page-view space-y-6 {{ in_array(Route::currentRouteName(), ['regular.purchase-order', 'special.purchase-order']) ? '' : 'hidden' }}">
                    @yield('purchase_order_content')
                </div>

                <!-- PAGE: PURCHASING -> PURCHASE RETURN -->
                <div id="page-purchase-return-container" class="page-view space-y-6 {{ in_array(Route::currentRouteName(), ['regular.purchase-return', 'special.purchase-return']) ? '' : 'hidden' }}">
                    @yield('purchase_return_content')
                </div>

                <!-- PAGE: PURCHASING -> PURCHASE VIBER LIST -->
                <div id="page-purchase-viber-container" class="page-view space-y-6 {{ in_array(Route::currentRouteName(), ['special.purchase-viber']) ? '' : 'hidden' }}">
                    @yield('purchase_viber_content')
                </div>

                <!-- PAGE: SALES -> SALES NOTE -->
                <div id="page-sales-note-container" class="page-view space-y-6 {{ in_array(Route::currentRouteName(), ['regular.sales-note', 'special.sales-note', 'admin.sales-note.online-prices', 'admin.sales-note.report-redirect']) ? '' : 'hidden' }}">
                    @yield('sales_note_content')
                </div>

                <!-- PAGE: SALES -> SALES ORDER -->
                <div id="page-sales-order-container" class="page-view space-y-6 {{ in_array(Route::currentRouteName(), ['regular.sales-order', 'special.sales-order']) ? '' : 'hidden' }}">
                    @yield('sales_order_content')
                </div>

                <!-- PAGE: SALES -> CONSIGNMENT INVOICE -->
                <div id="page-cons-invoice" class="page-view space-y-6 {{ in_array(Route::currentRouteName(), ['regular.consignment-invoice', 'special.consignment-invoice']) ? '' : 'hidden' }}">
                    @yield('cons_invoice_content')
                </div>

                <!-- PAGE: SALES -> WAYBILL -->
                <div id="page-waybill" class="page-view space-y-6 {{ in_array(Route::currentRouteName(), ['regular.waybill', 'special.waybill']) ? '' : 'hidden' }}">
                    @yield('waybill_content')
                </div>

                <!-- PAGE: MASTER LIST -> FORWARDER MASTER -->
                <div id="page-forwarder-master-container" class="page-view space-y-6 {{ in_array(Route::currentRouteName(), ['regular.forwarder-master', 'special.forwarder-master']) ? '' : 'hidden' }}">
                    @yield('forwarder_master_content')
                </div>

                <!-- PAGE: INVENTORY -> INVENTORY ADJUSTMENT -->
                <div id="page-inv-adjust-container" class="page-view space-y-6 {{ in_array(Route::currentRouteName(), ['regular.inv-adjust', 'special.inv-adjust']) ? '' : 'hidden' }}">
                    @yield('inventory_adjustment_content')
                </div>

                <!-- PAGE: INVENTORY -> JUNK ITEMS -->
                <div id="page-sales-junk-container" class="page-view space-y-6 {{ in_array(Route::currentRouteName(), ['special.sales-junk', 'warehouse.sales-junk']) ? '' : 'hidden' }}">
                    @yield('sales_junk_content')
                </div>

                <!-- PAGE: INVENTORY -> ITEM CONVERT -->
                <div id="page-item-convert-container" class="page-view space-y-6 {{ in_array(Route::currentRouteName(), ['special.item-convert', 'warehouse.item-convert']) ? '' : 'hidden' }}">
                    @yield('item_convert_content')
                </div>

                <!-- PAGE: SALES -> SALES RETURN -->
                <div id="page-sales-return-container" class="page-view space-y-6 {{ in_array(Route::currentRouteName(), ['regular.sales-return', 'special.sales-return']) ? '' : 'hidden' }}">
                    @yield('sales_return_content')
                </div>

                <!-- PAGE: ACCOUNTING -> PAYMENTS -->
                <div id="page-payments" class="page-view space-y-6 {{ in_array(Route::currentRouteName(), ['regular.payments', 'special.payments']) ? '' : 'hidden' }}">
                    @yield('payments_content')
                </div>

                <!-- PAGE: ADMIN PROFILE -->
                <div id="page-admin-profile" class="page-view space-y-6 {{ Route::currentRouteName() === 'special.profile' ? '' : 'hidden' }}">
                    @yield('admin_profile_content')
                </div>

                <!-- PAGE: ACCOUNTING -> PAYABLE CHEQUE VOUCHER -->
                <div id="page-payable-cheque-voucher-container" class="page-view space-y-6 {{ in_array(Route::currentRouteName(), ['regular.payable-cheque-voucher', 'special.payable-cheque-voucher']) ? '' : 'hidden' }}">
                    @yield('payable_cheque_voucher_content')
                </div>

                <!-- PAGE: ACCOUNTING -> EXPENSE CHEQUE VOUCHER -->
                <div id="page-exp-cheque" class="page-view space-y-6 {{ in_array(Route::currentRouteName(), ['regular.expense-cheque-voucher', 'special.expense-cheque-voucher']) ? '' : 'hidden' }}">
                    @yield('expense_cheque_voucher_content')
                </div>
                <!-- PAGE: REPORTS -> INVENTORY REPORTS -->
                <div id="page-rep-inv" class="page-view space-y-6 {{ in_array(Route::currentRouteName(), ['regular.inventory-reports', 'special.inventory-reports']) ? '' : 'hidden' }}">
                    @yield('inventory_reports_content')
                </div>
                <!-- PAGE: REPORTS -> SALES REPORTS -->
                <div id="page-rep-sales" class="page-view space-y-6 {{ in_array(Route::currentRouteName(), ['regular.sales-report', 'special.sales-report', 'special.top-products']) ? '' : 'hidden' }}">
                    @yield('sales_report_content')
                </div>
                <!-- PAGE: REPORTS -> UNSERVED DETAILS -->
                <div id="page-rep-unserved" class="page-view space-y-6 {{ Route::currentRouteName() === 'special.unserved-report' ? '' : 'hidden' }}">
                    @yield('unserved_report_content')
                </div>
                <!-- PAGE: REPORTS -> ACCOUNTS RECEIVABLE -->
                <div id="page-rep-ar" class="page-view space-y-6 {{ in_array(Route::currentRouteName(), ['regular.accounts-receivable', 'special.accounts-receivable']) ? '' : 'hidden' }}">
                    @yield('accounts_receivable_content')
                </div>
                <!-- PAGE: REPORTS -> COST REPORT -->
                <div id="page-rep-cost" class="page-view space-y-6 {{ in_array(Route::currentRouteName(), ['regular.cost-report', 'special.cost-report']) ? '' : 'hidden' }}">
        ...
        (function(){
            ...
            function sendMessage() {
                ...
                if (/^slow moving products$/i.test(text)) {
                    ...
                    setLoading(true);
                    var genUrl = '{{ route("special.ai.slow-moving-products.generate") }}';
                    fetch(genUrl, {
                        method: 'POST',
                        headers: {
