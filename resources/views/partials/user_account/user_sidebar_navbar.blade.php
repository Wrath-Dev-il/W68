...
<body class="bg-gray-50 text-gray-800 font-sans h-screen flex flex-col overflow-hidden" data-system-theme="{{ $activeSystemTheme }}">
    ...
    <div class="flex flex-1 h-screen overflow-hidden">
        ...
        <aside id="sidebar" class="sidebar-transition bg-maroon-900 border-r-4 border-goldlining-500 w-64 flex flex-col h-full text-white z-[250] shadow-2xl relative no-print">
            ...
            <div class="flex-1 min-h-0 overflow-y-auto px-3 pt-4 pb-28 space-y-1.5 scroll-pb-28" id="nav-container">
                ...
                <div>
                    <a href="{{ route('regular.dashboard') }}" class="nav-item flex items-center space-x-3 px-3 py-3 rounded-lg transition-all duration-150 group {{ Route::currentRouteName() === 'regular.dashboard' ? 'active bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'hover:bg-maroon-800 text-gray-100' }}" title="Dashboard">
                ...
                <div class="menu-dropdown">
                    <button onclick="toggleDropdown('dropdown-master', this)" class="w-full flex items-center justify-between px-3 py-3 rounded-lg hover:bg-maroon-800 text-gray-100 hover:text-white transition-all group" title="Master List">
                        ...
                        <i data-lucide="chevron-down" class="dropdown-chevron w-4 h-4 text-goldlining-500 rotate-transition sidebar-text {{ in_array(Route::currentRouteName(), ['regular.prod-master', 'regular.prod-online-config', 'regular.supplier-master', 'regular.customer-master', 'regular.forwarder-master']) ? 'rotate-180' : '' }}"></i>
                    </button>
                    <div id="dropdown-master" class="submenu-transition overflow-hidden bg-maroon-950 bg-opacity-40 rounded-md mt-1 pl-4 space-y-1" style="{{ in_array(Route::currentRouteName(), ['regular.prod-master', 'regular.prod-online-config', 'regular.supplier-master', 'regular.customer-master', 'regular.forwarder-master']) ? 'max-height: 500px;' : 'max-height: 0px;' }}">
                        <a href="{{ route('regular.prod-master') }}" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all {{ Route::currentRouteName() === 'regular.prod-master' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1' }}" data-page="prod-master">
                            <i data-lucide="package" class="w-3.5 h-3.5 {{ Route::currentRouteName() === 'regular.prod-master' ? 'text-maroon-950' : '' }}"></i>
                            <span>Product Master List</span>
                        </a>
                        <a href="{{ route('regular.prod-online-config') }}" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all {{ Route::currentRouteName() === 'regular.prod-online-config' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1' }}" data-page="prod-online-config">
                            <i data-lucide="refresh-cw" class="w-3.5 h-3.5 {{ Route::currentRouteName() === 'regular.prod-online-config' ? 'text-maroon-950' : 'text-cyan-400' }}"></i>
                            <span>Online Product Config</span>
                        </a>
                        <a href="{{ route('regular.supplier-master') }}" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all {{ Route::currentRouteName() === 'regular.supplier-master' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1' }}" data-page="supplier-master">
                            <i data-lucide="truck" class="w-3.5 h-3.5 {{ Route::currentRouteName() === 'regular.supplier-master' ? 'text-maroon-950' : 'text-blue-400' }}"></i>
                            <span>Supplier Master List</span>
                        </a>
                        <a href="{{ route('regular.customer-master') }}" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all {{ Route::currentRouteName() === 'regular.customer-master' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1' }}" data-page="customer-master">
                            <i data-lucide="users" class="w-3.5 h-3.5 {{ Route::currentRouteName() === 'regular.customer-master' ? 'text-maroon-950' : 'text-emerald-400' }}"></i>
                            <span>Customer Master List</span>
                        </a>
                        <a href="{{ route('regular.forwarder-master') }}" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all {{ Route::currentRouteName() === 'regular.forwarder-master' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1' }}" data-page="forwarder-master">
                            <i data-lucide="plane" class="w-3.5 h-3.5 {{ Route::currentRouteName() === 'regular.forwarder-master' ? 'text-maroon-950' : 'text-emerald-400' }}"></i>
                ...
                <div class="menu-dropdown">
                    <button onclick="toggleDropdown('dropdown-inventory', this)" class="w-full flex items-center justify-between px-3 py-3 rounded-lg hover:bg-maroon-800 text-gray-100 hover:text-white transition-all group" title="Inventory Management">
                        ...
                        <i data-lucide="chevron-down" class="dropdown-chevron w-4 h-4 text-goldlining-500 rotate-transition sidebar-text {{ in_array(Route::currentRouteName(), ['regular.inv-adjust', 'regular.sales-junk']) ? 'rotate-180' : '' }}"></i>
                    </button>
                    <div id="dropdown-inventory" class="submenu-transition overflow-hidden bg-maroon-950 bg-opacity-40 rounded-md mt-1 pl-4 space-y-1" style="{{ in_array(Route::currentRouteName(), ['regular.inv-adjust', 'regular.sales-junk']) ? 'max-height: 500px;' : 'max-height: 0px;' }}">
                        <a href="{{ route('regular.inv-adjust') }}" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all {{ Route::currentRouteName() === 'regular.inv-adjust' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1' }}" data-page="inv-adjust">
                            <i data-lucide="sliders-horizontal" class="w-3.5 h-3.5 {{ Route::currentRouteName() === 'regular.inv-adjust' ? 'text-maroon-950' : '' }}"></i>
                            <span>Inventory Adjustment</span>
                        </a>
                        <a href="{{ route('regular.sales-junk') }}" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all {{ Route::currentRouteName() === 'regular.sales-junk' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1' }}" data-page="sales-junk">
                            <i data-lucide="archive" class="w-3.5 h-3.5 {{ Route::currentRouteName() === 'regular.sales-junk' ? 'text-maroon-950' : '' }}"></i>
                ...
                <div class="menu-dropdown">
                    <button onclick="toggleDropdown('dropdown-purchasing', this)" class="w-full flex items-center justify-between px-3 py-3 rounded-lg hover:bg-maroon-800 text-gray-100 hover:text-white transition-all group" title="Purchasing">
                        ...
                        <i data-lucide="chevron-down" class="dropdown-chevron w-4 h-4 text-goldlining-500 rotate-transition sidebar-text {{ in_array(Route::currentRouteName(), ['regular.purchase-viber', 'regular.purchase-note', 'regular.purchase-order', 'regular.purchase-return']) ? 'rotate-180' : '' }}"></i>
                    </button>
                    <div id="dropdown-purchasing" class="submenu-transition overflow-hidden bg-maroon-950 bg-opacity-40 rounded-md mt-1 pl-4 space-y-1" style="{{ in_array(Route::currentRouteName(), ['regular.purchase-viber', 'regular.purchase-note', 'regular.purchase-order', 'regular.purchase-return']) ? 'max-height: 500px;' : 'max-height: 0px;' }}">
                        <a href="{{ route('regular.purchase-viber') }}" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all {{ Route::currentRouteName() === 'regular.purchase-viber' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1' }}" data-page="viber-list">
                            <i data-lucide="message-square" class="w-3.5 h-3.5 {{ Route::currentRouteName() === 'regular.purchase-viber' ? 'text-maroon-950' : '' }}"></i>
                            <span>Purchase Entry</span>
                        </a>
                        <a href="{{ route('regular.purchase-note') }}" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all {{ Route::currentRouteName() === 'regular.purchase-note' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1' }}" data-page="purch-note">
                            <i data-lucide="file-text" class="w-3.5 h-3.5 {{ Route::currentRouteName() === 'regular.purchase-note' ? 'text-maroon-950' : '' }}"></i>
                            <span>Purchasing Note</span>
                        </a>
                        <a href="{{ route('regular.purchase-order') }}" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all {{ Route::currentRouteName() === 'regular.purchase-order' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1' }}" data-page="purch-order">
                            <i data-lucide="shopping-bag" class="w-3.5 h-3.5 {{ Route::currentRouteName() === 'regular.purchase-order' ? 'text-maroon-950' : '' }}"></i>
                            <span>Purchase Order</span>
                        </a>
                        <a href="{{ route('regular.purchase-return') }}" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all {{ Route::currentRouteName() === 'regular.purchase-return' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1' }}" data-page="purch-return">
                            <i data-lucide="undo-2" class="w-3.5 h-3.5 {{ Route::currentRouteName() === 'regular.purchase-return' ? 'text-maroon-950' : '' }}"></i>
                ...
                <div class="menu-dropdown">
                    <button onclick="toggleDropdown('dropdown-sales', this)" class="w-full flex items-center justify-between px-3 py-3 rounded-lg hover:bg-maroon-800 text-gray-100 hover:text-white transition-all group" title="Sales">
                        ...
                        <i data-lucide="chevron-down" class="dropdown-chevron w-4 h-4 text-goldlining-500 rotate-transition sidebar-text {{ in_array(Route::currentRouteName(), ['regular.sales-note', 'regular.sales-order', 'regular.consignment-invoice', 'regular.sales-return', 'regular.waybill']) ? 'rotate-180' : '' }}"></i>
                    </button>
                    <div id="dropdown-sales" class="submenu-transition overflow-hidden bg-maroon-950 bg-opacity-40 rounded-md mt-1 pl-4 space-y-1" style="{{ in_array(Route::currentRouteName(), ['regular.sales-note', 'regular.sales-order', 'regular.consignment-invoice', 'regular.sales-return', 'regular.waybill']) ? 'max-height: 500px;' : 'max-height: 0px;' }}">
                        <a href="{{ route('regular.sales-note') }}" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all {{ Route::currentRouteName() === 'regular.sales-note' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1' }}" data-page="sales-note">
                            <i data-lucide="receipt" class="w-3.5 h-3.5 {{ Route::currentRouteName() === 'regular.sales-note' ? 'text-maroon-950' : '' }}"></i>
                            <span>Sales Note</span>
                        </a>
                        <a href="{{ route('regular.sales-order') }}" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all {{ Route::currentRouteName() === 'regular.sales-order' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1' }}" data-page="sales-order">
                            <i data-lucide="file-symlink" class="w-3.5 h-3.5 {{ Route::currentRouteName() === 'regular.sales-order' ? 'text-maroon-950' : '' }}"></i>
                            <span>Sales Order</span>
                        </a>
                        <a href="{{ route('regular.consignment-invoice') }}" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all {{ Route::currentRouteName() === 'regular.consignment-invoice' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1' }}" data-page="cons-invoice">
                            <i data-lucide="file-digit" class="w-3.5 h-3.5 {{ Route::currentRouteName() === 'regular.consignment-invoice' ? 'text-maroon-950' : '' }}"></i>
                            <span>Consignment Invoice</span>
                        </a>
                        <a href="{{ route('regular.sales-return') }}" class="flex items-center space-x-2 py-2 px-3 text-xs {{ Request::routeIs('regular.sales-return') ? 'text-goldlining-400 bg-maroon/20' : 'text-gray-300' }} hover:text-goldlining-400 hover:translate-x-1 transition-all rounded" data-page="sales-return">
                            <i data-lucide="corner-up-left" class="w-3.5 h-3.5"></i>
                            <span>Sales Return</span>
                        </a>

                        <a href="{{ route('regular.waybill') }}" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all {{ Route::currentRouteName() === 'regular.waybill' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1' }}" data-page="waybill">
                            <i data-lucide="map" class="w-3.5 h-3.5 {{ Route::currentRouteName() === 'regular.waybill' ? 'text-maroon-950' : '' }}"></i>
                            <span>Waybill</span>
                        </a>
                    </div>
                </div>
                ...
                <!-- ACCOUNTING (DROPDOWN) -->
                <div class="menu-dropdown">
                    <button onclick="toggleDropdown('dropdown-accounting', this)" class="w-full flex items-center justify-between px-3 py-3 rounded-lg hover:bg-maroon-800 {{ in_array(Route::currentRouteName(), ['regular.payments', 'regular.payable-cheque-voucher', 'regular.expense-cheque-voucher']) ? 'bg-maroon-800 text-white shadow-inner' : 'text-gray-100' }} hover:text-white transition-all group" title="Accounting">
                        <div class="flex items-center space-x-3">
                            <i data-lucide="calculator" class="w-5 h-5 text-goldlining-400 group-hover:scale-110 transition-transform flex-shrink-0"></i>
                            <span class="sidebar-text text-sm whitespace-nowrap {{ in_array(Route::currentRouteName(), ['regular.payments', 'regular.payable-cheque-voucher', 'regular.expense-cheque-voucher']) ? 'font-bold text-goldlining-400' : '' }}">Accounting</span>
                        </div>
                        <i data-lucide="chevron-down" class="dropdown-chevron w-4 h-4 text-goldlining-500 rotate-transition sidebar-text {{ in_array(Route::currentRouteName(), ['regular.payments', 'regular.payable-cheque-voucher', 'regular.expense-cheque-voucher']) ? 'rotate-180' : '' }}"></i>
                    </button>
                    <div id="dropdown-accounting" class="submenu-transition overflow-hidden bg-maroon-950 bg-opacity-40 rounded-md mt-1 pl-4 space-y-1" style="{{ in_array(Route::currentRouteName(), ['regular.payments', 'regular.payable-cheque-voucher', 'regular.expense-cheque-voucher']) ? 'max-height: 500px;' : 'max-height: 0px;' }}">
                        <a href="{{ route('regular.payments') }}" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all {{ Route::currentRouteName() === 'regular.payments' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1' }}" data-page="payments">
                            <i data-lucide="credit-card" class="w-3.5 h-3.5 {{ Route::currentRouteName() === 'regular.payments' ? 'text-maroon-950' : '' }}"></i>
                            <span>Payments</span>
                        </a>
                        <a href="{{ route('regular.payable-cheque-voucher') }}" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all {{ Route::currentRouteName() === 'regular.payable-cheque-voucher' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1' }}" data-page="pay-cheque">
                            <i data-lucide="book-check" class="w-3.5 h-3.5 {{ Route::currentRouteName() === 'regular.payable-cheque-voucher' ? 'text-maroon-950' : '' }}"></i>
                            <span>Payable Cheque Voucher</span>
                        </a>
                        <a href="{{ route('regular.expense-cheque-voucher') }}" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all {{ Route::currentRouteName() === 'regular.expense-cheque-voucher' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1' }}" data-page="exp-cheque">
                            <i data-lucide="receipt" class="w-3.5 h-3.5 {{ Route::currentRouteName() === 'regular.expense-cheque-voucher' ? 'text-maroon-950' : '' }}"></i>
                ...
                <div class="menu-dropdown">
                    ...
                    <div id="dropdown-reports" class="submenu-transition overflow-hidden bg-maroon-950 bg-opacity-40 rounded-md mt-1 pl-4 space-y-1" style="{{ in_array(Route::currentRouteName(), ['regular.sales-report', 'regular.inventory-reports', 'regular.unserved-report', 'regular.accounts-receivable', 'regular.cost-report', 'regular.top-products']) ? 'max-height: 500px;' : 'max-height: 0px;' }}">
                        ...
                        <a href="{{ route('regular.accounts-receivable') }}" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all {{ Route::currentRouteName() === 'regular.accounts-receivable' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1' }}" data-page="rep-ar">
                            <i data-lucide="arrow-down-left" class="w-3.5 h-3.5 {{ Route::currentRouteName() === 'regular.accounts-receivable' ? 'text-maroon-950' : '' }}"></i>
        ...
        <main class="flex-1 flex flex-col min-w-0 overflow-hidden">
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <div class="relative">
                        ...
                        <div id="profile-dropdown" class="hidden absolute right-0 mt-3 w-48 bg-maroon-900 border border-goldlining-500 rounded-xl shadow-xl z-50 overflow-hidden py-1 text-white">
                            <a href="{{ route('regular.profile') }}" class="flex items-center space-x-2.5 px-4 py-2.5 text-sm text-gray-100 hover:bg-maroon-800 hover:text-goldlining-400 transition-colors">
            ...
            <div id="workspace" class="flex-1 overflow-y-auto p-6 md:p-8 space-y-6">
                ...
                <div class="flex items-center justify-between">
                    <div>
                        <nav class="flex text-xs font-medium text-gray-500 space-x-2" aria-label="Breadcrumb">
                            ...
                            <span id="breadcrumb-current" class="text-maroon-700 font-semibold">
                                @if(Route::currentRouteName() === 'admin.usm')
                                    System Security / USM
                                @elseif(Route::currentRouteName() === 'regular.prod-master')
                                    Master List / Product Master
                                @elseif(Route::currentRouteName() === 'regular.prod-online-config')
                                    Master List / Online Product Config
                                @elseif(Route::currentRouteName() === 'regular.supplier-master')
                                    Master List / Supplier Master
                                @elseif(Route::currentRouteName() === 'regular.customer-master')
                                    Master List / Customer Master
                                @elseif(Route::currentRouteName() === 'regular.forwarder-master')
                                    Master List / Forwarder Master
                                @elseif(Route::currentRouteName() === 'regular.inv-adjust')
                                    Inventory / Inventory Adjustment
                                @elseif(Route::currentRouteName() === 'regular.sales-junk')
                                    Inventory / Junk Items
                                @elseif(Route::currentRouteName() === 'regular.purchase-viber')
                                    Purchasing / Purchase Entry
                                @elseif(Route::currentRouteName() === 'regular.purchase-note')
                                    Purchasing / Purchasing Note
                                @elseif(Route::currentRouteName() === 'regular.purchase-order')
                                    Purchasing / Purchase Order
                                @elseif(Route::currentRouteName() === 'regular.purchase-return')
                                    Purchasing / Purchase Return
                                @elseif(Route::currentRouteName() === 'regular.sales-note')
                                    Sales / Sales Note
                                @elseif(Route::currentRouteName() === 'regular.sales-order')
                                    Sales / Sales Order
                                @elseif(Route::currentRouteName() === 'regular.sales-return')
                                    Sales / Sales Return
                                @elseif(Route::currentRouteName() === 'regular.consignment-invoice')
                                    Sales / Consignment Invoice
                                @elseif(Route::currentRouteName() === 'regular.waybill')
                                    Sales / Waybill
                                @elseif(Route::currentRouteName() === 'admin.profile')
                                    Profile / Admin Profile
                                @elseif(Route::currentRouteName() === 'regular.payments')
                                    Accounting / Payments
                                @elseif(Route::currentRouteName() === 'regular.payable-cheque-voucher')
                                    Accounting / Payable Cheque Voucher
                                @elseif(Route::currentRouteName() === 'regular.expense-cheque-voucher')
                                    Accounting / Expense Cheque Voucher
                                @elseif(Route::currentRouteName() === 'regular.sales-report')
                                    Statement Of Account
                                @elseif(Route::currentRouteName() === 'regular.inventory-reports')
                        ...
                        <h1 id="workspace-title" class="text-2xl md:text-3xl font-extrabold text-gray-900 tracking-tight mt-1">
                            ...
                            @elseif(Route::currentRouteName() === 'regular.inventory-reports')
                                Inventory Reports
                            @elseif(Route::currentRouteName() === 'regular.unserved-report')
                                Unserved Details
                            @elseif(Route::currentRouteName() === 'regular.accounts-receivable')
                                Accounts Receivable
                            @elseif(Route::currentRouteName() === 'regular.cost-report')
                ...
                <div id="page-dashboard" class="page-view space-y-6 {{ Route::currentRouteName() === 'regular.dashboard' ? '' : 'hidden' }}">
                ...
                <div id="page-prod-master-container" class="page-view space-y-6 {{ Route::currentRouteName() === 'regular.prod-master' ? '' : 'hidden' }}">
                    @yield('prod_master_content')
                </div>

                <!-- PAGE: MASTER LIST -> ONLINE PRODUCT CONFIG -->
                <div id="page-prod-online-config-container" class="page-view space-y-6 {{ Route::currentRouteName() === 'regular.prod-online-config' ? '' : 'hidden' }}">
                    @yield('prod_online_config_content')
                </div>

                <!-- PAGE: MASTER LIST -> SUPPLIER MASTER -->
                <div id="page-supplier-master-container" class="page-view space-y-6 {{ Route::currentRouteName() === 'regular.supplier-master' ? '' : 'hidden' }}">
                    @yield('supplier_master_content')
                </div>

                <!-- PAGE: MASTER LIST -> CUSTOMER MASTER -->
                <div id="page-customer-master-container" class="page-view space-view space-y-6 {{ Route::currentRouteName() === 'regular.customer-master' ? '' : 'hidden' }}">
                    @yield('customer_master_content')
                </div>

                <!-- PAGE: PURCHASING -> PURCHASE ENTRY / VIBER LIST -->
                <div id="page-purchase-viber-container" class="page-view space-y-6 {{ Route::currentRouteName() === 'regular.purchase-viber' ? '' : 'hidden' }}">
                    @yield('purchase_viber_content')
                </div>

                <!-- PAGE: PURCHASING -> PURCHASING NOTE -->
                <div id="page-purchase-note-container" class="page-view space-y-6 {{ Route::currentRouteName() === 'regular.purchase-note' ? '' : 'hidden' }}">
                    @yield('purchase_note_content')
                </div>

                <!-- PAGE: PURCHASING -> PURCHASE ORDER -->
                <div id="page-purchase-order-container" class="page-view space-y-6 {{ Route::currentRouteName() === 'regular.purchase-order' ? '' : 'hidden' }}">
                    @yield('purchase_order_content')
                </div>

                <!-- PAGE: PURCHASING -> PURCHASE RETURN -->
                <div id="page-purchase-return-container" class="page-view space-y-6 {{ Route::currentRouteName() === 'regular.purchase-return' ? '' : 'hidden' }}">
                    @yield('purchase_return_content')
                </div>

                <!-- PAGE: SALES -> SALES NOTE -->
                <div id="page-sales-note-container" class="page-view space-y-6 {{ in_array(Route::currentRouteName(), ['regular.sales-note', 'admin.sales-note.online-prices', 'admin.sales-note.report-redirect']) ? '' : 'hidden' }}">
                    @yield('sales_note_content')
                </div>

                <!-- PAGE: SALES -> SALES ORDER -->
                <div id="page-sales-order-container" class="page-view space-y-6 {{ Route::currentRouteName() === 'regular.sales-order' ? '' : 'hidden' }}">
                    @yield('sales_order_content')
                </div>

                <!-- PAGE: SALES -> CONSIGNMENT INVOICE -->
                <div id="page-cons-invoice" class="page-view space-y-6 {{ Route::currentRouteName() === 'regular.consignment-invoice' ? '' : 'hidden' }}">
                    @yield('cons_invoice_content')
                </div>

                <!-- PAGE: SALES -> WAYBILL -->
                <div id="page-waybill" class="page-view space-y-6 {{ Route::currentRouteName() === 'regular.waybill' ? '' : 'hidden' }}">
                    @yield('waybill_content')
                </div>

                <!-- PAGE: MASTER LIST -> FORWARDER MASTER -->
                <div id="page-forwarder-master-container" class="page-view space-y-6 {{ Route::currentRouteName() === 'regular.forwarder-master' ? '' : 'hidden' }}">
                    @yield('forwarder_master_content')
                </div>

                <!-- PAGE: INVENTORY -> INVENTORY ADJUSTMENT -->
                <div id="page-inv-adjust-container" class="page-view space-y-6 {{ Route::currentRouteName() === 'regular.inv-adjust' ? '' : 'hidden' }}">
                    @yield('inventory_adjustment_content')
                </div>

                <!-- PAGE: INVENTORY -> JUNK ITEMS -->
                <div id="page-sales-junk-container" class="page-view space-y-6 {{ Route::currentRouteName() === 'regular.sales-junk' ? '' : 'hidden' }}">
                    @yield('sales_junk_content')
                </div>

                <!-- PAGE: SALES -> SALES RETURN -->
                <div id="page-sales-return-container" class="page-view space-y-6 {{ Route::currentRouteName() === 'regular.sales-return' ? '' : 'hidden' }}">
                    @yield('sales_return_content')
                </div>

                <!-- PAGE: ACCOUNTING -> PAYMENTS -->
                <div id="page-payments" class="page-view space-y-6 {{ Route::currentRouteName() === 'regular.payments' ? '' : 'hidden' }}">
                    @yield('payments_content')
                </div>

                <!-- PAGE: ADMIN PROFILE -->
                <div id="page-admin-profile" class="page-view space-y-6 {{ in_array(Route::currentRouteName(), ['admin.profile', 'regular.profile']) ? '' : 'hidden' }}">
                    @yield('admin_profile_content')
                </div>

                <!-- PAGE: ACCOUNTING -> PAYABLE CHEQUE VOUCHER -->
                <div id="page-payable-cheque-voucher-container" class="page-view space-y-6 {{ Route::currentRouteName() === 'regular.payable-cheque-voucher' ? '' : 'hidden' }}">
                    @yield('payable_cheque_voucher_content')
                </div>

                <!-- PAGE: ACCOUNTING -> EXPENSE CHEQUE VOUCHER -->
                <div id="page-exp-cheque" class="page-view space-y-6 {{ Route::currentRouteName() === 'regular.expense-cheque-voucher' ? '' : 'hidden' }}">
                    @yield('expense_cheque_voucher_content')
                </div>
                <!-- PAGE: REPORTS -> INVENTORY REPORTS -->
                <div id="page-rep-inv" class="page-view space-y-6 {{ Route::currentRouteName() === 'regular.inventory-reports' ? '' : 'hidden' }}">
                ...
                <div id="page-rep-unserved" class="page-view space-y-6 {{ Route::currentRouteName() === 'regular.unserved-report' ? '' : 'hidden' }}">
                ...
                <div id="page-rep-cost" class="page-view space-y-6 {{ Route::currentRouteName() === 'regular.cost-report' ? '' : 'hidden' }}">
        ...
        (function(){
            ...
            function sendMessage() {
                ...
                if (/^slow moving products$/i.test(text)) {
                    ...
                    setLoading(true);
                    var genUrl = '{{ route("regular.ai.slow-moving-products.generate") }}';
                    fetch(genUrl, {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
            ...
            function fetchUsage() {
                fetch('{{ route("regular.chat.usage") }}', {
    ...
    <script>
        window.userNavbarNotificationRoutes = {
            rush: @json(route('regular.sales-note.rush-notifications')),
            invoice: @json(route('regular.payments.overdue-notifications')),
            salesOrder: @json(route('regular.sales-order')),
            payments: @json(route('regular.payments')),
        };
