    ...
    <div class="flex flex-1 h-screen overflow-hidden">
        ...
        <aside id="sidebar" class="sidebar-transition bg-maroon-900 border-r-4 border-goldlining-500 w-64 flex flex-col h-full min-h-0 text-white z-40 shadow-2xl relative no-print">
            ...
            <div class="flex-1 min-h-0 overflow-y-auto px-3 pt-4 pb-28 space-y-1.5 scroll-pb-28" id="nav-container">
                ...
                <!-- REPORTS (DROPDOWN) -->
                <div class="menu-dropdown">
                    <button onclick="toggleDropdown('dropdown-reports', this)" class="w-full flex items-center justify-between px-3 py-3 rounded-lg hover:bg-maroon-800 {{ in_array(Route::currentRouteName(), ['admin.sales-report', 'admin.inventory-reports', 'admin.accounts-receivable', 'admin.cost-report', 'admin.top-products']) ? 'bg-maroon-800 text-white shadow-inner' : 'text-gray-100' }} hover:text-white transition-all group" title="Reports">
                        <div class="flex items-center space-x-3">
                            <i data-lucide="trending-up" class="w-5 h-5 text-goldlining-400 group-hover:scale-110 transition-transform flex-shrink-0"></i>
                            <span class="sidebar-text text-sm whitespace-nowrap {{ in_array(Route::currentRouteName(), ['admin.sales-report', 'admin.inventory-reports', 'admin.accounts-receivable', 'admin.cost-report', 'admin.top-products']) ? 'font-bold text-goldlining-400' : '' }}">Reports</span>
                        </div>
                        <i data-lucide="chevron-down" class="dropdown-chevron w-4 h-4 text-goldlining-500 rotate-transition sidebar-text {{ in_array(Route::currentRouteName(), ['admin.sales-report', 'admin.inventory-reports', 'admin.accounts-receivable', 'admin.cost-report', 'admin.top-products']) ? 'rotate-180' : '' }}"></i>
                    </button>
                    <div id="dropdown-reports" class="submenu-transition overflow-hidden bg-maroon-950 bg-opacity-40 rounded-md mt-1 pl-4 space-y-1" style="{{ in_array(Route::currentRouteName(), ['admin.sales-report', 'admin.inventory-reports', 'admin.accounts-receivable', 'admin.cost-report', 'admin.top-products']) ? 'max-height: 500px;' : 'max-height: 0px;' }}">
