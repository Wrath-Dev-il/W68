...
@endphp
<body class="bg-gray-50 text-gray-800 font-sans h-screen flex flex-col overflow-hidden" data-system-theme="{{ $activeSystemTheme }}">
    ...
    <div class="flex flex-1 h-screen overflow-hidden">
        ...
        <aside id="sidebar" class="sidebar-transition bg-maroon-900 border-r-4 border-goldlining-500 w-64 flex flex-col h-full min-h-0 text-white z-40 shadow-2xl relative no-print">
            ...
            <div class="flex-1 min-h-0 overflow-y-auto px-3 pt-4 pb-28 space-y-1.5 scroll-pb-28" id="nav-container">
                ...
                <div>
                    <a href="{{ route('admin.dashboard') }}" class="nav-item flex items-center space-x-3 px-3 py-3 rounded-lg transition-all duration-150 group {{ Route::currentRouteName() === 'admin.dashboard' ? 'active bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'hover:bg-maroon-800 text-gray-100' }}" title="Dashboard">
                ...
                <div class="menu-dropdown">
                    <button onclick="toggleDropdown('dropdown-sys-sec', this)" class="w-full flex items-center justify-between px-3 py-3 rounded-lg hover:bg-maroon-800 text-gray-100 hover:text-white transition-all group" title="System Security">
                        ...
                        <i data-lucide="chevron-down" class="dropdown-chevron w-4 h-4 text-goldlining-500 rotate-transition sidebar-text {{ in_array(Route::currentRouteName(), ['admin.usm', 'admin.archived', 'admin.datasync', 'admin.audit-trail']) ? 'rotate-180' : '' }}"></i>
                    </button>
                    <!-- Submenu Links -->
                    <div id="dropdown-sys-sec" class="submenu-transition overflow-hidden bg-maroon-950 bg-opacity-40 rounded-md mt-1 pl-4 space-y-1" style="{{ in_array(Route::currentRouteName(), ['admin.usm', 'admin.archived', 'admin.datasync', 'admin.audit-trail']) ? 'max-height: 500px;' : 'max-height: 0px;' }}">
                        <a href="{{ route('admin.usm') }}" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all {{ Route::currentRouteName() === 'admin.usm' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1' }}" data-page="usm">
                            <i data-lucide="key-round" class="w-3.5 h-3.5 {{ Route::currentRouteName() === 'admin.usm' ? 'text-maroon-950' : 'text-red-400' }}"></i>
                            <span>USM (Admin Access Only)</span>
                        </a>
                        <a href="{{ route('admin.archived') }}" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all {{ Route::currentRouteName() === 'admin.archived' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1' }}" data-page="archived">
                            <i data-lucide="archive" class="w-3.5 h-3.5 {{ Route::currentRouteName() === 'admin.archived' ? 'text-maroon-950' : '' }}"></i>
                            <span>Archived</span>
                        </a>
                        <a href="{{ route('admin.datasync') }}" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all {{ Route::currentRouteName() === 'admin.datasync' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1' }}" data-page="datasync">
                            <i data-lucide="refresh-cw" class="w-3.5 h-3.5 {{ Route::currentRouteName() === 'admin.datasync' ? 'text-maroon-950' : '' }}"></i>
                            <span>Data Sync</span>
                        </a>
                        <a href="{{ route('admin.audit-trail') }}" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all {{ Route::currentRouteName() === 'admin.audit-trail' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1' }}" data-page="audit">
                            <i data-lucide="file-spreadsheet" class="w-3.5 h-3.5 {{ Route::currentRouteName() === 'admin.audit-trail' ? 'text-maroon-950' : '' }}"></i>
                ...
                <div class="menu-dropdown">
                    <button onclick="toggleDropdown('dropdown-master', this)" class="w-full flex items-center justify-between px-3 py-3 rounded-lg hover:bg-maroon-800 text-gray-100 hover:text-white transition-all group" title="Master List">
                        ...
                        <i data-lucide="chevron-down" class="dropdown-chevron w-4 h-4 text-goldlining-500 rotate-transition sidebar-text {{ in_array(Route::currentRouteName(), ['admin.prod-master', 'admin.prod-online-config']) ? 'rotate-180' : '' }}"></i>
                    </button>
                    <div id="dropdown-master" class="submenu-transition overflow-hidden bg-maroon-950 bg-opacity-40 rounded-md mt-1 pl-4 space-y-1" style="{{ in_array(Route::currentRouteName(), ['admin.prod-master', 'admin.prod-online-config']) ? 'max-height: 500px;' : 'max-height: 0px;' }}">
                        <a href="{{ route('admin.prod-master') }}" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all {{ Route::currentRouteName() === 'admin.prod-master' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1' }}" data-page="prod-master">
                            <i data-lucide="package" class="w-3.5 h-3.5 {{ Route::currentRouteName() === 'admin.prod-master' ? 'text-maroon-950' : '' }}"></i>
                            <span>Product Master List</span>
                        </a>
                        <a href="{{ route('admin.prod-online-config') }}" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all {{ Route::currentRouteName() === 'admin.prod-online-config' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1' }}" data-page="prod-online-config">
                            <i data-lucide="refresh-cw" class="w-3.5 h-3.5 {{ Route::currentRouteName() === 'admin.prod-online-config' ? 'text-maroon-950' : 'text-cyan-400' }}"></i>
                            <span>Online Product Config</span>
                        </a>
                        <a href="{{ route('admin.supplier-master') }}" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all {{ Route::currentRouteName() === 'admin.supplier-master' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1' }}" data-page="supplier-master">
                            <i data-lucide="truck" class="w-3.5 h-3.5 {{ Route::currentRouteName() === 'admin.supplier-master' ? 'text-maroon-950' : 'text-blue-400' }}"></i>
                            <span>Supplier Master List</span>
                        </a>
                        <a href="{{ route('admin.customer-master') }}" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all {{ Route::currentRouteName() === 'admin.customer-master' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1' }}" data-page="customer-master">
                            <i data-lucide="users" class="w-3.5 h-3.5 {{ Route::currentRouteName() === 'admin.customer-master' ? 'text-maroon-950' : 'text-emerald-400' }}"></i>
                            <span>Customer Master List</span>
                        </a>
                        <a href="{{ route('admin.forwarder-master') }}" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all {{ Route::currentRouteName() === 'admin.forwarder-master' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1' }}" data-page="forwarder-master">
                            <i data-lucide="plane" class="w-3.5 h-3.5 {{ Route::currentRouteName() === 'admin.forwarder-master' ? 'text-maroon-950' : 'text-emerald-400' }}"></i>
                ...
                <div class="menu-dropdown">
                    <button onclick="toggleDropdown('dropdown-inventory', this)" class="w-full flex items-center justify-between px-3 py-3 rounded-lg hover:bg-maroon-800 text-gray-100 hover:text-white transition-all group" title="Inventory Management">
                        ...
                        <i data-lucide="chevron-down" class="dropdown-chevron w-4 h-4 text-goldlining-500 rotate-transition sidebar-text {{ in_array(Route::currentRouteName(), ['admin.inv-adjust', 'admin.sales-junk', 'admin.item-convert']) ? 'rotate-180' : '' }}"></i>
                    </button>
                    <div id="dropdown-inventory" class="submenu-transition overflow-hidden bg-maroon-950 bg-opacity-40 rounded-md mt-1 pl-4 space-y-1" style="{{ in_array(Route::currentRouteName(), ['admin.inv-adjust', 'admin.sales-junk', 'admin.item-convert']) ? 'max-height: 500px;' : 'max-height: 0px;' }}">
                        <a href="{{ route('admin.inv-adjust') }}" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all {{ Route::currentRouteName() === 'admin.inv-adjust' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1' }}" data-page="inv-adjust">
                            <i data-lucide="sliders-horizontal" class="w-3.5 h-3.5 {{ Route::currentRouteName() === 'admin.inv-adjust' ? 'text-maroon-950' : '' }}"></i>
                            <span>Inventory Adjustment</span>
                        </a>
                        <a href="{{ route('admin.sales-junk') }}" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all {{ Route::currentRouteName() === 'admin.sales-junk' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1' }}" data-page="sales-junk">
                            <i data-lucide="archive" class="w-3.5 h-3.5 {{ Route::currentRouteName() === 'admin.sales-junk' ? 'text-maroon-950' : '' }}"></i>
                            <span>Junk Items</span>
                        </a>
                         <a href="{{ route('admin.item-convert') }}" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all {{ Route::currentRouteName() === 'admin.item-convert' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1' }}" data-page="item-convert">
                            <i data-lucide="shuffle" class="w-3.5 h-3.5 {{ Route::currentRouteName() === 'admin.item-convert' ? 'text-maroon-950' : '' }}"></i>
                ...
                <div class="menu-dropdown">
                    <button onclick="toggleDropdown('dropdown-purchasing', this)" class="w-full flex items-center justify-between px-3 py-3 rounded-lg hover:bg-maroon-800 text-gray-100 hover:text-white transition-all group" title="Purchasing">
                        ...
                        <i data-lucide="chevron-down" class="dropdown-chevron w-4 h-4 text-goldlining-500 rotate-transition sidebar-text {{ in_array(Route::currentRouteName(), ['admin.purchase-viber', 'admin.purchase-note', 'admin.purchase-order', 'admin.purchase-return']) ? 'rotate-180' : '' }}"></i>
                    </button>
                    <div id="dropdown-purchasing" class="submenu-transition overflow-hidden bg-maroon-950 bg-opacity-40 rounded-md mt-1 pl-4 space-y-1" style="{{ in_array(Route::currentRouteName(), ['admin.purchase-viber', 'admin.purchase-note', 'admin.purchase-order', 'admin.purchase-return']) ? 'max-height: 500px;' : 'max-height: 0px;' }}">
                          <a href="{{ route('admin.purchase-viber') }}" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all {{ Route::currentRouteName() === 'admin.purchase-viber' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1' }}" data-page="viber-list">
                            <i data-lucide="file-text" class="w-3.5 h-3.5 {{ Route::currentRouteName() === 'admin.purchase-viber' ? 'text-maroon-950' : '' }}"></i>
                            <span>Purchase Entry</span>
                        </a>
                        <a href="{{ route('admin.purchase-note') }}" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all {{ Route::currentRouteName() === 'admin.purchase-note' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1' }}" data-page="purch-note">
                            <i data-lucide="file-text" class="w-3.5 h-3.5 {{ Route::currentRouteName() === 'admin.purchase-note' ? 'text-maroon-950' : '' }}"></i>
                            <span>Purchasing Note</span>
                        </a>
                        <a href="{{ route('admin.purchase-order') }}" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all {{ Route::currentRouteName() === 'admin.purchase-order' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1' }}" data-page="purch-order">
                            <i data-lucide="shopping-bag" class="w-3.5 h-3.5 {{ Route::currentRouteName() === 'admin.purchase-order' ? 'text-maroon-950' : '' }}"></i>
                            <span>Purchase Order</span>
                        </a>
                        <a href="{{ route('admin.purchase-return') }}" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all {{ Route::currentRouteName() === 'admin.purchase-return' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1' }}" data-page="purch-return">
                            <i data-lucide="undo-2" class="w-3.5 h-3.5 {{ Route::currentRouteName() === 'admin.purchase-return' ? 'text-maroon-950' : '' }}"></i>
                ...
                <div class="menu-dropdown">
                    <button onclick="toggleDropdown('dropdown-sales', this)" class="w-full flex items-center justify-between px-3 py-3 rounded-lg hover:bg-maroon-800 text-gray-100 hover:text-white transition-all group" title="Sales">
                        ...
                        <i data-lucide="chevron-down" class="dropdown-chevron w-4 h-4 text-goldlining-500 rotate-transition sidebar-text {{ in_array(Route::currentRouteName(), ['admin.sales-note', 'admin.sales-order', 'admin.consignment-invoice', 'admin.waybill']) ? 'rotate-180' : '' }}"></i>
                    </button>
                    <div id="dropdown-sales" class="submenu-transition overflow-hidden bg-maroon-950 bg-opacity-40 rounded-md mt-1 pl-4 space-y-1" style="{{ in_array(Route::currentRouteName(), ['admin.sales-note', 'admin.sales-order', 'admin.consignment-invoice', 'admin.waybill']) ? 'max-height: 500px;' : 'max-height: 0px;' }}">
                        <a href="{{ route('admin.sales-note') }}" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all {{ Route::currentRouteName() === 'admin.sales-note' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1' }}" data-page="sales-note">
                            <i data-lucide="receipt" class="w-3.5 h-3.5 {{ Route::currentRouteName() === 'admin.sales-note' ? 'text-maroon-950' : '' }}"></i>
                            <span>Sales Note</span>
                        </a>
                        <a href="{{ route('admin.sales-order') }}" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all {{ Route::currentRouteName() === 'admin.sales-order' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1' }}" data-page="sales-order">
                            <i data-lucide="file-symlink" class="w-3.5 h-3.5 {{ Route::currentRouteName() === 'admin.sales-order' ? 'text-maroon-950' : '' }}"></i>
                            <span>Sales Order</span>
                        </a>
                        <a href="{{ route('admin.consignment-invoice') }}" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all {{ Route::currentRouteName() === 'admin.consignment-invoice' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1' }}" data-page="cons-invoice">
                            <i data-lucide="file-digit" class="w-3.5 h-3.5 {{ Route::currentRouteName() === 'admin.consignment-invoice' ? 'text-maroon-950' : '' }}"></i>
                            <span>Consignment Invoice</span>
                        </a>
                        <a href="{{ route('admin.sales-return') }}" class="flex items-center space-x-2 py-2 px-3 text-xs {{ Request::routeIs('admin.sales-return') ? 'text-goldlining-400 bg-maroon/20' : 'text-gray-300' }} hover:text-goldlining-400 hover:translate-x-1 transition-all rounded" data-page="sales-return">
                            <i data-lucide="corner-up-left" class="w-3.5 h-3.5"></i>
                            <span>Sales Return</span>
                        </a>

                        <a href="{{ route('admin.waybill') }}" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all {{ Route::currentRouteName() === 'admin.waybill' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1' }}" data-page="waybill">
                            <i data-lucide="map" class="w-3.5 h-3.5 {{ Route::currentRouteName() === 'admin.waybill' ? 'text-maroon-950' : '' }}"></i>
                            <span>Waybill</span>
                        </a>
                    </div>
                </div>
                ...
                <!-- ACCOUNTING (DROPDOWN) -->
                <div class="menu-dropdown">
                    <button onclick="toggleDropdown('dropdown-accounting', this)" class="w-full flex items-center justify-between px-3 py-3 rounded-lg hover:bg-maroon-800 {{ in_array(Route::currentRouteName(), ['admin.payments', 'admin.payable-cheque-voucher', 'admin.expense-cheque-voucher']) ? 'bg-maroon-800 text-white shadow-inner' : 'text-gray-100' }} hover:text-white transition-all group" title="Accounting">
                        <div class="flex items-center space-x-3">
                            <i data-lucide="calculator" class="w-5 h-5 text-goldlining-400 group-hover:scale-110 transition-transform flex-shrink-0"></i>
                            <span class="sidebar-text text-sm whitespace-nowrap {{ in_array(Route::currentRouteName(), ['admin.payments', 'admin.payable-cheque-voucher', 'admin.expense-cheque-voucher']) ? 'font-bold text-goldlining-400' : '' }}">Accounting</span>
                        </div>
                        <i data-lucide="chevron-down" class="dropdown-chevron w-4 h-4 text-goldlining-500 rotate-transition sidebar-text {{ in_array(Route::currentRouteName(), ['admin.payments', 'admin.payable-cheque-voucher', 'admin.expense-cheque-voucher']) ? 'rotate-180' : '' }}"></i>
                    </button>
                    <div id="dropdown-accounting" class="submenu-transition overflow-hidden bg-maroon-950 bg-opacity-40 rounded-md mt-1 pl-4 space-y-1" style="{{ in_array(Route::currentRouteName(), ['admin.payments', 'admin.payable-cheque-voucher', 'admin.expense-cheque-voucher']) ? 'max-height: 500px;' : 'max-height: 0px;' }}">
                        <a href="{{ route('admin.payments') }}" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all {{ Route::currentRouteName() === 'admin.payments' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1' }}" data-page="payments">
                            <i data-lucide="credit-card" class="w-3.5 h-3.5 {{ Route::currentRouteName() === 'admin.payments' ? 'text-maroon-950' : '' }}"></i>
                            <span>Payments</span>
                        </a>
                        <a href="{{ route('admin.payable-cheque-voucher') }}" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all {{ Route::currentRouteName() === 'admin.payable-cheque-voucher' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1' }}" data-page="pay-cheque">
                            <i data-lucide="book-check" class="w-3.5 h-3.5 {{ Route::currentRouteName() === 'admin.payable-cheque-voucher' ? 'text-maroon-950' : '' }}"></i>
                            <span>Payable Cheque Voucher</span>
                        </a>
                        <a href="{{ route('admin.expense-cheque-voucher') }}" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all {{ Route::currentRouteName() === 'admin.expense-cheque-voucher' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1' }}" data-page="exp-cheque">
                            <i data-lucide="receipt" class="w-3.5 h-3.5 {{ Route::currentRouteName() === 'admin.expense-cheque-voucher' ? 'text-maroon-950' : '' }}"></i>
                ...
                <!-- REPORTS (DROPDOWN) -->
                <div class="menu-dropdown">
                    <button onclick="toggleDropdown('dropdown-reports', this)" class="w-full flex items-center justify-between px-3 py-3 rounded-lg hover:bg-maroon-800 {{ in_array(Route::currentRouteName(), ['admin.sales-report', 'admin.inventory-reports', 'admin.unserved-report', 'admin.accounts-receivable', 'admin.cost-report', 'admin.top-products']) ? 'bg-maroon-800 text-white shadow-inner' : 'text-gray-100' }} hover:text-white transition-all group" title="Reports">
                        <div class="flex items-center space-x-3">
                            <i data-lucide="trending-up" class="w-5 h-5 text-goldlining-400 group-hover:scale-110 transition-transform flex-shrink-0"></i>
                            <span class="sidebar-text text-sm whitespace-nowrap {{ in_array(Route::currentRouteName(), ['admin.sales-report', 'admin.inventory-reports', 'admin.unserved-report', 'admin.accounts-receivable', 'admin.cost-report', 'admin.top-products']) ? 'font-bold text-goldlining-400' : '' }}">Reports</span>
                        </div>
                        <i data-lucide="chevron-down" class="dropdown-chevron w-4 h-4 text-goldlining-500 rotate-transition sidebar-text {{ in_array(Route::currentRouteName(), ['admin.sales-report', 'admin.inventory-reports', 'admin.unserved-report', 'admin.accounts-receivable', 'admin.cost-report', 'admin.top-products']) ? 'rotate-180' : '' }}"></i>
                    </button>
                    <div id="dropdown-reports" class="submenu-transition overflow-hidden bg-maroon-950 bg-opacity-40 rounded-md mt-1 pl-4 space-y-1" style="{{ in_array(Route::currentRouteName(), ['admin.sales-report', 'admin.inventory-reports', 'admin.unserved-report', 'admin.accounts-receivable', 'admin.cost-report', 'admin.top-products']) ? 'max-height: 500px;' : 'max-height: 0px;' }}">
                        <a href="{{ route('admin.sales-report') }}" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all {{ Route::currentRouteName() === 'admin.sales-report' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1' }}" data-page="rep-sales">
                            <i data-lucide="bar-chart-3" class="w-3.5 h-3.5 {{ Route::currentRouteName() === 'admin.sales-report' ? 'text-maroon-950' : '' }}"></i>
                            <span>Account Receivable</span>
                        </a>
                        <a href="{{ route('admin.inventory-reports') }}" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all {{ Route::currentRouteName() === 'admin.inventory-reports' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1' }}" data-page="rep-inv">
                            <i data-lucide="package-search" class="w-3.5 h-3.5 {{ Route::currentRouteName() === 'admin.inventory-reports' ? 'text-maroon-950' : '' }}"></i>
                            <span>Inventory Reports</span>
                        </a>
                        <!-- W68_UNSERVED_ALL_USERS_PARTIAL_FIX_20260918 -->
                        <a href="{{ route('admin.unserved-report') }}" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all {{ Route::currentRouteName() === 'admin.unserved-report' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1' }}" data-page="rep-unserved">
                            <i data-lucide="arrow-down-left" class="w-3.5 h-3.5 {{ Route::currentRouteName() === 'admin.unserved-report' ? 'text-maroon-950' : '' }}"></i>
                            <span>Unserved Details</span>
                        </a>
                        
                        <a href="{{ route('admin.accounts-receivable') }}" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all {{ Route::currentRouteName() === 'admin.accounts-receivable' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1' }}" data-page="rep-ar">
                            <i data-lucide="arrow-down-left" class="w-3.5 h-3.5 {{ Route::currentRouteName() === 'admin.accounts-receivable' ? 'text-maroon-950' : '' }}"></i>
                            <span>Accounts Receivable Reports</span>
                        </a>
                        <a href="{{ route('admin.cost-report') }}" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all {{ Route::currentRouteName() === 'admin.cost-report' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1' }}" data-page="rep-cost">
                            <i data-lucide="receipt" class="w-3.5 h-3.5 {{ Route::currentRouteName() === 'admin.cost-report' ? 'text-maroon-950' : '' }}"></i>
                            <span>Cost Report</span>
                        </a>
                        <a href="{{ route('admin.top-products') }}" class="flex items-center space-x-2 py-2 px-3 text-xs rounded transition-all {{ Route::currentRouteName() === 'admin.top-products' ? 'bg-goldlining-500 text-maroon-950 font-semibold shadow' : 'text-gray-300 hover:text-goldlining-400 hover:translate-x-1' }}" data-page="rep-top-products">
                            <i data-lucide="trophy" class="w-3.5 h-3.5 {{ Route::currentRouteName() === 'admin.top-products' ? 'text-maroon-950' : '' }}"></i>
        ...
        <main class="flex-1 flex flex-col min-w-0 overflow-hidden">
            ...
            <header class="bg-white border-b border-gray-200 h-[70px] px-6 flex items-center justify-between flex-shrink-0 relative z-20 shadow-sm no-print">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div
                        ...
                        data-system-theme="{{ $activeSystemTheme }}"
                        class="hidden sm:flex items-center space-x-2.5 text-xs md:text-sm text-gray-600 bg-gray-50 border border-gray-200 px-4 py-2 rounded-lg font-medium shadow-sm relative overflow-hidden {{ $activeDateTimeThemeDesign ? 'pr-16' : '' }}"
                    >
                        @if($activeDateTimeThemeDesign)
                            <span class="theme-datetime-animation-wrap" aria-hidden="true">
                                <img
                                    src="{{ $systemThemeAssetSrc($activeDateTimeThemeDesign['asset']) }}"
                                    class="theme-datetime-animation {{ $activeDateTimeThemeDesign['class'] }}"
                                    alt="{{ $activeDateTimeThemeDesign['alt'] }}"
                                >
                            </span>
                        @endif
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <div class="relative">
                        <button id="notif-btn" class="p-2 rounded-full hover:bg-gray-100 text-gray-600 relative transition-all" title="View Notifications">
                            ...
                            @if($activeSystemThemeIcons['notification'])
                                <img src="{{ $systemThemeAssetSrc($activeSystemThemeIcons['notification']) }}" id="bell-icon" alt="{{ $activeSystemThemeIcons['chat_label'] }} notification" class="system-theme-navbar-icon">
                            @else
                    ...
                    <div class="relative">
                        ...
                        <div id="profile-dropdown" class="hidden absolute right-0 mt-3 w-48 bg-maroon-900 border border-goldlining-500 rounded-xl shadow-xl z-50 overflow-hidden py-1 text-white">
                            <a href="{{ route('admin.profile') }}" class="flex items-center space-x-2.5 px-4 py-2.5 text-sm text-gray-100 hover:bg-maroon-800 hover:text-goldlining-400 transition-colors">
            ...
            <div id="workspace" class="flex-1 overflow-y-auto p-6 md:p-8 space-y-6">
                    ...
                    <div>
                        <nav class="flex text-xs font-medium text-gray-500 space-x-2" aria-label="Breadcrumb">
                            ...
                            <span id="breadcrumb-current" class="text-maroon-700 font-semibold">
                                ...
                                @elseif(Route::currentRouteName() === 'admin.prod-online-config')
                                ...
                                @elseif(Route::currentRouteName() === 'admin.purchase-viber')
                                ...
                                @elseif(Route::currentRouteName() === 'admin.item-convert')
                                    Inventory / Convert Items
                                @elseif(Route::currentRouteName() === 'admin.cost-report')
                                    Reports / Cost Report
                                @elseif(Route::currentRouteName() === 'admin.top-products')
                ...
                <div id="page-prod-online-config-container" class="page-view space-y-6 {{ Route::currentRouteName() === 'admin.prod-online-config' ? '' : 'hidden' }}">
                    @yield('prod_online_config_content')
                </div>
                ...
                <div id="page-purchase-viber-container" class="page-view space-y-6 {{ Route::currentRouteName() === 'admin.purchase-viber' ? '' : 'hidden' }}">
                    @yield('purchase_viber_content')
                </div>
                ...
                <div id="page-inv-adjust-container" class="page-view space-y-6 {{ Route::currentRouteName() === 'admin.inv-adjust' ? '' : 'hidden' }}">
                    @yield('inventory_adjustment_content')
                </div>

                <!-- PAGE: INVENTORY -> JUNK ITEMS -->
                <div id="page-sales-junk-container" class="page-view space-y-6 {{ Route::currentRouteName() === 'admin.sales-junk' ? '' : 'hidden' }}">
                    @yield('sales_junk_content')
                </div>

                <!-- PAGE: INVENTORY -> ITEM CONVERT -->
                <div id="page-item-convert-container" class="page-view space-y-6 {{ Route::currentRouteName() === 'admin.item-convert' ? '' : 'hidden' }}">
                ...
                <!-- PAGE: ADMIN PROFILE -->
                <div id="page-admin-profile" class="page-view space-y-6 {{ Route::currentRouteName() === 'admin.profile' ? '' : 'hidden' }}">
                ...
                <div id="page-rep-cost" class="page-view space-y-6 {{ Route::currentRouteName() === 'admin.cost-report' ? '' : 'hidden' }}">
                    @yield('cost_report_content')
                </div>
    ...
    <div id="chat-float-btn" class="fixed bottom-6 right-6 w-14 h-14 bg-maroon-900 border-2 border-goldlining-500 rounded-full flex items-center justify-center cursor-grab shadow-2xl z-[200] select-none" style="touch-action:none;" title="{{ $activeSystemThemeIcons['chat_label'] }}">
        @if($activeSystemThemeIcons['chat_image'])
            <img src="{{ $systemThemeAssetSrc($activeSystemThemeIcons['chat_image']) }}" alt="{{ $activeSystemThemeIcons['chat_label'] }}" class="system-theme-chat-icon pointer-events-none">
        @else
            <i data-lucide="{{ $activeSystemThemeIcons['chat_lucide'] ?? 'message-circle' }}" class="w-7 h-7 text-goldlining-400 pointer-events-none"></i>
        @endif
    </div>
    ...
    <div id="chat-box" class="fixed hidden flex flex-col" style="width:360px;height:520px;z-index:200;border-radius:16px;background:#fff;border:1px solid #e5e7eb;box-shadow:0 20px 60px rgba(0,0,0,0.25);overflow:hidden;">
        <div class="bg-maroon-900 text-white px-4 py-3 flex items-center justify-between flex-shrink-0" id="chat-header" style="cursor:move;">
            <span class="font-bold text-sm flex items-center gap-2">
                @if($activeSystemThemeIcons['chat_image'])
                    <img src="{{ $systemThemeAssetSrc($activeSystemThemeIcons['chat_image']) }}" alt="{{ $activeSystemThemeIcons['chat_label'] }}" class="system-theme-chat-header-icon">
                @else
                    <i data-lucide="{{ $activeSystemThemeIcons['chat_lucide'] ?? 'message-circle' }}" class="w-4 h-4 text-goldlining-400"></i>
                @endif
                AI Chat
            </span>
            <div class="flex items-center gap-2">
        ...
        (function(){
            ...
            function sendMessage() {
                ...
                if (smpMatch) {
                    ...
                    var genUrl = '{{ route("admin.ai.slow-moving-products.generate") }}';
                    var estUrl = '{{ route("admin.ai.slow-moving-products.estimate") }}';
