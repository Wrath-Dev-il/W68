@if (request()->routeIs('admin.expense-cheque-voucher', 'regular.expense-cheque-voucher', 'special.expense-cheque-voucher'))
        ...
        @foreach ([
            ...
            <div class="bg-white border border-slate-200 rounded-xl p-5 shadow-sm">
                <div class="flex items-center justify-between gap-4">
                    <div><p class="text-[10px] font-black uppercase tracking-widest text-slate-400">{{ $card['label'] }}</p><p id="ecv-stat-{{ $card['id'] }}" class="mt-3 text-2xl font-black text-slate-900">0</p></div>
