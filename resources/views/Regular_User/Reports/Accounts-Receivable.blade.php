...
<div id="page-accounts-receivable" class="rep-page space-y-6" data-print-url="{{ route('regular.accounts-receivable.print-data') }}">
    ...
    <div class="bg-white border border-slate-200 rounded-xl p-6 shadow-sm no-print">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="space-y-2 relative">
                ...
                <div class="ar-searchable" data-endpoint="{{ route('regular.sales-report.customers') }}" data-type="object" data-input-id="ar-customer" data-default-label="Select All">
            ...
            <div class="space-y-2 relative">
                ...
                <div class="ar-searchable" data-endpoint="{{ route('regular.sales-report.agents') }}" data-type="text" data-input-id="ar-agent" data-default-label="Select All">
                    <div class="relative">
