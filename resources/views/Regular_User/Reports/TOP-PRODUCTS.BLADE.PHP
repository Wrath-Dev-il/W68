...
@php
$tpRoutes = [
    'customers' => route('regular.top-products.customers'),
    'brands' => route('regular.top-products.brands'),
    'descriptions' => route('regular.top-products.descriptions'),
    'agents' => route('regular.top-products.agents'),
    'data' => route('regular.top-products.data'),
];
@endphp
    ...
    <div class="bg-white border border-slate-200 rounded-xl p-6 shadow-sm no-print">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="space-y-2 relative">
                ...
                <div class="tp-searchable" data-endpoint="{{ $tpRoutes['customers'] }}" data-default="All" data-object="1">
            ...
            <div class="space-y-2 relative">
                ...
                <div class="tp-searchable" data-endpoint="{{ $tpRoutes['brands'] }}" data-default="All">
            ...
            <div class="space-y-2 relative">
                ...
                <div class="tp-searchable" data-endpoint="{{ $tpRoutes['descriptions'] }}" data-default="All">
            ...
            <div class="space-y-2 relative md:col-span-2">
                ...
                <div class="tp-searchable" data-endpoint="{{ $tpRoutes['agents'] }}" data-default="All">
