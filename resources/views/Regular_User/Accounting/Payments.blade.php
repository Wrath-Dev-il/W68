...
@push('scripts')
    <script>
        window.paymentsRoutes = {
            data: "{{ route('regular.payments.data') }}",
            customer: "{{ route('regular.payments.customer', ['customerId' => ':customerId']) }}",
            customerReturns: "{{ route('regular.payments.customer.returns', ['customerId' => ':customerId']) }}",
            returnLookup: "{{ route('regular.payments.return.lookup', ['returnId' => ':returnId']) }}",
            process: "{{ route('regular.payments.process') }}",
            historyData: "{{ route('regular.payments.history.data') }}",
            payors: "{{ route('regular.payments.history.payors') }}",
            payorHistory: "{{ route('regular.payments.history.payor', ['customerId' => ':customerId']) }}",
            historyItems: "{{ route('regular.payments.history.items', ['sourceType' => ':sourceType', 'sourceId' => ':sourceId']) }}",
            historyLedger: "{{ route('regular.payments.history.ledger', ['paymentId' => ':paymentId']) }}",
            historyDetail: "{{ route('regular.payments.history.detail', ['paymentId' => ':paymentId']) }}",
            historyUpdate: "{{ route('regular.payments.history.update', ['paymentId' => ':paymentId']) }}",
            historyDelete: "{{ route('regular.payments.history.delete', ['paymentId' => ':paymentId']) }}",
            historyPrint: "{{ route('regular.payments.history.print') }}",
            groupsData: "{{ route('regular.payments.groups.data') }}",
            groupsStore: "{{ route('regular.payments.groups.store') }}",
            groupDelete: "{{ route('regular.payments.groups.delete', ['groupId' => ':groupId']) }}",
            groupDetail: "{{ route('regular.payments.groups.detail', ['groupId' => ':groupId']) }}",
            groupPrint: "{{ route('regular.payments.groups.print', ['groupId' => ':groupId']) }}",
            groupProcess: "{{ route('regular.payments.groups.process', ['groupId' => ':groupId']) }}",
            groupsItems: "{{ route('regular.payments.groups.items', ['groupId' => ':groupId']) }}",

            groupItemUpdate: "{{ route('regular.payments.groups.item.update', ['groupId' => ':groupId', 'itemId' => ':itemId']) }}",
            groupItemDelete: "{{ route('regular.payments.groups.item.delete', ['groupId' => ':groupId', 'itemId' => ':itemId']) }}"
        };
    </script>
