...
@push('scripts')
    ...
    <script>
        window.pcvRoutes = {
            data: "{{ route('regular.payable-cheque-voucher.data') }}",
            supplier: "{{ url('/regular/accounting/payable-cheque-voucher/supplier') }}",
            process: "{{ route('regular.payable-cheque-voucher.process') }}",
            returns: "{{ url('/regular/accounting/payable-cheque-voucher/returns') }}",
            suddenReturns: "{{ url('/regular/accounting/payable-cheque-voucher/sudden-returns') }}",
            history: "{{ url('/regular/accounting/payable-cheque-voucher/history') }}",
            historyDetail: "{{ url('/regular/accounting/payable-cheque-voucher/history') }}",
            show: "{{ url('/regular/accounting/payable-cheque-voucher/show') }}",
            updateNew: "{{ url('/regular/accounting/payable-cheque-voucher/update-new') }}",
            draftSave: "{{ url('/regular/accounting/payable-cheque-voucher/draft/save') }}",
            draftGet: "{{ url('/regular/accounting/payable-cheque-voucher/draft/get') }}",
            draftClear: "{{ url('/regular/accounting/payable-cheque-voucher/draft/clear') }}",
            recommendations: "{{ url('/regular/accounting/payable-cheque-voucher/supplier') }}"
        };
        ...
        (() => {
            ...
            async function openPrintModal(supplierId) {
                ...
                try {
                    ...
                    const res = await fetch(`{{ url('/regular/accounting/payable-cheque-voucher/history/supplier') }}/${supplierId}/vouchers`);
                    const data = await res.json();
            ...
            window.pcvSubmitDeleteVoucher = async function() {
                ...
                try {
                    const res = await fetch(`{{ url('/regular/accounting/payable-cheque-voucher/delete') }}/${deleteVoucherId}`, {
                        method: 'DELETE',
                        headers: {
