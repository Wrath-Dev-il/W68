...
<script>
    window.purchaseRoutes = {
        process: '{{ route("regular.purchase-order.process") }}',
        updatePO: '{{ route("regular.purchase-order.update") }}',
        openNotesUrl: '{{ route("regular.purchase.open-notes") }}',
        dashboardDataUrl: '{{ route("regular.purchase-order.dashboard") }}',
        activeDataUrl: '{{ route("regular.purchase-order.active") }}',
        historyDataUrl: '{{ route("regular.purchase-order.history") }}',
        poItemsUrl: '{{ route("regular.purchase-order.po-items", ["poId" => ":poId"]) }}',
        poDetailUrl: '{{ route("regular.purchase-order.detail", ["poId" => ":poId"]) }}',
        forceCloseUrl: '{{ route("regular.purchase-order.force-close.submit", ["purchaseNoteId" => ":purchaseNoteId"]) }}',
    };
...
@push('scripts')
    <script>
        window.purchaseRoutes = {
            process: '{{ route("regular.purchase-order.process") }}',
            updatePO: '{{ route("regular.purchase-order.update") }}',
            itemsUrl: '{{ url("/regular/purchase/purchase-order/items") }}',
            openNotesUrl: '{{ route("regular.purchase.open-notes") }}',
            activeDataUrl: '{{ route("regular.purchase-order.active") }}',
            historyDataUrl: '{{ route("regular.purchase-order.history") }}',
            detailsByNumberUrl: '{{ url("/regular/purchase/purchase-note/details-by-number") }}',
            dashboardDataUrl: '{{ route("regular.purchase-order.dashboard") }}',
            poItemsUrl: '{{ route("regular.purchase-order.po-items", ["poId" => ":poId"]) }}',
            poDetailUrl: '{{ route("regular.purchase-order.detail", ["poId" => ":poId"]) }}',
            forceCloseUrl: '{{ route("regular.purchase-order.force-close.submit", ["purchaseNoteId" => ":purchaseNoteId"]) }}',
