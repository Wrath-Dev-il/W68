...
<div id="page-purchase-viber-root" class="space-y-6 animate-fade-in text-slate-800">
    ...
    <div id="supplier-tabs-wrapper" class="hidden flex items-center gap-1.5 flex-wrap">
        ...
        <button onclick="openSelectSupplier()" id="viber-add-supplier-btn" class="inline-flex items-center gap-1 px-2.5 py-1.5 text-xs font-bold text-maroon border border-dashed border-maroon/30 rounded-lg hover:bg-maroon/5 hover:border-maroon/60 transition-all flex-shrink-0">
    ...
    <div class="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3">
        <div class="flex items-center gap-2">
            <button onclick="openSelectSupplier()" id="viber-add-supplier-action-btn" class="inline-flex items-center gap-1.5 px-4 py-2 bg-maroon text-white text-xs font-bold rounded-xl hover:bg-maroon-800 transition-all shadow-sm">
                <i data-lucide="plus" class="w-4 h-4"></i>
                <span>Add Supplier</span>
            </button>
            <button onclick="openAddItems()" id="viber-add-items-btn" class="hidden">
                <i data-lucide="package-plus" class="w-4 h-4"></i>
                <span>Add Items</span>
            </button>
            <button type="button" onclick="openTransferItemModal()" id="viber-transfer-item-btn" class="inline-flex items-center gap-1.5 px-4 py-2 bg-slate-100 text-slate-400 border border-slate-200 text-xs font-bold rounded-xl cursor-not-allowed" disabled>
    ...
    <div id="viber-main-table-card" class="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
        ...
        <div id="viber-empty-no-supplier" class="flex flex-col items-center justify-center py-16">
            ...
            <p class="text-xs text-slate-400 mt-1">Click the button below to add a supplier.</p>
            <button onclick="openSelectSupplier()" class="mt-5 inline-flex items-center gap-1.5 px-5 py-2.5 bg-maroon text-white text-xs font-bold rounded-xl hover:bg-maroon-800 transition-all shadow-sm">
                <i data-lucide="plus" class="w-4 h-4"></i>
                <span>Add Supplier</span>
            </button>
        </div>
        ...
        <div id="viber-empty-no-items" class="hidden flex flex-col items-center justify-center py-16">
            ...
            <p class="text-xs text-slate-400 mt-1">Click "Add Items" to add items.</p>
        </div>
                    ...
                    <thead>
                        <tr class="border-b border-slate-100 bg-slate-50/80 text-slate-400 text-[10px] font-bold uppercase tracking-wider">
                            ...
                            <tr class="border-b border-slate-100 bg-white">
                                ...
                                <th class="py-3 px-4"><input type="text" oninput="filterViberColumn(this, 'unit')" placeholder="Filter..." class="w-full px-2 py-1 text-[10px] border border-slate-200 rounded-md focus:outline-none focus:ring-1 focus:ring-maroon/20"></th>
...
<div id="viber-to-shipped-area" class="hidden space-y-4">
    ...
    <div id="viber-to-shipped-items-area" class="hidden bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
        ...
        <div class="px-4 pb-3 pt-2 hidden flex items-center gap-3" id="viber-ready-btn-area">
            <div class="flex items-center gap-1.5">
                <label class="text-[10px] font-bold text-slate-500 uppercase tracking-wider">Currency:</label>
                <select id="viber-currency-select" onchange="onCurrencyChange(this)" class="px-2 py-1 text-xs font-semibold border border-slate-200 rounded-lg focus:outline-none focus:ring-1 focus:ring-maroon/20 bg-white text-slate-700">
                    <option value="PHP">₱ PHP</option>
                    <option value="TWD">NT$ TWD</option>
                    <option value="USD">$ USD</option>
                </select>
            </div>
            <button id="add-to-note-btn" onclick="addToNote()" disabled class="px-4 py-2 bg-maroon text-white text-xs font-bold rounded-xl opacity-50 cursor-not-allowed transition-all">Add to Note</button>
        </div>
        <div class="overflow-x-auto">
            <table class="w-full text-left border-collapse">
                <thead>
                    ...
                    <tr id="viber-ready-column-filters" class="border-b border-slate-100 bg-white">
                        <th class="py-2 px-4"><input type="text" oninput="filterToShippedColumn(this, 'item_code')" placeholder="Search..." class="viber-ready-col-filter w-full min-w-[90px] px-2 py-1.5 text-[10px] text-slate-600 bg-white border border-slate-300 rounded-md focus:outline-none focus:ring-2 focus:ring-maroon/15 focus:border-maroon/40"></th>
                        <th class="py-2 px-4"><input type="text" oninput="filterToShippedColumn(this, 'part_no')" placeholder="Search..." class="viber-ready-col-filter w-full min-w-[90px] px-2 py-1.5 text-[10px] text-slate-600 bg-white border border-slate-300 rounded-md focus:outline-none focus:ring-2 focus:ring-maroon/15 focus:border-maroon/40"></th>
                        <th class="py-2 px-4"><input type="text" oninput="filterToShippedColumn(this, 'description')" placeholder="Search..." class="viber-ready-col-filter w-full min-w-[100px] px-2 py-1.5 text-[10px] text-slate-600 bg-white border border-slate-300 rounded-md focus:outline-none focus:ring-2 focus:ring-maroon/15 focus:border-maroon/40"></th>
                        <th class="py-2 px-4"><input type="text" oninput="filterToShippedColumn(this, 'application')" placeholder="Search..." class="viber-ready-col-filter w-full min-w-[100px] px-2 py-1.5 text-[10px] text-slate-600 bg-white border border-slate-300 rounded-md focus:outline-none focus:ring-2 focus:ring-maroon/15 focus:border-maroon/40"></th>
                        <th class="py-2 px-4"><input type="text" oninput="filterToShippedColumn(this, 'last_cost')" placeholder="Search..." class="viber-ready-col-filter w-full min-w-[80px] px-2 py-1.5 text-[10px] text-right text-slate-600 bg-white border border-slate-300 rounded-md focus:outline-none focus:ring-2 focus:ring-maroon/15 focus:border-maroon/40"></th>
                        <th class="py-2 px-4"><input type="text" oninput="filterToShippedColumn(this, 'new_cost')" placeholder="Search..." class="viber-ready-col-filter w-full min-w-[80px] px-2 py-1.5 text-[10px] text-right text-slate-600 bg-white border border-slate-300 rounded-md focus:outline-none focus:ring-2 focus:ring-maroon/15 focus:border-maroon/40"></th>
                        <th class="py-2 px-4"><input type="text" oninput="filterToShippedColumn(this, 'order_qty')" placeholder="Search..." class="viber-ready-col-filter w-full min-w-[70px] px-2 py-1.5 text-[10px] text-center text-slate-600 bg-white border border-slate-300 rounded-md focus:outline-none focus:ring-2 focus:ring-maroon/15 focus:border-maroon/40"></th>
                        <th class="py-2 px-4"><input type="text" oninput="filterToShippedColumn(this, 'unit')" placeholder="Search..." class="viber-ready-col-filter w-full min-w-[70px] px-2 py-1.5 text-[10px] text-slate-600 bg-white border border-slate-300 rounded-md focus:outline-none focus:ring-2 focus:ring-maroon/15 focus:border-maroon/40"></th>
                        <th class="py-2 px-4"><input type="text" oninput="filterToShippedColumn(this, 'ordered_date')" placeholder="YYYY-MM-DD" class="viber-ready-col-filter w-full min-w-[100px] px-2 py-1.5 text-[10px] text-slate-600 bg-white border border-slate-300 rounded-md focus:outline-none focus:ring-2 focus:ring-maroon/15 focus:border-maroon/40"></th>
                    </tr>
                </thead>
                ...
                <table class="w-full text-left border-collapse">
                    <thead>
                        ...
                        <tr class="border-b border-slate-100 bg-white">
                            ...
                            <th class="py-3 px-4"><input type="text" oninput="filterArrivedColumn(this, 'oum_unit')" placeholder="Filter..." class="w-full px-2 py-1 text-[10px] border border-slate-200 rounded-md focus:outline-none focus:ring-1 focus:ring-emerald-500/20"></th>
...
<div id="add-items-modal" class="fixed inset-0 z-[600] hidden">
    <div class="viber-modal-overlay fixed inset-0" onclick="closeAddItems()"></div>
    <div id="add-items-modal-positioner" class="fixed inset-0 flex items-center justify-center p-4">
        <div class="relative bg-white rounded-2xl shadow-2xl w-full max-w-[1500px] max-h-[90vh] flex flex-col overflow-hidden">
            {{-- Header --}}
            <div class="flex items-center justify-between p-5 border-b border-slate-100 flex-shrink-0">
                <div>
    ...
    <div id="viber-not-arrived-card" class="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
        ...
        <div id="not-arrived-table-area" class="hidden">
            <div class="flex items-center justify-between px-4 py-3 border-b border-slate-100 bg-slate-50/40">
                ...
                <button id="rollback-not-arrived-btn" onclick="openRollbackModal()" class="px-4 py-1.5 text-xs font-bold rounded-lg bg-red-600 text-white hover:bg-red-700 transition-all shadow-sm hidden">
                    <i data-lucide="rotate-ccw" class="w-3.5 h-3.5 inline-block mr-1"></i> Rollback
                </button>
            </div>
            <div class="overflow-x-auto viber-scroll">
                <table class="w-full text-left border-collapse">
                    <thead>
                        ...
                        <tr class="border-b border-slate-100 bg-white">
                            ...
                            <th class="py-3 px-4"><input type="text" oninput="filterNotArrivedColumn(this, 'oum_unit')" placeholder="Filter..." class="w-full px-2 py-1 text-[10px] border border-slate-200 rounded-md focus:outline-none focus:ring-1 focus:ring-amber-500/20"></th>
...
{{-- TRANSFER PURCHASE ENTRY ITEM MODAL --}}
    ...
    <div class="fixed inset-0 flex items-center justify-center p-4">
        <div class="relative bg-white rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden">
            <div class="px-6 py-4 border-b border-slate-100 flex items-center justify-between bg-slate-50/70">
                ...
                <button type="button" onclick="closeTransferItemModal()" class="p-2 rounded-lg text-slate-400 hover:text-slate-700 hover:bg-slate-100 transition-all">
            ...
            <div class="p-6 space-y-5">
                ...
                <div>
                    ...
                    <p id="transfer-no-supplier-message" class="hidden mt-2 text-xs font-medium text-amber-600">Add another supplier to Purchase Entry first before transferring this item.</p>
                </div>
            </div>
...
@push('scripts')
    <script>
        ...
        window.viberRoutes = {
            suppliers: '{{ route("regular.purchase-viber.suppliers") }}',
            products: '{{ route("regular.purchase-viber.products") }}',
            list: '{{ route("regular.purchase-viber.list") }}',
            storeSupplier: '{{ route("regular.purchase-viber.store-supplier") }}',
            storeItems: '{{ route("regular.purchase-viber.store-items") }}',
            items: '{{ route("regular.purchase-viber.items", ["viberListId" => ":viberListId"]) }}',
            counts: '{{ route("regular.purchase-viber.counts") }}',
            invoicedItems: '{{ route("regular.purchase-viber.invoiced-items") }}',
            notArrivedItems: '{{ route("regular.purchase-viber.not-arrived-items") }}',
            updateItem: '{{ route("regular.purchase-viber.items.update", ["id" => ":id"]) }}',
            transferItem: '{{ route("regular.purchase-viber.items.transfer", ["id" => ":id"]) }}',
            prepareNote: '{{ route("regular.purchase-viber.prepare-note") }}',
            purchaseNote: '{{ route("regular.purchase-note") }}',
            shippedPrintItems: '{{ route("regular.purchase-viber.shipped-print-items", ["viberListId" => ":viberListId"]) }}',
            destroySupplier: '{{ route("regular.purchase-viber.destroy", ["id" => ":id"]) }}',
            destroyItem: '{{ route("regular.purchase-viber.items.destroy", ["id" => ":id"]) }}',
            notArrivedRollback: '{{ route("regular.purchase-viber.not-arrived-rollback") }}',
        };
    </script>
