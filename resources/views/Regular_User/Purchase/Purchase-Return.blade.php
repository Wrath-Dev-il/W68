...
@push('scripts')
    <script>
        window.returnRoutes = {
            invoicesUrl: '{{ route("regular.purchase-return.invoices") }}',
            poItemsUrl: '{{ route("regular.purchase-return.po-items", ["poId" => ":poId"]) }}',
            processUrl: '{{ route("regular.purchase-return.process") }}',
            updateUrl: '{{ route("regular.purchase-return.update", ["id" => ":id"]) }}',
            deleteUrl: '{{ route("regular.purchase-return.delete", ["id" => ":id"]) }}',
            historyUrl: '{{ route("regular.purchase-return.history") }}',
            dashboardUrl: '{{ route("regular.purchase-return.dashboard") }}',
            detailUrl: '{{ route("regular.purchase-return.detail", ["id" => ":id"]) }}'
        };
