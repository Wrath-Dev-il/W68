...
@push('scripts')
    <script>
        ...
        function loadCIDashboard() {
            fetch('{{ route("regular.consignment-invoice.dashboard") }}')
                .then(r => r.json())
                .then(res => {
        ...
        function loadCIActiveNotes() {
            ...
            fetch('{{ route("regular.consignment-invoice.active") }}')
                .then(r => r.json())
                .then(res => {
        ...
        function loadCIHistory() {
            ...
            fetch('{{ route("regular.consignment-invoice.history") }}')
                .then(r => r.json())
                .then(res => {
        ...
        function loadCINoteDetail(id) {
            ...
            fetch('{{ route("regular.consignment-invoice.note-detail", ["id" => "__ID__"]) }}'.replace('__ID__', id))
                .then(r => r.json())
                .then(res => {
        ...
        window.finalizeConsignmentInvoice = function() {
            ...
            fetch('{{ route("regular.consignment-invoice.proceed") }}', {
                method: 'POST',
        ...
        window.submitCIPrintReceipt = function() {
            ...
            fetch('{{ route("regular.consignment-invoice.receipt-print") }}', {
                method: 'POST',
                headers: {
        ...
        function loadCIOrderDetail(id) {
            ...
            fetch('{{ route("regular.consignment-invoice.detail", ["id" => "__ID__"]) }}'.replace('__ID__', id))
                .then(r => r.json())
                .then(res => {
                    if (!res.success) {
