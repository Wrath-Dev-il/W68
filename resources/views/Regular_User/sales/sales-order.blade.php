...
@push('scripts')
    <script>
        window.salesOrderRoutes = {
            activeUrl: '{{ route("regular.sales-order.active") }}',
            proceedUrl: '{{ route("regular.sales-order.proceed") }}',
            forceCloseNoteUrl: '{{ route("regular.sales-order.force-close-note", ["salesNoteId" => ":salesNoteId"]) }}',
            historyUrl: '{{ route("regular.sales-order.history") }}',
            dashboardUrl: '{{ route("regular.sales-order.dashboard") }}',
            detailUrl: '{{ route("regular.sales-order.detail", ["id" => ":id"]) }}',
            editDetailUrl: '{{ route("regular.sales-order.edit-detail", ["salesOrderId" => ":salesOrderId"]) }}',
            updateUrl: '{{ route("regular.sales-order.update", ["salesOrderId" => ":salesOrderId"]) }}',
            ledgerUrl: '{{ route("regular.sales-order.ledger", ["salesNumber" => ":salesNumber"]) }}',
            receiptPrintUrl: '{{ route("regular.sales-order.receipt-print") }}',
            ...
            counterPartProductsUrl: '{{ route("regular.sales-order.counter-part-products") }}',
            onlineGenerateUrl: '{{ route("regular.sales-order.online-generate") }}',
            onlinePrintUrl: '{{ route("regular.sales-order.online-print", ["id" => ":id"]) }}',
            onlineInvoicesUrl: '{{ route("regular.sales-order.online-invoices") }}',
            onlineInvoicesDataUrl: '{{ route("regular.sales-order.online-invoices-data") }}',
            onlineInvoiceEditUrl: '{{ route("regular.sales-order.online-edit", ["id" => ":id"]) }}',
            onlineInvoiceUpdateUrl: '{{ route("regular.sales-order.online-update", ["id" => ":id"]) }}',
            onlineInvoiceDeleteUrl: '{{ route("regular.sales-order.online-destroy", ["id" => ":id"]) }}',
            onlineInvoiceMinSearchLength: 3,
            allOrdersDataUrl: '{{ route("regular.sales-order.all-orders-data") }}',
            historyDataUrl: '{{ route("regular.sales-order.history-data") }}',
            historyDeleteUrl: '{{ route("regular.sales-order.history-destroy", ["id" => ":id"]) }}',
            allUrl: '{{ route("regular.sales-order.all") }}',
            productPriceUrl: '{{ route("regular.sales-order.product-price", ["id" => ":id"]) }}',
            priceCodesUrl: '{{ route("regular.sales-order.price-codes", ["productId" => ":productId"]) }}',
            stockCheckUrl: '{{ route("regular.sales-order.check-stock") }}',
            editStockCheckUrl: '{{ route("regular.sales-order.edit-check-stock") }}',
            noteInvoicesUrl: '{{ route("regular.sales-note.invoices", ["noteId" => ":noteId"]) }}',
            onlineVerifyLedgerUrl: '{{ route("regular.sales-order.online-report.verify-product-ledger", ["onlineReport" => ":reportId"]) }}',
        };
