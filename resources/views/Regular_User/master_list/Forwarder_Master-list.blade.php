...
@push('scripts')
    <script>
        window.forwarderRoutes = {
            data: '{{ route("regular.forwarder-master.data") }}',
            create: '{{ route("regular.forwarder-master.create") }}',
            update: '{{ route("regular.forwarder-master.update", ["id" => ":id"]) }}',
            delete: '{{ route("regular.forwarder-master.delete", ["id" => ":id"]) }}'
        };
    </script>
