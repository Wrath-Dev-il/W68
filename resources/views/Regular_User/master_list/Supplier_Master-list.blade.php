...
@push('scripts')
    <script>
        window.supplierRoutes = {
            fetchData: '{{ route("regular.supplier-master.data") }}',
            fetchLifecycle: '{{ route("regular.supplier-master.lifecycle") }}',
            create: '{{ route("regular.supplier-master.create") }}',
            update: '{{ route("regular.supplier-master.update", ["id" => ":id"]) }}',
            delete: '{{ route("regular.supplier-master.delete", ["id" => ":id"]) }}',
            fetchLedgerItems: '{{ route("regular.masterlist.supplier.ledger-items", ["supplierId" => ":id"]) }}',
            fetchUnregisteredPurchaseOrders: '{{ route("regular.masterlist.supplier.unregistered-purchase-orders", ["supplierId" => ":id"]) }}',
            fetchHistory: '{{ route("regular.supplier-master.history", ["id" => ":id"]) }}',
            fetchLedger: '{{ route("regular.supplier-master.ledger", ["id" => ":id"]) }}',
            purchaseOrderDetail: '{{ route("regular.purchase-order.detail", ["poId" => ":id"]) }}',
            purchaseOrderPage: '{{ route("regular.purchase-order") }}',
        };
    </script>
