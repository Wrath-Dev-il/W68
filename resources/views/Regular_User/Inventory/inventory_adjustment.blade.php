...
@push('styles')
    @vite(['resources/css/inventory_adjustment.css'])
@endpush

@section('inventory_adjustment_content')
<script>
    window.adjustmentRoutes = {
        fetch: '{{ route("regular.inv-adjust.data") }}',
        adjust: '{{ route("regular.inv-adjust.save") }}',
        adjusted: '{{ route("regular.inv-adjust.adjusted") }}',
        adjustedUpdate: '{{ route("regular.inv-adjust.adjusted.update", ["id" => ":id"]) }}',
        adjustedDelete: '{{ route("regular.inv-adjust.adjusted.delete", ["id" => ":id"]) }}',
        ledger: '{{ route("regular.prod-master.ledger", ["id" => ":id"]) }}'
    };
</script>
...
@push('scripts')
    <script src="{{ asset('js/inventory_adjustment.js') }}?v={{ filemtime(public_path('js/inventory_adjustment.js')) }}"></script>
@endpush
