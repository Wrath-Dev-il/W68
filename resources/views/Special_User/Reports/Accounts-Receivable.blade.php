...
@push('styles')
    <link rel="stylesheet" href="{{ asset('css/accounts-receivable.css') }}?v={{ time() }}">
@endpush

@section('accounts_receivable_content')
<div id="page-accounts-receivable" class="rep-page space-y-6" data-print-url="{{ route('special.accounts-receivable.print-data') }}">
    ...
    <div class="bg-white border border-slate-200 rounded-xl p-6 shadow-sm no-print">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="space-y-2 relative">
                ...
                <div class="ar-searchable" data-endpoint="{{ route('special.sales-report.customers') }}" data-type="object" data-input-id="ar-customer" data-default-label="Select All">
            ...
            <div class="space-y-2 relative">
                ...
                <div class="ar-searchable" data-endpoint="{{ route('special.sales-report.agents') }}" data-type="text" data-input-id="ar-agent" data-default-label="Select All">
                    <div class="relative">
...
@push('scripts')
    <script src="{{ asset('js/accounts-receivable.js') }}?v={{ time() }}"></script>
@endpush
