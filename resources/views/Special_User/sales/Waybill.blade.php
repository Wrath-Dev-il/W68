...
@push('scripts')
    <script>
        window.waybillRoutes = {
            stats: "{{ route('special.waybill.stats') }}",
            pending: "{{ route('special.waybill.pending') }}",
            soItems: "{{ route('special.waybill.so-items', ':id') }}",
            finalize: "{{ route('special.waybill.finalize') }}",
            forwarderSuggestions: "{{ route('special.waybill.forwarder-suggestions') }}",
            history: "{{ route('special.waybill.history') }}",
            historyDetails: "{{ route('special.waybill.history-details', ':id') }}",
            batchPrint: "{{ route('special.waybill.batch-print') }}",
            update: "{{ route('special.waybill.update', ':id') }}",
            editData: "{{ route('special.waybill.edit-data', ':id') }}"
        };
