...
@section('dashboard_content')
            ...
            <div class="relative pt-12 pb-8 px-8 text-center">
                ...
                <div class="relative inline-block mb-6">
                    <div class="w-32 h-32 rounded-full border-4 border-white shadow-xl overflow-hidden bg-slate-50 flex items-center justify-center mx-auto">
                        @if(!empty($welcome_profile_picture_url))
                            <img src="{{ $welcome_profile_picture_url }}" alt="{{ $welcome_full_name }}" class="w-full h-full object-cover">
                        @else
                            @if($welcome_gender === 'Male')
                                <svg class="w-20 h-20 text-slate-300" fill="currentColor" viewBox="0 0 24 24">
                                    <path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/>
                                </svg>
                            @elseif($welcome_gender === 'Female')
                                <svg class="w-20 h-20 text-slate-300" fill="currentColor" viewBox="0 0 24 24">
                                    <path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/>
                                </svg>
                            @else
                ...
                <!-- Welcome Text -->
                <div class="space-y-2">
                    <h2 class="text-xs font-bold text-maroon uppercase tracking-[0.2em]">Welcome Back, {{ $welcome_account_type_label }}</h2>
                    <h1 class="text-2xl font-extrabold text-slate-900 tracking-tight">{{ $welcome_full_name }}</h1>
    ...
    @php session(['welcome_shown' => true]); @endphp
    @endif
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 flex items-center justify-between transition-all duration-200 hover:shadow-md hover:border-slate-200">
            <div class="space-y-1">
                ...
                <h3 class="text-3xl font-extrabold text-slate-800 tracking-tight">{{ number_format($total_products ?? 0) }}</h3>
        ...
        <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 flex items-center justify-between transition-all duration-200 hover:shadow-md hover:border-slate-200">
            <div class="space-y-1">
                ...
                <h3 class="text-3xl font-extrabold text-slate-800 tracking-tight">{{ number_format($low_stock_count ?? 0) }}</h3>
                <div class="flex items-center gap-1.5 mt-2">
        ...
        <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 flex items-center justify-between transition-all duration-200 hover:shadow-md hover:border-slate-200">
            <div class="space-y-1">
                ...
                <h3 class="text-3xl font-extrabold text-slate-800 tracking-tight">{{ number_format($total_suppliers ?? 0) }}</h3>
                <div class="flex items-center gap-1.5 mt-2">
                    <span class="text-emerald-500 font-semibold text-sm flex items-center gap-0.5">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M5 10l7-7m0 0l7 7m-7-7v18"/></svg>
                        +5.3%
        ...
        <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 flex items-center justify-between transition-all duration-200 hover:shadow-md hover:border-slate-200">
            <div class="space-y-1">
                ...
                <h3 class="text-3xl font-extrabold text-slate-800 tracking-tight">{{ number_format($total_customers ?? 0) }}</h3>
                <div class="flex items-center gap-1.5 mt-2">
                    <span class="text-emerald-500 font-semibold text-sm flex items-center gap-0.5">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M5 10l7-7m0 0l7 7m-7-7v18"/></svg>
                        +18.7%
        ...
        <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 flex items-center justify-between transition-all duration-200 hover:shadow-md hover:border-slate-200">
            <div class="space-y-1">
                ...
                <h3 class="text-3xl font-extrabold text-slate-800 tracking-tight">{{ number_format($total_sales ?? 0) }}</h3>
                <div class="flex items-center gap-1.5 mt-2">
                    <span class="text-emerald-500 font-semibold text-sm flex items-center gap-0.5">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M5 10l7-7m0 0l7 7m-7-7v18"/></svg>
                        +8.1%
        ...
        <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 flex items-center justify-between transition-all duration-200 hover:shadow-md hover:border-slate-200">
            <div class="space-y-1">
                ...
                <h3 class="text-3xl font-extrabold text-slate-800 tracking-tight">{{ number_format($total_online_invoice ?? 0) }}</h3>
                <div class="flex items-center gap-1.5 mt-2">
                    <span class="text-emerald-500 font-semibold text-sm flex items-center gap-0.5">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M5 10l7-7m0 0l7 7m-7-7v18"/></svg>
                        +22.3%
        ...
        <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 flex items-center justify-between transition-all duration-200 hover:shadow-md hover:border-slate-200">
            <div class="space-y-1">
                ...
                <h3 class="text-3xl font-extrabold text-slate-800 tracking-tight">{{ number_format($total_sales_return ?? 0) }}</h3>
                <div class="flex items-center gap-1.5 mt-2">
                    <span class="text-red-500 font-semibold text-sm flex items-center gap-0.5">
                        <svg class="w-4 h-4 rotate-180" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M5 10l7-7m0 0l7 7m-7-7v18"/></svg>
                        -50.0%
        ...
        <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 flex items-center justify-between transition-all duration-200 hover:shadow-md hover:border-slate-200">
            <div class="space-y-1">
                ...
                <h3 class="text-3xl font-extrabold text-slate-800 tracking-tight">{{ number_format($total_waybill ?? 0) }}</h3>
                <div class="flex items-center gap-1.5 mt-2">
                    <span class="text-emerald-500 font-semibold text-sm flex items-center gap-0.5">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M5 10l7-7m0 0l7 7m-7-7v18"/></svg>
                        +14.2%
                ...
                <div class="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4 p-4 border-b border-slate-100 bg-slate-50/50 flex-shrink-0">
                    ...
                    <div class="flex bg-slate-200/60 p-1 rounded-xl">
                        <button id="tab1-btn" onclick="switchTab('tab1')" class="inline-flex items-center px-4 py-2 text-xs md:text-sm font-semibold rounded-lg transition-all duration-150 bg-white text-slate-900 shadow-sm gap-2">
                            ...
                            <span id="tab1-count" class="bg-maroon text-white text-[10px] font-bold px-2 py-0.5 rounded-full transition-all duration-150">{{ $newly_added_count ?? 0 }}</span>
                        </button>
                        <button id="tab2-btn" onclick="switchTab('tab2')" class="inline-flex items-center px-4 py-2 text-xs md:text-sm font-semibold rounded-lg transition-all duration-150 text-slate-600 hover:text-slate-900 gap-2">
                            ...
                            <span id="tab2-count" class="bg-slate-300 text-slate-700 text-[10px] font-bold px-2 py-0.5 rounded-full transition-all duration-150">{{ $low_stock_count ?? 0 }}</span>
                        </button>
                    </div>
...
@push('scripts')
    <script>
        let tab1Data = [];
        let tab2Data = [];
        const dashboardTableDataUrl = @json($dashboard_table_data_url ?? null);
        const PAGE_SIZE = 14;
...
<td class="py-2 px-6 font-mono font-bold text-slate-900 text-xs leading-tight">${item.code}</td>
                    ...
                    <td class="py-4 px-6 text-slate-600 font-medium max-w-[200px] truncate" title="${item.desc}">${item.desc}</td>
        ...
        function initDonutCharts() {
            ...
            if (productEl) {
                ...
                new Chart(productCtx, {
                    type: 'doughnut',
                    data: {
                        labels: @json($category_distribution_labels ?? []),
                        datasets: [{
                            data: @json($category_distribution_values ?? []),
                            backgroundColor: [
                                '#4A0A15', // Maroon
            ...
            if (financeEl) {
                ...
                new Chart(financeCtx, {
                    type: 'doughnut',
                    data: {
                        labels: @json($document_distribution_labels ?? []),
                        datasets: [{
                            data: @json($document_distribution_values ?? []),
                            backgroundColor: [
                                '#4A0A15', // Maroon
                                '#FFC72C', // Gold
                                '#475569'  // Charcoal
