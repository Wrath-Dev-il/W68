...
<script>
    window.adjustmentRoutes = {
        fetch: '{{ route("special.inv-adjust.data") }}',
        adjust: '{{ route("special.inv-adjust.save") }}',
        adjusted: '{{ route("special.inv-adjust.adjusted") }}',
        adjustedUpdate: '{{ route("special.inv-adjust.adjusted.update", ["id" => ":id"]) }}',
        adjustedDelete: '{{ route("special.inv-adjust.adjusted.delete", ["id" => ":id"]) }}',
        ledger: '{{ route("special.prod-master.ledger", ["id" => ":id"]) }}'
    };
</script>
