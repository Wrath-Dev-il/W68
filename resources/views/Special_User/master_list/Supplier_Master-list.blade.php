...
@push('scripts')
    <script>
        window.supplierRoutes = {
            fetchData: '{{ route("special.supplier-master.data") }}',
            fetchLifecycle: '{{ route("special.supplier-master.lifecycle") }}',
            create: '{{ route("special.supplier-master.create") }}',
            update: '{{ route("special.supplier-master.update", ["id" => ":id"]) }}',
            delete: '{{ route("special.supplier-master.delete", ["id" => ":id"]) }}',
            fetchLedgerItems: '{{ route("special.masterlist.supplier.ledger-items", ["supplierId" => ":id"]) }}',
            fetchUnregisteredPurchaseOrders: '{{ route("special.masterlist.supplier.unregistered-purchase-orders", ["supplierId" => ":id"]) }}',
            fetchHistory: '{{ route("special.supplier-master.history", ["id" => ":id"]) }}',
            fetchLedger: '{{ route("special.supplier-master.ledger", ["id" => ":id"]) }}',
            purchaseOrderDetail: '{{ route("special.purchase-order.detail", ["poId" => ":id"]) }}',
            purchaseOrderPage: '{{ route("special.purchase-order") }}',
        };
    </script>
