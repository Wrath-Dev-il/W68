...
@push('scripts')
    <script>
        window.customerRoutes = {
            data: '{{ route("special.customer-master.data") }}',
            create: '{{ route("special.customer-master.create") }}',
            update: '{{ route("special.customer-master.update", ["id" => ":id"]) }}',
            delete: '{{ route("special.customer-master.delete", ["id" => ":id"]) }}',
            purchaseHistory: '{{ route("special.customer-master.purchase-history", ["id" => ":id"]) }}',
            paymentHistory: '{{ route("special.customer-master.payment-history", ["id" => ":id"]) }}',
            paymentHistoryDetail: '{{ route("special.customer-master.payment-history-detail", ["id" => ":id", "salesOrderId" => ":salesOrderId"]) }}',
            notes: '{{ url("/special/master-list/customer-master/notes/:id") }}',
            portalStatus: '{{ route("special.customer-master.portal.status", ["id" => ":id"]) }}',
            portalGenerate: '{{ route("special.customer-master.portal.generate", ["id" => ":id"]) }}',
            portalValidity: '{{ route("special.customer-master.portal.validity", ["id" => ":id"]) }}',
            portalDelete: '{{ route("special.customer-master.portal.delete", ["id" => ":id"]) }}',
            brandDiscounts: '{{ route("special.customer-master.brand-discounts.index", ["id" => ":id"]) }}',
            ...
            soaAutoStatus: '{{ route("special.customer-master.soa-auto.status") }}',
            soaAutoSave: '{{ route("special.customer-master.soa-auto.save") }}',
        };
    </script>
