...
@push('scripts')
    <script>
        window.paymentsRoutes = {
            data: "{{ route('special.payments.data') }}",
            customer: "{{ route('special.payments.customer', ['customerId' => ':customerId']) }}",
            customerReturns: "{{ route('special.payments.customer.returns', ['customerId' => ':customerId']) }}",
            returnLookup: "{{ route('special.payments.return.lookup', ['returnId' => ':returnId']) }}",
            process: "{{ route('special.payments.process') }}",
            historyData: "{{ route('special.payments.history.data') }}",
            payors: "{{ route('special.payments.history.payors') }}",
            payorHistory: "{{ route('special.payments.history.payor', ['customerId' => ':customerId']) }}",
            historyItems: "{{ route('special.payments.history.items', ['sourceType' => ':sourceType', 'sourceId' => ':sourceId']) }}",
            historyLedger: "{{ route('special.payments.history.ledger', ['paymentId' => ':paymentId']) }}",
            historyDetail: "{{ route('special.payments.history.detail', ['paymentId' => ':paymentId']) }}",
            historyUpdate: "{{ route('special.payments.history.update', ['paymentId' => ':paymentId']) }}",
            historyDelete: "{{ route('special.payments.history.delete', ['paymentId' => ':paymentId']) }}",
            historyPrint: "{{ route('special.payments.history.print') }}",
            groupsData: "{{ route('special.payments.groups.data') }}",
            groupsStore: "{{ route('special.payments.groups.store') }}",
            groupDelete: "{{ route('special.payments.groups.delete', ['groupId' => ':groupId']) }}",
            groupDetail: "{{ route('special.payments.groups.detail', ['groupId' => ':groupId']) }}",
            groupPrint: "{{ route('special.payments.groups.print', ['groupId' => ':groupId']) }}",
            groupProcess: "{{ route('special.payments.groups.process', ['groupId' => ':groupId']) }}",
            groupsItems: "{{ route('special.payments.groups.items', ['groupId' => ':groupId']) }}",

            groupItemUpdate: "{{ route('special.payments.groups.item.update', ['groupId' => ':groupId', 'itemId' => ':itemId']) }}",
            groupItemDelete: "{{ route('special.payments.groups.item.delete', ['groupId' => ':groupId', 'itemId' => ':itemId']) }}"
        };
    </script>
