...
<script>
    window.purchaseRoutes = {
        process: '{{ route("special.purchase-order.process") }}',
        updatePO: '{{ route("special.purchase-order.update") }}',
        itemsUrl: '{{ url("/special/purchase/purchase-order/items") }}',
        openNotesUrl: '{{ route("special.purchase.open-notes") }}',
        dashboardDataUrl: '{{ route("special.purchase-order.dashboard") }}',
        activeDataUrl: '{{ route("special.purchase-order.active") }}',
        historyDataUrl: '{{ route("special.purchase-order.history") }}',
        poItemsUrl: '{{ route("special.purchase-order.po-items", ["poId" => ":poId"]) }}',
        detailsByNumberUrl: '{{ url("/special/purchase/purchase-note/details-by-number") }}',
        poDetailUrl: '{{ route("special.purchase-order.detail", ["poId" => ":poId"]) }}',
        resyncCostsUrl: '{{ route("special.purchase-order.resync-product-costs", ["poId" => ":poId"]) }}',
        forceCloseUrl: '{{ route("special.purchase-order.force-close.submit", ["purchaseNoteId" => ":purchaseNoteId"]) }}',
    };
