...
@push('styles')
    <link rel="stylesheet" href="{{ asset('css/Purchase-Return.css') }}?v={{ time() }}">
@endpush

@section('purchase_return_content')
...
@push('scripts')
    <script>
        window.returnRoutes = {
            invoicesUrl: '{{ route("special.purchase-return.invoices") }}',
            poItemsUrl: '{{ route("special.purchase-return.po-items", ["poId" => ":poId"]) }}',
            processUrl: '{{ route("special.purchase-return.process") }}',
            updateUrl: '{{ route("special.purchase-return.update", ["id" => ":id"]) }}',
            deleteUrl: '{{ route("special.purchase-return.delete", ["id" => ":id"]) }}',
            historyUrl: '{{ route("special.purchase-return.history") }}',
            dashboardUrl: '{{ route("special.purchase-return.dashboard") }}',
            detailUrl: '{{ route("special.purchase-return.detail", ["id" => ":id"]) }}'
        };
        window.csrfToken = '{{ csrf_token() }}';
    </script>
    <script src="{{ asset('js/Purchase-Return.js') }}?v={{ filemtime(public_path('js/Purchase-Return.js')) }}"></script>
    <script>
