...
@push('scripts')
    <script>
        ...
        window.salesRoutes = {
            customersUrl: '{{ route("special.sales-note.customers") }}',
            productsUrl: '{{ route("special.sales-note.products") }}',
            processUrl: '{{ route("special.sales-note.process") }}',
            stockCheckUrl: '{{ route("special.sales-note.check-stock") }}',
            dashboardUrl: '{{ route("special.sales-note.dashboard") }}',
            activeUrl: '{{ route("special.sales-note.active") }}',
            historyUrl: '{{ route("special.sales-note.history") }}',
            detailUrl: '{{ route("special.sales-note.detail", ["id" => ":id"]) }}',
            deleteUrl: '{{ route("special.sales-note.delete", ["id" => ":id"]) }}',
            updateUrl: '{{ route("special.sales-note.update", ["id" => ":id"]) }}',
            ...
            printUrl: '{{ route("special.sales-note.print") }}',
            salesOrderUrl: '{{ route("special.sales-order") }}',
            customerPartialsUrl: '{{ route("special.sales-note.customer.partials", ["customerId" => ":customerId"]) }}',
            remainingItemsUrl: '{{ route("special.sales-note.remaining-items", ["noteId" => ":noteId"]) }}'
        };
    ...
    <script>
        ...
        window.loadInvoicesForEdit = async function() {
            ...
            try {
                const url = `{{ url('/special/sales/sales-note') }}/${noteId}/invoices`;
        ...
        window.selectInvoiceForEdit = async function(invoiceId, invoiceNumber) {
            ...
            try {
                const url = `{{ url('/special/sales/sales-note/invoice') }}/${invoiceId}/items`;
                const res = await fetch(url);
                const result = await res.json();
        ...
        window.proceedEditRemainingItems = async function() {
            ...
            try {
                const url = `{{ url('/special/sales/sales-note') }}/${window.activeEditNoteId}/invoices`;
                const res = await fetch(url);
                const result = await res.json();
