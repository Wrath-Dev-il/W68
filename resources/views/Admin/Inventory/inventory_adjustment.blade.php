...
<script>
    window.adjustmentRoutes = {
        fetch: '{{ route("admin.inv-adjust.data") }}',
        adjust: '{{ route("admin.inv-adjust.save") }}',
        adjusted: '{{ route("admin.inv-adjust.adjusted") }}',
        adjustedUpdate: '{{ route("admin.inv-adjust.adjusted.update", ["id" => ":id"]) }}',
        adjustedDelete: '{{ route("admin.inv-adjust.adjusted.delete", ["id" => ":id"]) }}',
        ledger: '{{ route("admin.prod-master.ledger", ["id" => ":id"]) }}'
    };
</script>
