...
@push('scripts')
    <script>
        window.salesOrderRoutes = {
            activeUrl: '{{ route("admin.sales-order.active") }}',
            proceedUrl: '{{ route("admin.sales-order.proceed") }}',
            forceCloseNoteUrl: '{{ route("admin.sales-order.force-close-note", ["salesNoteId" => ":salesNoteId"]) }}',
            historyUrl: '{{ route("admin.sales-order.history") }}',
            dashboardUrl: '{{ route("admin.sales-order.dashboard") }}',
            detailUrl: '{{ route("admin.sales-order.detail", ["id" => ":id"]) }}',
            editDetailUrl: '{{ route("admin.sales-order.edit-detail", ["salesOrderId" => ":salesOrderId"]) }}',
            updateUrl: '{{ route("admin.sales-order.update", ["salesOrderId" => ":salesOrderId"]) }}',
            ledgerUrl: '{{ route("admin.sales-order.ledger", ["salesNumber" => ":salesNumber"]) }}',
            receiptPrintUrl: '{{ route("admin.sales-order.receipt-print") }}',
            ...
            counterPartProductsUrl: '{{ route("admin.sales-order.counter-part.products") }}',
            onlineGenerateUrl: '{{ route("admin.sales-order.online-generate") }}',
            onlinePrintUrl: '{{ route("admin.sales-order.online-print", ["id" => ":id"]) }}',
            onlineInvoicesUrl: '{{ route("admin.sales-order.online-invoices") }}',
            onlineInvoicesDataUrl: '{{ route("admin.sales-order.online-invoices-data") }}',
            onlineInvoiceEditUrl: '{{ route("admin.sales-order.online-edit", ["id" => ":id"]) }}',
            onlineInvoiceUpdateUrl: '{{ route("admin.sales-order.online-update", ["id" => ":id"]) }}',
            onlineInvoiceDeleteUrl: '{{ route("admin.sales-order.online-destroy", ["id" => ":id"]) }}',
            onlineInvoiceMinSearchLength: 3,
            allUrl: '{{ route("admin.sales-order.all") }}',
            allOrdersDataUrl: '{{ route("admin.sales-order.all-orders-data") }}',
            historyDataUrl: '{{ route("admin.sales-order.history-data") }}',
            productPriceUrl: '{{ route("admin.sales-order.product-price", ["id" => ":id"]) }}',
            priceCodesUrl: '{{ route("admin.sales-order.price-codes", ["productId" => ":productId"]) }}',
            stockCheckUrl: '{{ route("admin.sales-order.check-stock") }}',
            editStockCheckUrl: '{{ route("admin.sales-order.edit-check-stock") }}',
            noteInvoicesUrl: '{{ route("admin.sales-note.invoices", ["noteId" => ":noteId"]) }}',
            onlineVerifyLedgerUrl: '{{ route("admin.sales-order.online-verify-product-ledger", ["reportId" => ":reportId"]) }}',
            historyDeleteUrl: '{{ route("admin.sales-order.history-destroy", ["id" => ":id"]) }}'
        };
