...
@push('scripts')
    <script>
        window.salesReturnRoutes = {
            invoices: "{{ route('admin.sales-return.invoices') }}",
            items: "{{ route('admin.sales-return.items', ':id') }}",
            history: "{{ route('admin.sales-return.history') }}",
            historyDetail: "{{ route('admin.sales-return.history-detail', ':id') }}",
            finalize: "{{ route('admin.sales-return.finalize') }}",
            dashboard: "{{ route('admin.sales-return.dashboard') }}",
            editData: "{{ route('admin.sales-return.edit-data', ':id') }}",
            update: "{{ route('admin.sales-return.update', ':id') }}",
            delete: "{{ route('admin.sales-return.delete', ':id') }}",
        };
