...
@push('scripts')
    <script>
        window.waybillRoutes = {
            stats: "{{ route('admin.waybill.stats') }}",
            pending: "{{ route('admin.waybill.pending') }}",
            soItems: "{{ route('admin.waybill.so-items', ':id') }}",
            finalize: "{{ route('admin.waybill.finalize') }}",
            forwarderSuggestions: "{{ route('admin.waybill.forwarder-suggestions') }}",
            history: "{{ route('admin.waybill.history') }}",
            historyDetails: "{{ route('admin.waybill.history-details', ':id') }}",
            batchPrint: "{{ route('admin.waybill.batch-print') }}",
            update: "{{ route('admin.waybill.update', ':id') }}",
            editData: "{{ route('admin.waybill.edit-data', ':id') }}",
            destroy: "{{ url('admin/sales/waybill') }}/" + ':id'
        };
