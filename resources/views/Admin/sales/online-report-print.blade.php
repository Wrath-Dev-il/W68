...
<table class="info-table">
    <tr>
        <td style="width:50%;" class="label">INVOICE NO.: <span style="color:red">{{ $note['invoice_no'] ?: '________________________' }}</span> @if(!empty($note['is_rush']))<span style="background:#800000;color:#fff;padding:2px 8px;font-size:11px;margin-left:6px;border-radius:3px;">RUSH</span>@endif</td>
        <td style="width:50%;text-align:right;" class="label">DATE: {{ $reportDate }} | SN NO.: {{ $note['sales_number'] }}</td>
    </tr>
    <tr>
