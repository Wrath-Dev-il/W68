...
@section('payments_content')
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
        ...
        <div class="bg-white p-5 rounded-2xl shadow-sm border border-slate-100 flex items-center justify-between group hover:border-slate-200 transition-all hover:shadow-md hover:scale-[1.02] duration-300 overflow-hidden">
            <div class="space-y-0.5 min-w-0">
                <span class="text-[10px] font-bold text-slate-400 uppercase tracking-wider block mb-1">{{ $stat[0] }} DAYS</span>
                <h3 id="stat-{{ $stat[0] }}-days" class="text-2xl font-extrabold text-slate-800 tracking-tight truncate">{{ $stat[1] }}</h3>
                <div class="flex items-center gap-1.5 mt-1">
                    <span class="{{ $stat[3] }} font-bold text-[10px] flex items-center gap-0.5 whitespace-nowrap">
                        @if($stat[5] === 'up')
            ...
            <div class="w-12 h-12 rounded-xl bg-maroon flex items-center justify-center shadow-inner group-hover:scale-105 transition-transform duration-300 flex-shrink-0 ml-3">
                <i data-lucide="{{ $stat[2] }}" class="w-6 h-6 text-gold"></i>
            </div>
        </div>
        @endforeach
    </div>
    ...
    <div class="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
        <div class="p-5 border-b border-slate-50 bg-slate-50/30">
            <div class="flex items-center space-x-4">
                <button id="payments-tab-active" type="button" onclick="window.showPaymentsTab('active')" class="payments-tab-button active">
                    <i data-lucide="wallet-cards" class="w-4 h-4"></i>
                    <span>Active Accounts</span>
                </button>
                <button id="payments-tab-history" type="button" onclick="window.showPaymentsTab('history')" class="payments-tab-button">
                    <i data-lucide="history" class="w-4 h-4"></i>
                    <span>History</span>
                </button>
                <button id="payments-tab-groups" type="button" onclick="window.showPaymentsTab('groups')" class="payments-tab-button">
                    <i data-lucide="folder-open" class="w-4 h-4"></i>
                    <span>Grouped Invoices</span>
                </button>
            </div>
        </div>
        <div id="payments-active-view" class="space-y-0">
                ...
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody id="payments-tbody" class="divide-y divide-slate-100 text-xs text-slate-600 font-medium">
                        ...
                        <tr class="hover:bg-slate-50/50 transition-colors group">
                            <td class="py-5 px-6 text-slate-700 font-bold">John Doe Enterprise</td>
                            <td class="py-5 px-6">
                                <div class="flex items-center justify-center space-x-3">
                                    <span class="text-slate-500 font-black text-lg">10</span>
                                    <div class="status-tag-container">
                                        <span class="tag-count bg-blue-tag">+2</span>
                                        <span class="tag-date">(2026/06/01)</span>
                                    </div>
                                </div>
                            </td>
                            <td class="py-5 px-6">
                                <div class="flex items-center justify-center space-x-3">
                                    <span class="text-amber-600 font-black text-lg">8</span>
                                    <div class="status-tag-container">
                                        <span class="tag-count bg-amber-tag">+1</span>
                                        <span class="tag-date">(2026/05/20)</span>
                                    </div>
                                </div>
                            </td>
                            <td class="py-5 px-6">
                                <div class="flex items-center justify-center space-x-3">
                                    <span class="text-emerald-600 font-black text-lg">5</span>
                                    <div class="status-tag-container">
                                        <span class="tag-count bg-emerald-tag">+1</span>
                                        <span class="tag-date">(2026/07/20)</span>
                                    </div>
                                </div>
                            </td>
                            <td class="py-5 px-6 text-center"><span class="px-3 py-1 bg-slate-100 rounded-full text-[10px]">15 Days</span></td>
                            <td class="py-5 px-6 text-center">
                                <button onclick="window.openProceedModal('John Doe Enterprise')" class="px-4 py-2 bg-maroon text-white text-[10px] font-bold rounded-xl hover:bg-maroon-800 transition-all shadow-md shadow-maroon/10">PROCEED</button>
                            </td>
                        </tr>
                        <tr class="hover:bg-slate-50/50 transition-colors group">
                            <td class="py-5 px-6 text-slate-700 font-bold">Smith & Co. Logistics</td>
                            <td class="py-5 px-6">
                                <div class="flex items-center justify-center space-x-3">
                                    <span class="text-slate-500 font-black text-lg">12</span>
                                    <div class="status-tag-container">
                                        <span class="tag-count bg-blue-tag">+3</span>
                                        <span class="tag-date">(2026/05/15)</span>
                                    </div>
                                </div>
                            </td>
                            <td class="py-5 px-6">
                                <div class="flex items-center justify-center space-x-3">
                                    <span class="text-amber-600 font-black text-lg">4</span>
                                    <div class="status-tag-container">
                                        <span class="tag-count bg-amber-tag">+2</span>
                                        <span class="tag-date">(2026/04/10)</span>
                                    </div>
                                </div>
                            </td>
                            <td class="py-5 px-6">
                                <div class="flex items-center justify-center space-x-3">
                                    <span class="text-emerald-600 font-black text-lg">15</span>
                                    <div class="status-tag-container">
                                        <span class="tag-count bg-emerald-tag">+2</span>
                                        <span class="tag-date">(2026/06/15)</span>
                                    </div>
                                </div>
                            </td>
                            <td class="py-5 px-6 text-center"><span class="px-3 py-1 bg-slate-100 rounded-full text-[10px]">22 Days</span></td>
                            <td class="py-5 px-6 text-center">
                                <button onclick="window.openProceedModal('Smith & Co. Logistics')" class="px-4 py-2 bg-maroon text-white text-[10px] font-bold rounded-xl hover:bg-maroon-800 transition-all shadow-md shadow-maroon/10">PROCEED</button>
                            </td>
                        </tr>
                        <tr class="hover:bg-slate-50/50 transition-colors group">
                            <td class="py-5 px-6 text-slate-700 font-bold">Global Tech Solutions</td>
                            <td class="py-5 px-6">
                                <div class="flex items-center justify-center space-x-3">
                                    <span class="text-slate-500 font-black text-lg">7</span>
                                    <div class="status-tag-container">
                                        <span class="tag-count bg-blue-tag">+1</span>
                                        <span class="tag-date">(2026/05/01)</span>
                                    </div>
                                </div>
                            </td>
                            <td class="py-5 px-6">
                                <div class="flex items-center justify-center space-x-3">
                                    <span class="text-amber-600 font-black text-lg">2</span>
                                    <div class="status-tag-container">
                                        <span class="tag-count bg-amber-tag">+1</span>
                                        <span class="tag-date">(2026/04/05)</span>
                                    </div>
                                </div>
                            </td>
                            <td class="py-5 px-6">
                                <div class="flex items-center justify-center space-x-3">
                                    <span class="text-emerald-600 font-black text-lg">10</span>
                                    <div class="status-tag-container">
                                        <span class="tag-count bg-emerald-tag">+1</span>
                                        <span class="tag-date">(2026/05/10)</span>
                                    </div>
                                </div>
                            </td>
                            <td class="py-5 px-6 text-center"><span class="px-3 py-1 bg-slate-100 rounded-full text-[10px]">10 Days</span></td>
                            <td class="py-5 px-6 text-center">
                                <button onclick="window.openProceedModal('Global Tech Solutions')" class="px-4 py-2 bg-maroon text-white text-[10px] font-bold rounded-xl hover:bg-maroon-800 transition-all shadow-md shadow-maroon/10">PROCEED</button>
                            </td>
                        </tr>
                        <tr class="hover:bg-slate-50/50 transition-colors group">
                            <td class="py-5 px-6 text-slate-700 font-bold">Apex Manufacturing</td>
                            <td class="py-5 px-6">
                                <div class="flex items-center justify-center space-x-3">
                                    <span class="text-slate-500 font-black text-lg">20</span>
                                    <div class="status-tag-container">
                                        <span class="tag-count bg-blue-tag">+5</span>
                                        <span class="tag-date">(2026/04/20)</span>
                                    </div>
                                </div>
                            </td>
                            <td class="py-5 px-6">
                                <div class="flex items-center justify-center space-x-3">
                                    <span class="text-amber-600 font-black text-lg">5</span>
                                    <div class="status-tag-container">
                                        <span class="tag-count bg-amber-tag">+2</span>
                                        <span class="tag-date">(2026/03/15)</span>
                                    </div>
                                </div>
                            </td>
                            <td class="py-5 px-6">
                                <div class="flex items-center justify-center space-x-3">
                                    <span class="text-emerald-600 font-black text-lg">12</span>
                                    <div class="status-tag-container">
                                        <span class="tag-count bg-emerald-tag">+3</span>
                                        <span class="tag-date">(2026/04/22)</span>
                                    </div>
                                </div>
                            </td>
                            <td class="py-5 px-6 text-center"><span class="px-3 py-1 bg-slate-100 rounded-full text-[10px]">30 Days</span></td>
                            <td class="py-5 px-6 text-center">
                                <button onclick="window.openProceedModal('Apex Manufacturing')" class="px-4 py-2 bg-maroon text-white text-[10px] font-bold rounded-xl hover:bg-maroon-800 transition-all shadow-md shadow-maroon/10">PROCEED</button>
                            </td>
                        </tr>
                        <tr class="hover:bg-slate-50/50 transition-colors group">
                            <td class="py-5 px-6 text-slate-700 font-bold">Horizon Retailers</td>
                            <td class="py-5 px-6">
                                <div class="flex items-center justify-center space-x-3">
                                    <span class="text-slate-500 font-black text-lg">15</span>
                                    <div class="status-tag-container">
                                        <span class="tag-count bg-blue-tag">+2</span>
                                        <span class="tag-date">(2026/03/25)</span>
                                    </div>
                                </div>
                            </td>
                            <td class="py-5 px-6">
                                <div class="flex items-center justify-center space-x-3">
                                    <span class="text-amber-600 font-black text-lg">10</span>
                                    <div class="status-tag-container">
                                        <span class="tag-count bg-amber-tag">+3</span>
                                        <span class="tag-date">(2026/02/10)</span>
                                    </div>
                                </div>
                            </td>
                            <td class="py-5 px-6">
                                <div class="flex items-center justify-center space-x-3">
                                    <span class="text-emerald-600 font-black text-lg">8</span>
                                    <div class="status-tag-container">
                                        <span class="tag-count bg-emerald-tag">+1</span>
                                        <span class="tag-date">(2026/03/30)</span>
                                    </div>
                                </div>
                            </td>
                            <td class="py-5 px-6 text-center"><span class="px-3 py-1 bg-slate-100 rounded-full text-[10px]">18 Days</span></td>
                            <td class="py-5 px-6 text-center">
                                <button onclick="window.openProceedModal('Horizon Retailers')" class="px-4 py-2 bg-maroon text-white text-[10px] font-bold rounded-xl hover:bg-maroon-800 transition-all shadow-md shadow-maroon/10">PROCEED</button>
                            </td>
                        </tr>
                    </tbody>
                </table>
    ...
    <div id="payments-history-view" class="hidden mt-6">
        ...
        <div id="payments-groups-view" class="hidden space-y-0">
            <div class="p-5 border-b border-slate-50 bg-slate-50/50 flex items-center justify-between gap-3 flex-wrap">
                <div>
                    ...
                    <p class="text-[10px] text-slate-400 font-medium mt-1">Active = a new invoice was added within the last 3 calendar days; 4+ days untouched becomes Not Active. Use All to see every group.</p>
                </div>
            ...
            <div class="overflow-x-auto custom-scrollbar">
                <table class="w-full text-left border-collapse">
                    <thead>
                        <tr class="bg-slate-50 text-slate-400 text-[10px] font-bold uppercase tracking-widest">
                            <th class="py-5 px-6">Group Title</th><th class="py-5 px-6 text-center">Total Invoices</th><th class="py-5 px-6 text-center">Total Amount</th><th class="py-5 px-6 text-center">Grouped Date</th><th class="py-5 px-6 text-center">Payment Status</th><th class="py-5 px-6 text-center">Action</th>
                        </tr>
                    ...
                    <tbody id="payments-groups-tbody" class="divide-y divide-slate-100 text-xs text-slate-600 font-medium"></tbody>
                </table>
            </div>
            <div class="p-4 border-t border-slate-100 bg-white flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                ...
                <div class="flex items-center gap-2"><button id="payments-groups-prev-btn" onclick="window.changeGroupsPage(-1)" class="px-4 py-2 rounded-lg border border-slate-200 text-[10px] font-black uppercase tracking-widest text-slate-500 hover:bg-slate-50 disabled:opacity-40 disabled:cursor-not-allowed">Previous</button><button id="payments-groups-next-btn" onclick="window.changeGroupsPage(1)" class="px-4 py-2 rounded-lg bg-maroon text-white text-[10px] font-black uppercase tracking-widest hover:bg-maroon-800 disabled:opacity-40 disabled:cursor-not-allowed">Next</button></div>
            </div>
        </div>
    </div>

    <!-- PROCEED MODAL (Multi-Step) -->
                            ...
                            <div class="payment-right-pane payment-pane-scroll custom-scrollbar space-y-4 pr-2">
                                <div class="flex items-center justify-between">
                                    ...
                                    <div class="flex items-center gap-2">
                                        ...
                                        <button onclick="window.openPaymentGroupModal()" class="payments-history-action text-white" style="background:#800000;" title="Group selected invoices and post them as paid">
                                    ...
                                    <table class="w-full min-w-[1350px] text-left">
                                        <thead class="bg-slate-50 text-slate-400 text-[9px] font-bold uppercase tracking-wider">
                                            ...
                                            <tr class="bg-white border-t border-slate-100">
                                                ...
                                                <th class="p-1"><input type="text" class="invoice-filter-input w-full px-2 py-1 text-[8px] border border-slate-200 rounded outline-none bg-slate-50" data-col="4" placeholder="Filter Amount..."></th>
                                                <th class="p-1"><input type="text" class="invoice-filter-input w-full px-2 py-1 text-[8px] border border-slate-200 rounded outline-none bg-slate-50" data-col="5" placeholder="Filter Due..."></th>
    ...
    <div id="payment-delete-confirm-modal" class="fixed inset-0 z-[690] hidden items-center justify-center p-4">
        <div class="absolute inset-0 bg-slate-950/60 backdrop-blur-sm"></div>
        <div class="relative w-full max-w-md rounded-2xl bg-white shadow-2xl overflow-hidden">
            <div class="bg-red-600 p-5 text-white">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h3 class="text-sm font-black uppercase tracking-widest">Delete Payment</h3>
                        <p class="text-[10px] font-semibold text-white/70 mt-1">This action permanently removes the saved record.</p>
                    </div>
                </div>
            </div>
            <div class="p-6 space-y-4">
                <p id="payment-delete-confirm-message" class="text-sm text-slate-600 font-semibold leading-relaxed">Are you sure you want to delete this payment?</p>
                <div class="flex justify-end gap-3">
                    <button onclick="window.closePaymentDeleteConfirmModal()" class="px-5 py-2.5 rounded-xl bg-slate-100 text-slate-600 text-[10px] font-black uppercase tracking-widest hover:bg-slate-200">Cancel</button>
                    <button onclick="window.submitDeletePaymentHistory()" class="px-5 py-2.5 rounded-xl bg-red-600 text-white text-[10px] font-black uppercase tracking-widest hover:bg-red-700">Delete</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="payment-delete-success-modal" class="fixed inset-0 z-[700] hidden items-center justify-center p-4">
        <div class="absolute inset-0 bg-slate-950/60 backdrop-blur-sm"></div>
        <div class="relative w-full max-w-md rounded-2xl bg-white shadow-2xl overflow-hidden">
            <div class="p-8 text-center">
                <div class="mx-auto w-16 h-16 rounded-2xl bg-emerald-50 text-emerald-500 flex items-center justify-center">
                ...
                <h3 class="mt-5 text-lg font-black text-slate-800 uppercase tracking-widest">Payment Deleted</h3>
                <p id="payment-delete-success-message" class="mt-2 text-sm font-semibold text-slate-500">The selected payment history record was deleted successfully.</p>
                <button onclick="window.closePaymentDeleteSuccessModal()" class="mt-6 px-8 py-3 rounded-xl bg-maroon text-white text-[10px] font-black uppercase tracking-widest hover:bg-maroon-800">Done</button>
            </div>
        </div>
    </div>
</div>
    ...
    <div id="payment-group-modal" class="fixed inset-0 z-[700] hidden flex items-center justify-center p-4" role="dialog" aria-modal="true">
        ...
        <div class="relative bg-white rounded-2xl text-left overflow-hidden shadow-2xl transform transition-all w-full max-w-md modal-animate-in">
            <div class="bg-maroon p-6 text-white"><div class="flex items-center space-x-3"><div class="p-2 bg-white/10 rounded-lg"><i data-lucide="folder-plus" class="w-5 h-5 text-gold"></i></div><div><h3 class="text-base font-bold uppercase tracking-widest">Create Invoice Group</h3><p class="text-[10px] font-semibold text-white/60 mt-1">Group selected invoices and post them as paid immediately.</p></div></div></div>
            <div class="p-6 space-y-4">
                <p id="payment-group-count" class="text-[10px] font-semibold text-slate-400"></p>
                <div><label for="payment-group-title" class="text-[10px] font-bold text-slate-500 uppercase tracking-widest block mb-2">ADD NEW GROUP</label><input type="text" id="payment-group-title" oninput="window.updateGroupButton()" class="w-full px-4 py-2.5 rounded-xl border border-slate-200 text-xs font-semibold text-slate-700 outline-none focus:border-maroon focus:ring-2 focus:ring-maroon/20" placeholder="Group Title"></div>
                <div>
                ...
                <div><p id="payment-group-error" class="hidden text-[10px] font-bold text-red-600"></p></div>
            </div>
            <div class="p-5 border-t border-slate-100 bg-slate-50/50 flex items-center justify-end gap-2"><button onclick="window.toggleModal('payment-group-modal', false)" class="px-5 py-2.5 rounded-xl border border-slate-200 text-[10px] font-black uppercase tracking-widest text-slate-500 hover:bg-slate-100">Cancel</button><button id="payment-group-create-btn" onclick="window.submitPaymentGroup()" class="px-5 py-2.5 rounded-xl bg-maroon text-white text-[10px] font-black uppercase tracking-widest hover:bg-maroon-800 disabled:opacity-50 disabled:cursor-not-allowed">Create Group & Pay</button></div>
        </div>
    </div>
...
@push('scripts')
    <script>
        window.paymentsRoutes = {
            data: "{{ route('admin.payments.data') }}",
            customer: "{{ url('/admin/payments/customer') }}/:customerId",
            customerReturns: "{{ url('/admin/payments/customer') }}/:customerId/returns",
            returnLookup: "{{ route('admin.payments.return.lookup', ['returnId' => ':returnId']) }}",
            process: "{{ route('admin.payments.process') }}",
            historyData: "{{ route('admin.payments.history.data') }}",
            payors: "{{ route('admin.payments.history.payors') }}",
            payorHistory: "{{ route('admin.payments.history.payor', ['customerId' => ':customerId']) }}",
            historyDetail: "{{ url('/admin/payments/history') }}/:paymentId",
            historyItems: "{{ route('admin.payments.history.items', ['sourceType' => ':sourceType', 'sourceId' => ':sourceId']) }}",
            historyLedger: "{{ route('admin.payments.history.ledger', ['paymentId' => ':paymentId']) }}",
            historyPrint: "{{ route('admin.payments.history.print') }}",
            historyUpdate: "{{ url('/admin/payments/history') }}/:paymentId",
            historyDelete: "{{ url('/admin/payments/history') }}/:paymentId",
            groupsData: "{{ route('admin.payments.groups.data') }}",
            groupsStore: "{{ route('admin.payments.groups.store') }}",
            groupDelete: "{{ route('admin.payments.groups.delete', ['groupId' => ':groupId']) }}",
            groupDetail: "{{ route('admin.payments.groups.detail', ['groupId' => ':groupId']) }}",
            groupPrint: "{{ route('admin.payments.groups.print', ['groupId' => ':groupId']) }}",
            groupProcess: "{{ route('admin.payments.groups.process', ['groupId' => ':groupId']) }}",
            groupsItems: "{{ route('admin.payments.groups.items', ['groupId' => ':groupId']) }}",

            groupItemUpdate: "{{ route('admin.payments.groups.item.update', ['groupId' => ':groupId', 'itemId' => ':itemId']) }}",
            groupItemDelete: "{{ route('admin.payments.groups.item.delete', ['groupId' => ':groupId', 'itemId' => ':itemId']) }}"
        };
    </script>
    <script src="{{ asset('js/payments.js') }}?v={{ time() }}"></script>
@endpush
