...
@push('scripts')
    ...
    <script>
        window.pcvRoutes = {
            ...
            recommendations: "{{ url('/admin/accounting/payable-cheque-voucher/supplier') }}"
        };
        ...
        (() => {
            ...
            window.pcvSubmitDeleteVoucher = async function() {
                ...
                try {
                    const res = await fetch(`{{ url('/admin/accounting/payable-cheque-voucher/delete') }}/${deleteVoucherId}`, {
                        method: 'DELETE',
                        headers: {
