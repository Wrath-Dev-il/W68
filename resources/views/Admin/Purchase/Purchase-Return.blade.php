...
@push('scripts')
    <script>
        window.returnRoutes = {
            invoicesUrl: '{{ route("admin.purchase-return.invoices") }}',
            poItemsUrl: '{{ route("admin.purchase-return.po-items", ["poId" => ":poId"]) }}',
            processUrl: '{{ route("admin.purchase-return.process") }}',
            updateUrl: '{{ route("admin.purchase-return.update", ["id" => ":id"]) }}',
            deleteUrl: '{{ route("admin.purchase-return.delete", ["id" => ":id"]) }}',
            historyUrl: '{{ route("admin.purchase-return.history") }}',
            dashboardUrl: '{{ route("admin.purchase-return.dashboard") }}',
            detailUrl: '{{ route("admin.purchase-return.detail", ["id" => ":id"]) }}'
        };
