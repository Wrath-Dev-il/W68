...
<div id="select-supplier-modal" class="fixed inset-0 z-[900] hidden">
...
<div id="add-items-modal" class="fixed inset-0 z-[900] hidden">
...
<div id="rollback-modal" class="fixed inset-0 z-[950] hidden">
...
<div id="rollback-success-modal" class="fixed inset-0 z-[1000] hidden">
...
<div id="delete-supplier-modal" class="fixed inset-0 z-[950] hidden">
...
<div id="delete-item-modal" class="fixed inset-0 z-[950] hidden">
...
<div id="duplicate-warning-modal" class="fixed inset-0 z-[950] hidden">
...
@push('scripts')
    <script>
        ...
        window.viberRoutes = {
            suppliers: '{{ route("admin.purchase-viber.suppliers") }}',
            products: '{{ route("admin.purchase-viber.products") }}',
            list: '{{ route("admin.purchase-viber.list") }}',
            storeSupplier: '{{ route("admin.purchase-viber.store-supplier") }}',
            storeItems: '{{ route("admin.purchase-viber.store-items") }}',
            items: '{{ route("admin.purchase-viber.items", ["viberListId" => ":viberListId"]) }}',
            destroySupplier: '{{ route("admin.purchase-viber.destroy", ["id" => ":id"]) }}',
            destroyItem: '{{ route("admin.purchase-viber.items.destroy", ["id" => ":id"]) }}',
            updateItem: '{{ route("admin.purchase-viber.items.update", ["id" => ":id"]) }}',
            transferItem: '{{ route("admin.purchase-viber.items.transfer", ["id" => ":id"]) }}',
            prepareNote: '{{ route("admin.purchase-viber.prepare-note") }}',
            counts: '{{ route("admin.purchase-viber.counts") }}',
            invoicedItems: '{{ route("admin.purchase-viber.invoiced-items") }}',
            notArrivedItems: '{{ route("admin.purchase-viber.not-arrived-items") }}',
            notArrivedRollback: '{{ route("admin.purchase-viber.not-arrived-rollback") }}',
            purchaseNote: '{{ route("admin.purchase-note") }}',
            shippedPrintItems: '{{ route("admin.purchase-viber.shipped-print-items", ["viberListId" => ":viberListId"]) }}',
        };
    </script>
