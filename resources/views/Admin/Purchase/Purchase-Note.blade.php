...
<script>
    ...
    window.purchaseRoutes = {
        fetch: '{{ route("admin.purchase.note.data") }}',
        details: '{{ route("admin.purchase.note.details", ["id" => ":id"]) }}',
        searchSuppliers: '{{ route("admin.purchase.search-suppliers") }}',
        searchProducts: '{{ route("admin.purchase.search-products") }}',
        store: '{{ route("admin.purchase.note.store") }}',
        update: '{{ route("admin.purchase.note.update", ["id" => ":id"]) }}',
        delete: '{{ route("admin.purchase.note.delete", ["id" => ":id"]) }}',
        supplierItemConflicts: '{{ route("admin.purchase.note.supplier-item-conflicts") }}',
        forgottenPartialItems: '{{ route("admin.purchase.note.forgotten-partial-items", ["supplierCode" => ":supplierCode"]) }}',
        nextNumber: '{{ route("admin.purchase.note.next-number") }}',
        print: '{{ route("admin.purchase.note.print", ["id" => ":id"]) }}',
        verifyPasswordUrl: '{{ route("admin.purchase.note.verify-password") }}',
        checkPasswordUrl: '{{ url("/check-password") }}',
        invoicesByNoteUrl: '{{ route("admin.purchase-order.by-note", ["purchaseNoteNumber" => ":noteNumber"]) }}'
    };
