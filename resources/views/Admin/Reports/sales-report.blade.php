    ...
    <div class="bg-white border border-slate-200 rounded-xl p-6 shadow-sm no-print">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="space-y-2 relative">
                ...
                <div class="sales-report-searchable" data-endpoint="{{ route('admin.sales-report.customers') }}" data-type="object" data-input-id="sales-report-customer" data-default-label="Select All">
                    <div class="relative">
            ...
            <div class="space-y-2 relative">
                ...
                <div class="sales-report-searchable" data-endpoint="{{ route('admin.sales-report.descriptions') }}" data-type="text" data-input-id="sales-report-description">
                    <div class="relative">
            ...
            <div class="space-y-2 relative">
                ...
                <div class="sales-report-searchable" data-endpoint="{{ route('admin.sales-report.categories') }}" data-type="text" data-input-id="sales-report-category">
                    <div class="relative">
            ...
            <div class="space-y-2 relative">
                ...
                <div class="sales-report-searchable" data-endpoint="{{ route('admin.sales-report.agents') }}" data-type="text" data-input-id="sales-report-agent">
                    <div class="relative">
...
@push('scripts')
    <script>
        window.salesReportRoutes = {
            customers: "{{ route('admin.sales-report.customers') }}",
            descriptions: "{{ route('admin.sales-report.descriptions') }}",
            categories: "{{ route('admin.sales-report.categories') }}",
            agents: "{{ route('admin.sales-report.agents') }}",
            printData: "{{ route('admin.sales-report.print-data') }}",
            printSoa: "{{ route('admin.sales-report.print-soa') }}"
        };
    </script>
