@php
$tpRoutes = [
    'customers' => route('admin.top-products.customers'),
    'brands' => route('admin.top-products.brands'),
    'descriptions' => route('admin.top-products.descriptions'),
    'agents' => route('admin.top-products.agents'),
    'data' => route('admin.top-products.data'),
];
@endphp
