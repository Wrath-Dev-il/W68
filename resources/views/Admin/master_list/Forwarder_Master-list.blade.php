@push('styles')
    <link rel="stylesheet" href="{{ asset('css/Forwarder_Master-list.css') }}?v={{ time() }}">
@endpush

@section('forwarder_master_content')
<script>
    ...
    (function() {
        ...
        window.fetch = function(input, init) {
            if (typeof input === 'string') {
                // If the URL starts with /admin/masterlist/forwarder and we are in /hatdog/public
                if (input.startsWith('/admin/masterlist/forwarder') && window.location.pathname.includes('/hatdog/public')) {
            ...
            <table class="w-full text-left border-collapse">
                <thead>
                    ...
                    <tr class="bg-white border-b border-slate-100">
                        <th class="p-2 px-6"><input type="text" id="col-search-code" name="code" placeholder="Search Code..." class="column-search-input text-[10px]"></th>
                        <th class="p-2 px-6"><input type="text" id="col-search-name" name="name" placeholder="Search Name..." class="column-search-input text-[10px]"></th>
...
@push('scripts')
    <script src="{{ asset('js/Forwarder_Master-list.js') }}?v={{ time() }}"></script>
@endpush
