...
<head>
    ...
    <style>
        ...
        @media print {
            ...
            /* Full-page watermark overlay (covers entire sheet including margins) */
            .print-watermark {
            ...
            /* ── Single table — browser pagination with repeating thead/tfoot ── */
...
<body class="bg-slate-200 font-sans">
    ...
    <div class="fixed top-5 left-5 z-[250] no-print">
        <a href="{{ route('admin.prod-master') }}" class="px-6 py-3 bg-gold text-maroon-900 font-black rounded-2xl shadow-2xl hover:bg-goldlining-500 transition-all flex items-center gap-3 border border-goldlining-500">
    ...
    <div class="fixed top-5 right-5 z-[110] no-print flex flex-col gap-2">
        ...
        <a id="excel-export-btn" href="{{ route('admin.product-price-list.export-excel') }}{{ $exportQuery ? '?' . $exportQuery : '' }}" class="px-8 py-3 bg-emerald-700 text-white font-black rounded-2xl shadow-2xl hover:bg-emerald-800 transition-all flex items-center gap-3 border-2 border-emerald-300">
    ...
    <!-- Print-Only: Single table — browser handles pagination with repeating thead/tfoot -->
    <div id="print-report">
                    ...
                    <td colspan="5" style="border:none;padding:0 0 3px 0;">
                        <div class="print-header">
                            <div>
                                ...
                                <div class="subtitle">PRICE LIST</div>
                            </div>
                            <div class="date">{{ strtoupper(date('M d, Y')) }}</div>
                        </div>
                    </td>
                </tr>
            </thead>
                ...
                <tr>
                    <td colspan="5" style="border:none;padding:2mm 0 0 0;">
                        <div class="print-footer">
                            <p>W68 AUTO PARTS &mdash; PRICE LIST</p>
                        </div>
                    </td>
                </tr>
            </tfoot>
