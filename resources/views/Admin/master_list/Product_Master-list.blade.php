...
<script>
    window.prodRoutes = {
        fetch: '{{ route("admin.prod-master.data") }}',
        create: '{{ route("admin.prod-master.create") }}',
        update: '{{ route("admin.prod-master.update", ["id" => ":id"]) }}',
        delete: '{{ route("admin.prod-master.delete", ["id" => ":id"]) }}',
       'ledger': '{{ route("admin.prod-master.ledger", ["id" => ":id"]) }}',
        'select': '{{ route("admin.prod-master.select") }}',
        'reorderLevel': '{{ route("admin.prod-master.reorder-level") }}',
        'catalog': '{{ route("admin.prod-master.catalog") }}',
        'priceList': '{{ route("admin.prod-master.price-list") }}',
        'selectedFilters': '{{ route("admin.prod-master.selected-filters") }}',
        'activeNotes': '{{ route("admin.prod-master.active-notes", ["id" => ":id"]) }}',
        'priceCodesUpdate': '{{ route("admin.prod-master.price-codes.update", ["id" => ":id"]) }}'
    };
