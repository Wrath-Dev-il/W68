    ...
    (function() {
        ...
        window.fetch = function(input, init) {
            if (typeof input === 'string') {
                // If the URL starts with /admin/masterlist/customer and we are in /hatdog/public
                if (input.startsWith('/admin/masterlist/customer') && window.location.pathname.includes('/hatdog/public')) {
...
@push('scripts')
    <script>
        window.customerRoutes = {
            ...
            soaAutoStatus: '{{ route("admin.customer-master.soa-auto.status") }}',
            soaAutoSave: '{{ route("admin.customer-master.soa-auto.save") }}',
        };
    </script>
